 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yk{constructor(){this.ao=()=>this.uo(),this.co=()=>this.lo(),this.ho=[],this.Po()}_o(e){this.ho.push(e)}shutdown(){window.removeEventListener("online",this.ao),window.removeEventListener("offline",this.co)}Po(){window.addEventListener("online",this.ao),window.addEventListener("offline",this.co)}uo(){X("ConnectivityMonitor","Network connectivity changed: AVAILABLE");for(const e of this.ho)e(0)}lo(){X("ConnectivityMonitor","Network connectivity changed: UNAVAILABLE");for(const e of this.ho)e(1)}static D(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pN{constructor(e){this.app=e}_delete(){return delete _l[this.app.options.appId],Promise.resolve()}}let _l={},Dk=[];const Ok={};let rp="dataLayer",mN="gtag",Nk,X8,Mk=!1;function gN(){const t=[];if(gT()&&t.push("This is a browser extension environment."),vA()||t.push("Cookies are not available."),t.length>0){const e=t.map((r,i)=>`(${i+1}) ${r}`).join(" "),n=nn.create("invalid-analytics-context",{errorInfo:e});Kt.warn(n.message)}}function yN(t,e,n){gN();const r=t.options.appId;if(!r)throw nn.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)Kt.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw nn.create("no-api-key");if(_l[r]!=null)throw nn.create("already-exists",{id:r});if(!Mk){QO(rp);const{wrappedGtag:o,gtagCore:s}=eN(_l,Dk,Ok,rp,mN);X8=o,Nk=s,Mk=!0}return _l[r]=fN(t,Dk,Ok,e,Nk,rp,n),new pN(t)}function vN(t=ph()){t=We(t);const e=Ti(t,bd);return e.isInitialized()?e.getImmediate():_N(t)}function _N(t,e={}){const n=Ti(t,bd);if(n.isInitialized()){const i=n.getImmediate();if($l(e,n.getOptions()))return i;throw nn.create("already-initialized")}return n.initialize({options:e})}function kN(t,e,n,r){t=We(t),dN(X8,_l[t.app.options.appId],e,n,r).catch(i=>Kt.error(i))}const Vk="@firebase/analytics",Fk="0.10.8";function EN(){Rn(new mn(bd,(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("installations-internal").getImmediate();return yN(r,i,n)},"PUBLIC")),Rn(new mn("analytics-internal",t,"PRIVATE")),Yt(Vk,Fk),Yt(Vk,Fk,"esm2017");function t(e){try{const n=e.getProvider(bd).getImmediate();return{logEvent:(r,i,o)=>kN(n,r,i,o)}}catch(n){throw nn.create("interop-component-reg-failed",{reason:n})}}}EN();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function DN(t){return t!==void 0}function Wk(t,e,n,r){if(r<e)throw Uk(`Invalid value for '${t}'. Expected ${e} or greater.`);if(r>n)throw Uk(`Invalid value for '${t}'. Expected ${n} or less.`)}function ON(t){const e=encodeURIComponent;let n="?";for(const r in t)if(t.hasOwnProperty(r)){const i=e(r)+"="+e(t[r]);n=n+i+"&"}return n=n.slice(0,-1),n}var jd;(function(t){t[t.NO_ERROR=0]="NO_ERROR",t[t.NETWORK_ERROR=1]="NETWORK_ERROR",t[t.ABORT=2]="ABORT"})(jd||(jd={}));/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,O2=V.div`
  ...
  padding: 2rem;
  color: #666;
`,JV=({user:t,userData:e})=>{const[n,r]=O.useState(null),[i,o]=O.useState(!0),[s,a]=O.useState(null),{use24HourFormat:u}=X1(),d=(e==null?void 0:e.timeRegion)||Intl.DateTimeFormat().resolvedOptions().timeZone||"Asia/Manila";O.useEffect(()=>{(async()=>{if(t!=null&&t.uid)try{if(o(!0),e&&e.schedule&&Array.isArray(e.schedule)&&e.schedule.length>0)console.log("Using schedule from userData prop:",e.schedule),r(e.schedule);else{const I=ft(Le,"users",t.uid),P=await Jl(I);if(P.exists()){const S=P.data();if(S.schedule&&Array.isArray(S.schedule)&&S.schedule.length>0)console.log("Found user schedule in Firestore:",S.schedule),r(S.schedule);else if(S.scheduleId){const v=S.scheduleId,g=ft(Le,"schedules",v),_=await Jl(g);_.exists()&&r(_.data())}else{const v=xn(Le,"schedules"),g=pr(v,Kr("isDefault","==",!0)),_=await zn(g);_.empty||r(_.docs[0].data())}}}}catch(I){console.error("Error fetching schedule:",I),a("Failed to load schedule. Please try again later.")}finally{o(!1)}})()},[t,e]);const h=E=>["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][E],m=(E,I=null,P=d)=>{if(!E)return"N/A";try{if(!I||I===P){const[T,w]=E.split(":"),A=new Date;return A.setHours(parseInt(T,10)),A.setMinutes(parseInt(w,10)),A.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hour12:!u})}const[S,v]=E.split(":"),g=new Date;g.setHours(0,0,0,0);const _=new Date(g);_.setHours(parseInt(S,10),parseInt(v,10),0,0);const x=ZV(_,I),R=XV(x,P);return GV(R,u?"HH:mm":"h:mm a",{timeZone:P})}catch(S){return console.error("Error formatting time:",S),E}},k=(E,I,P)=>{try{const[S,v]=E.split(":").map(Number),g=new Date;g.setHours(0,0,0,0);const _=new Date(g);_.setHours(S,v,0,0);const x=M5(_,I);return $9(x,"HH:mm")}catch(S){console.error("Error calculating end time:",S);let v=(parseInt(E.split(":")[0],10)+I)%24,g=E.split(":")[1];return`${v.toString().padStart(2,"0")}:${g}`}};return f.jsxs(ui,{children:[f.jsx(ci,{children:"My Schedule"}),f.jsx(di,{children:i?f.jsx("p",{children:"Loading your schedule..."}):s?f.jsx(O2,{children:f.jsx("p",{children:s})}):n?f.jsx("div",{children:Array.isArray(n)?f.jsxs(f.Fragment,{children:[f.jsx("p",{children:f.jsx("strong",{children:"Your Schedule"})}),n.map((E,I)=>{const P=new Date,v=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].indexOf(E.dayOfWeek),g=P.getDay()===v,_=E.timeRegion||"Asia/Manila",x=m(E.timeIn,_,d),R=E.shiftDuration||8,N=k(E.timeIn,R),T=m(N,_,d);return f.jsxs(D2,{isToday:g,children:[f.jsx("h3",{children:E.dayOfWeek}),f.jsxs("p",{children:[f.jsx("strong",{children:"Time In:"})," ",x," |",f.jsx("strong",{children:"Duration:"})," ",E.shiftDuration," hours"]}),f.jsxs("p",{children:[f.jsx("strong",{children:"Estimated Time Out:"})," ",T]}),f.jsxs("p",{children:[f.jsx("strong",{children:"Original Time Region:"})," ",_]}),f.jsxs("p",{children:[f.jsx("strong",{children:"Displayed In:"})," ",d]})]},I)}),f.jsxs(j2,{children:[f.jsx("thead",{children:f.jsxs("tr",{children:[f.jsx("th",{children:"Day"}),f.jsx("th",{children:"Time In"}),f.jsx("th",{children:"Time Out (Est.)"}),f.jsx("th",{children:"Duration"}),f.jsx("th",{children:"Region"})]})}),f.jsx("tbody",{children:n.map((E,I)=>{const P=E.timeRegion||"Asia/Manila",S=m(E.timeIn,P,d),v=E.shiftDuration||8,g=k(E.timeIn,v),_=m(g,P,d);return f.jsxs("tr",{children:[f.jsx("td",{children:E.dayOfWeek}),f.jsx("td",{children:S}),f.jsx("td",{children:_}),f.jsxs("td",{children:[E.shiftDuration," hours"]}),f.jsxs("td",{children:[f.jsx("div",{children:P}),f.jsxs("div",{style:{fontSize:"0.8rem",opacity:.7},children:["Displayed in: ",d]})]})]},I)})})]})]}):f.jsxs(f.Fragment,{children:[f.jsxs("p",{children:["Your assigned schedule: ",f.jsx("strong",{children:n.name||"Standard Schedule"})]}),n.shifts&&n.shifts.map((E,I)=>{const S=new Date().getDay()===E.day;return f.jsxs(D2,{isToday:S,children:[f.jsx("h3",{children:h(E.day)}),f.jsxs("p",{children:[f.jsx("strong",{children:"Start:"})," ",m(E.startTime)," |",f.jsx("strong",{children:"End:"})," ",m(E.endTime)]}),E.breakStart&&E.breakEnd&&f.jsxs("p",{children:[f.jsx("strong",{children:"Break:"})," ",m(E.breakStart)," - ",m(E.breakEnd)]})]},I)}),f.jsxs(j2,{children:[f.jsx("thead",{children:f.jsxs("tr",{children:[f.jsx("th",{children:"Day"}),f.jsx("th",{children:"Start Time"}),f.jsx("th",{children:"End Time"}),f.jsx("th",{children:"Break"})]})}),f.jsx("tbody",{children:n.shifts&&n.shifts.map((E,I)=>f.jsxs("tr",{children:[f.jsx("td",{children:h(E.day)}),f.jsx("td",{children:m(E.startTime)}),f.jsx("td",{children:m(E.endTime)}),f.jsx("td",{children:E.breakStart&&E.breakEnd?`${m(E.breakStart)} - ${m(E.breakEnd)}`:"None"})]},I))})]})]})}):f.jsx(O2,{children:f.jsx("p",{children:"No schedule has been assigned to you yet."})})})]})},e7=V.div`
  margin-bottom: 1.5rem;
`,ss=V.p`
  margin: 0.75rem 0;
  display: flex;
...
`;function X7(){const[t,e]=O.useState(null),[n,r]=O.useState("dashboard"),[i,o]=O.useState(null),[s,a]=O.useState(null),[u,d]=O.useState(!1),[h,m]=O.useState(null),[k,E]=O.useState(!1),I=ca();O.useEffect(()=>{const b=Sn.currentUser;if(b){const D={uid:b.uid,email:b.email,displayName:b.displayName||b.email.split("@")[0]};e(D),P(b.uid)}},[]);const P=async b=>{if(b)try{E(!0);try{const G=pr(xn(Le,"declined_registrations"),Kr("userId","==",b));if(!(await zn(G)).empty){Y.error("Your registration request has been declined. Please contact an administrator."),await Sn.signOut(),I("/login");return}}catch(G){console.error("Error checking declined status:",G)}try{const G=pr(xn(Le,"registration_requests"),Kr("userId","==",b));if(!(await zn(G)).empty){Y.info("Your registration request is pending approval. You will be notified when approved."),await Sn.signOut(),I("/login");return}}catch(G){console.error("Error checking pending status:",G)}const D=ft(Le,"users",b),L=await Jl(D);if(L.exists()){const G=L.data();m(G)}else console.log("No user data found in Firestore"),Y.error("Your account is not properly set up. Please contact an administrator."),await Sn.signOut(),I("/login")}catch(D){console.error("Error fetching user data:",D),Y.error("Error loading user data. Please try again later.")}finally{E(!1)}};O.useEffect(()=>{t!=null&&t.uid&&S()},[t]);const S=async()=>{try{const b=xn(Le,"attendance");try{const D=pr(b,Kr("userId","==",t.uid),L1("timestamp","desc"),ZD(1)),L=await zn(D);if(L.empty)o(null),a(null);else{const G=L.docs[0].data();a(G),o(G.type)}}catch(D){if(D.message&&D.message.includes("index is currently building")){console.log("Index is still building, using fallback method");const L=pr(b,Kr("userId","==",t.uid)),G=await zn(L);if(G.empty)o(null),a(null);else{let ae=null,pe=new Date(0);G.forEach(me=>{var Z;const z=me.data(),q=((Z=z.timestamp)==null?void 0:Z.toDate())||new Date(0);q>pe&&(pe=q,ae=z)}),ae?(a(ae),o(ae.type)):(o(null),a(null))}Y.info("System is updating. Some features may be temporarily limited.",{autoClose:5e3,hideProgressBar:!1})}else throw D}}catch(b){console.error("Error fetching attendance status:",b),b.message&&b.message.includes("index")?Y.warning("System is updating attendance records. Please try again in a few minutes."):Y.error("Unable to fetch your attendance status. Please refresh the page.")}},[v,g]=O.useState(!1),[_,x]=O.useState(null),[R,N]=O.useState(""),T=async(b,D)=>{if(b==="Out")return"Complete";try{const L=await Jl(ft(Le,"users",D));if(!L.exists())return console.warn("User document not found when determining status"),"On Time";const ae=L.data().schedule||[],pe=new Date,me=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][pe.getDay()],z=ae&&Array.isArray(ae)?ae.find(ye=>ye.dayOfWeek===me):null;if(!z)return console.log("No schedule found for today:",me),"On Time";console.log("Found schedule for today:",z);const[q,Z]=z.timeIn.split(":").map(Number),ce=new Date;ce.setHours(q,Z,0,0);const ee=Math.round((pe-ce)/(1e3*60));return console.log("Time difference in minutes:",ee),ee<-15?"Early":ee<=15?"On Time":"Late"}catch(L){return console.error("Error determining status:",L),"On Time"}},w=async b=>{if(t){d(!0);try{const D=nt.now(),L=await T(b,t.uid),G={userId:t.uid,email:t.email,name:t.displayName,type:b,status:L,timestamp:D,notes:""};N(""),x(G),g(!0)}catch(D){console.error("Error preparing time in/out:",D),Y.error("Failed to prepare time in/out. Please try again.")}finally{d(!1)}}},A=async()=>{if(_){d(!0);try{const{status:b,...D}=_;D.notes=R;const L=await L8(xn(Le,"attendance"),D);Y.success(`Time ${_.type} recorded successfully!`),o(_.type);const G={..._,notes:R};a(G),g(!1),x(null),N(""),console.log(`Time ${_.type} recorded with ID: ${L.id}`)}catch(b){console.error(`Error recording time ${_.type}:`,b),Y.error(`Failed to record time ${_.type}`)}finally{d(!1)}}},j=()=>{g(!1),x(null),N("")};return f.jsxs(f.Fragment,{children:[f.jsxs(P5,{user:t,activeTab:n,setActiveTab:r,attendanceStatus:i,loading:u,handleTimeInOut:w,lastRecord:s,isSuperAdmin:(h==null?void 0:h.role)==="super_admin",userData:h,setUserData:m,children:[n==="dashboard"&&f.jsx(b5,{attendanceStatus:i,lastRecord:s}),n==="attendance"&&f.jsx(O5,{user:t}),n==="schedule"&&f.jsx(JV,{user:t,userData:h}),n==="profile"&&f.jsx(n7,{user:t,userData:h,loadingUserData:k}),n==="registration_requests"&&(h==null?void 0:h.role)==="super_admin"&&f.jsx(S7,{}),n==="user_management"&&(h==null?void 0:h.role)==="super_admin"&&f.jsx(W7,{})]}),v&&_&&f.jsx($7,{children:f.jsxs(z7,{children:[f.jsxs(B7,{children:["Confirm Time ",_.type]}),f.jsxs(H7,{children:[f.jsxs("p",{children:[f.jsx("strong",{children:"Time:"})," ",_.timestamp.toDate().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0})]}),f.jsxs("p",{children:[f.jsx("strong",{children:"Date:"})," ",_.timestamp.toDate().toLocaleDateString()]}),f.jsxs("p",{children:[f.jsx("strong",{children:"Status:"}),f.jsx(K7,{status:_.status,children:_.status})]}),f.jsxs("div",{style:{marginTop:"1rem"},children:[f.jsx("strong",{children:"Notes (Optional):"}),f.jsx(Q7,{value:R,onChange:b=>N(b.target.value),placeholder:"Add any notes about this attendance record..."})]})]}),f.jsxs(q7,{children:[f.jsxs(G7,{onClick:j,children:[f.jsx(Q1,{size:16,style:{marginRight:"4px"}}),"Cancel"]}),f.jsxs(Y7,{onClick:A,children:[f.jsx(H1,{size:16,style:{marginRight:"4px"}}),"Confirm"]})]})]})})]})}const Z7=({children:t})=>{const{currentUser:e,loading:n}=V1();return n?f.jsx(J7,{children:"Loading..."}):e?t:f.jsx(sT,{to:"/",replace:!0})},J7=V.div`
  ...
  color: #6e8efb;
  background-color: #f5f5f5;
`;function eF(){return f.jsx(f.Fragment,{children:f.jsx(JN,{children:f.jsxs(d5,{children:[f.jsx(eA,{children:f.jsxs(G4,{children:[f.jsx(Ka,{path:"/",element:f.jsx(K3,{})}),f.jsx(Ka,{path:"/register",element:f.jsx(c5,{})}),f.jsx(Ka,{path:"/dashboard",element:f.jsx(Z7,{children:f.jsx(X7,{})})}),f.jsx(Ka,{path:"*",element:f.jsx(sT,{to:"/",replace:!0})})]})}),f.jsx(tg,{position:"top-right",autoClose:3e3})]})})})}Kw(document.getElementById("root")).render(f.jsx(O.StrictMode,{children:f.jsx(eF,{})}));
