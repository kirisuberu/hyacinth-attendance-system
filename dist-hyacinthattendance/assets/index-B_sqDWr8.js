 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var qS=O,GS=Symbol.for("react.element"),YS=Symbol.for("react.fragment"),KS=Object.prototype.hasOwnProperty,QS=qS.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,XS={key:!0,ref:!0,__self:!0,__source:!0};function Gk(t,e,n){var r,i={},o=null,s=null;n!==void 0&&(o=""+n),e.key!==void 0&&(o=""+e.key),e.ref!==void 0&&(s=e.ref);for(r in e)KS.call(e,r)&&!XS.hasOwnProperty(r)&&(i[r]=e[r]);if(t&&t.defaultProps)for(r in e=t.defaultProps,e)i[r]===void 0&&(i[r]=e[r]);return{$$typeof:GS,type:t,key:o,ref:s,props:i,_owner:QS.current}}Kd.Fragment=YS;Kd.jsx=Gk;Kd.jsxs=Gk;Mk.exports=Kd;var f=Mk.exports,Yk={exports:{}},on={},Kk={exports:{}},Qk={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mP(t,e){const n=Ti(t,"auth");if(n.isInitialized()){const i=n.getImmediate(),o=n.getOptions();if($l(o,e??{}))return i;bn(i,"already-initialized")}return n.initialize({options:e})}function gP(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(fr);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function yP(t,e,n){const r=xi(t);te(r._canInitEmulator,r,"emulator-config-failed"),te(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const i=!1,o=BT(e),{host:s,port:a}=vP(e),u=a===null?"":`:${a}`;r.config.emulator={url:`${o}//${s}${u}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:s,port:a,protocol:o.replace(":",""),options:Object.freeze({disableWarnings:i})}),_P()}function BT(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function vP(t){const e=BT(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(r);if(i){const o=i[1];return{host:o,port:O_(r.substr(o.length+1))}}else{const[o,s]=r.split(":");return{host:o,port:O_(s)}}}function O_(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function _P(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const DR={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},OR=500,NR=600,MR="_blank",VR="http://localhost";class W_{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function FR(t,e,n,r=OR,i=NR){const o=Math.max((window.screen.availHeight-i)/2,0).toString(),s=Math.max((window.screen.availWidth-r)/2,0).toString();let a="";const u=Object.assign(Object.assign({},DR),{width:r.toString(),height:i.toString(),top:o,left:s}),d=Lt().toLowerCase();n&&(a=NT(d)?MR:n),DT(d)&&(e=e||VR,u.scrollbars="yes");const h=Object.entries(u).reduce((k,[E,I])=>`${k}${E}=${I},`,"");if(tP(d)&&a!=="_self")return UR(e||"",a),new W_(null);const m=window.open(e||"",a,h);te(m,t,"popup-blocked");try{m.focus()}catch{}return new W_(m)}function UR(t,e){const n=document.createElement("a");n.href=t,n.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nb=new $e(J.comparator);function Ir(){return Nb}const Sx=new $e(J.comparator);function Ja(...t){let e=Sx;for(const n of t)e=e.insert(n.key,n);return e}function Cx(t){let e=Sx;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function zi(){return gl()}function Ax(){return gl()}function gl(){return new pa(t=>t.toString(),(t,e)=>t.isEqual(e))}const Mb=new $e(J.comparator),Vb=new mt(J.comparator);function fe(...t){let e=Vb;for(const n of t)e=e.add(n);return e}const Fb=new mt(Ee);function Ub(){return Fb}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const W8=new Map;function $8(t,e){const n=Mh(t);z8(n,e),gO(n,e)}function z8(t,e){const n=W8.get(t);if(n)for(const r of n)r(e)}function gO(t,e){const n=yO();n&&n.postMessage({key:t,fid:e}),vO()}let Bi=null;function yO(){return!Bi&&"BroadcastChannel"in self&&(Bi=new BroadcastChannel("[Firebase] FID Change"),Bi.onmessage=t=>{z8(t.data.key,t.data.fid)}),Bi}function vO(){W8.size===0&&Bi&&(Bi.close(),Bi=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hN(){if(yT())try{await vT()}catch(t){return Kt.warn(nn.create("indexeddb-unavailable",{errorInfo:t==null?void 0:t.toString()}).message),!1}else return Kt.warn(nn.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function fN(t,e,n,r,i,o,s){var a;const u=aN(t);u.then(E=>{n[E.measurementId]=E.appId,t.options.measurementId&&E.measurementId!==t.options.measurementId&&Kt.warn(`The measurement ID in the local Firebase config (${t.options.measurementId}) does not match the measurement ID fetched from the server (${E.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(E=>Kt.error(E)),e.push(u);const d=hN().then(E=>{if(E)return r.getId()}),[h,m]=await Promise.all([u,d]);tN(o)||KO(o,h.measurementId),i("js",new Date);const k=(a=s==null?void 0:s.config)!==null&&a!==void 0?a:{};return k[zO]="firebase",k.update=!0,m!=null&&(k[$O]=m),i("config",h.measurementId,k),h.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Z8="firebasestorage.googleapis.com",wN="storageBucket",TN=2*60*1e3,xN=10*60*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bN(t,e,n){let r=1,i=null,o=null,s=!1,a=0;function u(){return a===2}let d=!1;function h(...S){d||(d=!0,e.apply(null,S))}function m(S){i=setTimeout(()=>{i=null,t(E,u())},S)}function k(){o&&clearTimeout(o)}function E(S,...v){if(d){k();return}if(S){k(),h.call(null,S,...v);return}if(u()||s){k(),h.call(null,S,...v);return}r<64&&(r*=2);let _;a===1?(a=2,_=0):_=(r+Math.random())*1e3,m(_)}let I=!1;function P(S){I||(I=!0,k(),!d&&(i!==null?(S||(a=2),clearTimeout(i),m(0)):S||(a=1)))}return m(0),o=setTimeout(()=>{s=!0,P(!0)},n),P}function jN(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`;const b5=({attendanceStatus:t,lastRecord:e})=>f.jsx(f.Fragment,{children:f.jsxs(R5,{children:[f.jsxs(ui,{children:[f.jsx(ci,{children:"Today's Schedule"}),f.jsx(di,{children:f.jsx("p",{children:"No schedule for today"})})]}),f.jsxs(ui,{children:[f.jsx(ci,{children:"Attendance Status"}),f.jsx(di,{children:t?f.jsxs(f.Fragment,{children:[f.jsxs("p",{children:["Current Status:",f.jsx(UI,{status:t,children:t==="In"?"Clocked In":"Clocked Out"})]}),e&&f.jsxs("p",{children:["Last action: ",new Date(e.timestamp.toDate()).toLocaleString()]})]}):f.jsx("p",{children:"You haven't clocked in today"})})]}),f.jsxs(ui,{children:[f.jsx(ci,{children:"Recent Activity"}),f.jsx(di,{children:e?f.jsxs("p",{children:["Last ",e.type==="In"?"Time In":"Time Out",": ",new Date(e.timestamp.toDate()).toLocaleString()]}):f.jsx("p",{children:"No recent activity"})})]})]})}),j5=V.table`
  width: 100%;
