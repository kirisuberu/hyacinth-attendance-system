 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class In{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=In.makeFromUrl(e,n)}catch{return new In(e,"")}if(r.path==="")return r;throw LN(e)}static makeFromUrl(e,n){let r=null;const i="([A-Za-z0-9.\\-_]+)";function o(I){I.path.charAt(I.path.length-1)==="/"&&(I.path_=I.path_.slice(0,-1))}const s="(/(.*))?$",a=new RegExp("^gs://"+i+s,"i"),u={bucket:1,path:3};function d(I){I.path_=decodeURIComponent(I.path)}const h="v[A-Za-z0-9_]+",m=n.replace(/[.]/g,"\\."),_="(/([^?#]*).*)?$",E=new RegExp(`^https?://${m}/${h}/b/${i}/o${_}`,"i"),x={bucket:1,path:3},L=n===J8?"(?:storage.googleapis.com|storage.cloud.google.com)":n,S="([^?#]*)",v=new RegExp(`^https?://${L}/${i}/${S}`,"i"),k=[{regex:a,indices:u,postModify:o},{regex:E,indices:x,postModify:d},{regex:v,indices:{bucket:1,path:2},postModify:d}];for(let I=0;I<k.length;I++){const R=k[I],N=R.regex.exec(e);if(N){const T=N[R.indices.bucket];let w=N[R.indices.path];w||(w=""),r=new In(T,w),R.postModify(r);break}}if(r==null)throw AN(e);return r}}class RN{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bN(t,e,n){let r=1,i=null,o=null,s=!1,a=0;function u(){return a===2}let d=!1;function h(...S){d||(d=!0,e.apply(null,S))}function m(S){i=setTimeout(()=>{i=null,t(E,u())},S)}function _(){o&&clearTimeout(o)}function E(S,...v){if(d){_();return}if(S){_(),h.call(null,S,...v);return}if(u()||s){_(),h.call(null,S,...v);return}r<64&&(r*=2);let k;a===1?(a=2,k=0):k=(r+Math.random())*1e3,m(k)}let x=!1;function L(S){x||(x=!0,_(),!d&&(i!==null?(S||(a=2),clearTimeout(i),m(0)):S||(a=1)))}return m(0),o=setTimeout(()=>{s=!0,L(!0)},n),L}function jN(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,Nk=V.div`
  ...
  padding: 2rem;
  color: #666;
`,e7=({user:t,userData:e})=>{const[n,r]=O.useState(null),[i,o]=O.useState(!0),[s,a]=O.useState(null),{use24HourFormat:u}=X1(),d=(e==null?void 0:e.timeRegion)||Intl.DateTimeFormat().resolvedOptions().timeZone||"Asia/Manila";O.useEffect(()=>{(async()=>{if(t!=null&&t.uid)try{if(o(!0),e&&e.schedule&&Array.isArray(e.schedule)&&e.schedule.length>0)console.log("Using schedule from userData prop:",e.schedule),r(e.schedule);else{const x=ft(Le,"users",t.uid),L=await Jl(x);if(L.exists()){const S=L.data();if(S.schedule&&Array.isArray(S.schedule)&&S.schedule.length>0)console.log("Found user schedule in Firestore:",S.schedule),r(S.schedule);else if(S.scheduleId){const v=S.scheduleId,g=ft(Le,"schedules",v),k=await Jl(g);k.exists()&&r(k.data())}else{const v=xn(Le,"schedules"),g=pr(v,Kr("isDefault","==",!0)),k=await zn(g);k.empty||r(k.docs[0].data())}}}}catch(x){console.error("Error fetching schedule:",x),a("Failed to load schedule. Please try again later.")}finally{o(!1)}})()},[t,e]);const h=E=>["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][E],m=(E,x=null,L=d)=>{if(!E)return"N/A";try{if(!x||x===L){const[T,w]=E.split(":"),A=new Date;return A.setHours(parseInt(T,10)),A.setMinutes(parseInt(w,10)),A.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hour12:!u})}const[S,v]=E.split(":"),g=new Date;g.setHours(0,0,0,0);const k=new Date(g);k.setHours(parseInt(S,10),parseInt(v,10),0,0);const I=JV(k,x),R=ZV(I,L);return YV(R,u?"HH:mm":"h:mm a",{timeZone:L})}catch(S){return console.error("Error formatting time:",S),E}},_=(E,x,L)=>{try{const[S,v]=E.split(":").map(Number),g=new Date;g.setHours(0,0,0,0);const k=new Date(g);k.setHours(S,v,0,0);const I=V5(k,x);return z9(I,"HH:mm")}catch(S){console.error("Error calculating end time:",S);let v=(parseInt(E.split(":")[0],10)+x)%24,g=E.split(":")[1];return`${v.toString().padStart(2,"0")}:${g}`}};return f.jsxs(ui,{children:[f.jsx(ci,{children:"My Schedule"}),f.jsx(di,{children:i?f.jsx("p",{children:"Loading your schedule..."}):s?f.jsx(Nk,{children:f.jsx("p",{children:s})}):n?f.jsx("div",{children:Array.isArray(n)?f.jsxs(f.Fragment,{children:[f.jsx("p",{children:f.jsx("strong",{children:"Your Schedule"})}),n.map((E,x)=>{const L=new Date,v=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].indexOf(E.dayOfWeek),g=L.getDay()===v,k=E.timeRegion||"Asia/Manila",I=m(E.timeIn,k,d),R=E.shiftDuration||8,N=_(E.timeIn,R),T=m(N,k,d);return f.jsxs(Ok,{isToday:g,children:[f.jsx("h3",{children:E.dayOfWeek}),f.jsxs("p",{children:[f.jsx("strong",{children:"Time In:"})," ",I," |",f.jsx("strong",{children:"Duration:"})," ",E.shiftDuration," hours"]}),f.jsxs("p",{children:[f.jsx("strong",{children:"Estimated Time Out:"})," ",T]}),f.jsxs("p",{children:[f.jsx("strong",{children:"Original Time Region:"})," ",k]}),f.jsxs("p",{children:[f.jsx("strong",{children:"Displayed In:"})," ",d]})]},x)}),f.jsxs(Dk,{children:[f.jsx("thead",{children:f.jsxs("tr",{children:[f.jsx("th",{children:"Day"}),f.jsx("th",{children:"Time In"}),f.jsx("th",{children:"Time Out (Est.)"}),f.jsx("th",{children:"Duration"}),f.jsx("th",{children:"Region"})]})}),f.jsx("tbody",{children:n.map((E,x)=>{const L=E.timeRegion||"Asia/Manila",S=m(E.timeIn,L,d),v=E.shiftDuration||8,g=_(E.timeIn,v),k=m(g,L,d);return f.jsxs("tr",{children:[f.jsx("td",{children:E.dayOfWeek}),f.jsx("td",{children:S}),f.jsx("td",{children:k}),f.jsxs("td",{children:[E.shiftDuration," hours"]}),f.jsxs("td",{children:[f.jsx("div",{children:L}),f.jsxs("div",{style:{fontSize:"0.8rem",opacity:.7},children:["Displayed in: ",d]})]})]},x)})})]})]}):f.jsxs(f.Fragment,{children:[f.jsxs("p",{children:["Your assigned schedule: ",f.jsx("strong",{children:n.name||"Standard Schedule"})]}),n.shifts&&n.shifts.map((E,x)=>{const S=new Date().getDay()===E.day;return f.jsxs(Ok,{isToday:S,children:[f.jsx("h3",{children:h(E.day)}),f.jsxs("p",{children:[f.jsx("strong",{children:"Start:"})," ",m(E.startTime)," |",f.jsx("strong",{children:"End:"})," ",m(E.endTime)]}),E.breakStart&&E.breakEnd&&f.jsxs("p",{children:[f.jsx("strong",{children:"Break:"})," ",m(E.breakStart)," - ",m(E.breakEnd)]})]},x)}),f.jsxs(Dk,{children:[f.jsx("thead",{children:f.jsxs("tr",{children:[f.jsx("th",{children:"Day"}),f.jsx("th",{children:"Start Time"}),f.jsx("th",{children:"End Time"}),f.jsx("th",{children:"Break"})]})}),f.jsx("tbody",{children:n.shifts&&n.shifts.map((E,x)=>f.jsxs("tr",{children:[f.jsx("td",{children:h(E.day)}),f.jsx("td",{children:m(E.startTime)}),f.jsx("td",{children:m(E.endTime)}),f.jsx("td",{children:E.breakStart&&E.breakEnd?`${m(E.breakStart)} - ${m(E.breakEnd)}`:"None"})]},x))})]})]})}):f.jsx(Nk,{children:f.jsx("p",{children:"No schedule has been assigned to you yet."})})})]})},t7=V.div`
  margin-bottom: 1.5rem;
`,ss=V.p`
  margin: 0.75rem 0;
  display: flex;
