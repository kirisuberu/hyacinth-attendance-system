 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(z,q){var Z=z.length;z.push(q);e:for(;0<Z;){var ce=Z-1>>>1,ee=z[ce];if(0<i(ee,q))z[ce]=q,z[Z]=ee,Z=ce;else break e}}function n(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var q=z[0],Z=z.pop();if(Z!==q){z[0]=Z;e:for(var ce=0,ee=z.length,ye=ee>>>1;ce<ye;){var qe=2*(ce+1)-1,Ge=z[qe],Xe=qe+1,F=z[Xe];if(0>i(Ge,Z))Xe<ee&&0>i(F,Ge)?(z[ce]=F,z[Xe]=Z,ce=Xe):(z[ce]=Ge,z[qe]=Z,ce=qe);else if(Xe<ee&&0>i(F,Z))z[ce]=F,z[Xe]=Z,ce=Xe;else break e}}return q}function i(z,q){var Z=z.sortIndex-q.sortIndex;return Z!==0?Z:z.id-q.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;t.unstable_now=function(){return o.now()}}else{var s=Date,a=s.now();t.unstable_now=function(){return s.now()-a}}var u=[],d=[],h=1,m=null,E=3,_=!1,x=!1,A=!1,S=typeof setTimeout=="function"?setTimeout:null,y=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function k(z){for(var q=n(d);q!==null;){if(q.callback===null)r(d);else if(q.startTime<=z)r(d),q.sortIndex=q.expirationTime,e(u,q);else break;q=n(d)}}function I(z){if(A=!1,k(z),!x)if(n(u)!==null)x=!0,pe(R);else{var q=n(d);q!==null&&me(I,q.startTime-z)}}function R(z,q){x=!1,A&&(A=!1,y(w),w=-1),_=!0;var Z=E;try{for(k(q),m=n(u);m!==null&&(!(m.expirationTime>q)||z&&!b());){var ce=m.callback;if(typeof ce=="function"){m.callback=null,E=m.priorityLevel;var ee=ce(m.expirationTime<=q);q=t.unstable_now(),typeof ee=="function"?m.callback=ee:m===n(u)&&r(u),k(q)}else r(u);m=n(u)}if(m!==null)var ye=!0;else{var qe=n(d);qe!==null&&me(I,qe.startTime-q),ye=!1}return ye}finally{m=null,E=Z,_=!1}}var N=!1,T=null,w=-1,L=5,j=-1;function b(){return!(t.unstable_now()-j<L)}function D(){if(T!==null){var z=t.unstable_now();j=z;var q=!0;try{q=T(!0,z)}finally{q?P():(N=!1,T=null)}}else N=!1}var P;if(typeof g=="function")P=function(){g(D)};else if(typeof MessageChannel<"u"){var G=new MessageChannel,ae=G.port2;G.port1.onmessage=D,P=function(){ae.postMessage(null)}}else P=function(){S(D,0)};function pe(z){T=z,N||(N=!0,P())}function me(z,q){w=S(function(){z(t.unstable_now())},q)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(z){z.callback=null},t.unstable_continueExecution=function(){x||_||(x=!0,pe(R))},t.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):L=0<z?Math.floor(1e3/z):5},t.unstable_getCurrentPriorityLevel=function(){return E},t.unstable_getFirstCallbackNode=function(){return n(u)},t.unstable_next=function(z){switch(E){case 1:case 2:case 3:var q=3;break;default:q=E}var Z=E;E=q;try{return z()}finally{E=Z}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(z,q){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var Z=E;E=z;try{return q()}finally{E=Z}},t.unstable_scheduleCallback=function(z,q,Z){var ce=t.unstable_now();switch(typeof Z=="object"&&Z!==null?(Z=Z.delay,Z=typeof Z=="number"&&0<Z?ce+Z:ce):Z=ce,z){case 1:var ee=-1;break;case 2:ee=250;break;case 5:ee=1073741823;break;case 4:ee=1e4;break;default:ee=5e3}return ee=Z+ee,z={id:h++,callback:q,priorityLevel:z,startTime:Z,expirationTime:ee,sortIndex:-1},Z>ce?(z.sortIndex=Z,e(d,z),n(u)===null&&z===n(d)&&(A?(y(w),w=-1):A=!0,me(I,Z-ce))):(z.sortIndex=ee,e(u,z),x||_||(x=!0,pe(R))),z},t.unstable_shouldYield=b,t.unstable_wrapCallback=function(z){var q=E;return function(){var Z=E;E=q;try{return z.apply(this,arguments)}finally{E=Z}}}})(Xk);Qk.exports=Xk;var ZS=Qk.exports;/**
 * @license React
...
*/var Yi,ax;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(T,w){function L(){}L.prototype=w.prototype,T.D=w.prototype,T.prototype=new L,T.prototype.constructor=T,T.C=function(j,b,D){for(var P=Array(arguments.length-2),G=2;G<arguments.length;G++)P[G-2]=arguments[G];return w.prototype[b].apply(j,P)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(T,w,L){L||(L=0);var j=Array(16);if(typeof w=="string")for(var b=0;16>b;++b)j[b]=w.charCodeAt(L++)|w.charCodeAt(L++)<<8|w.charCodeAt(L++)<<16|w.charCodeAt(L++)<<24;else for(b=0;16>b;++b)j[b]=w[L++]|w[L++]<<8|w[L++]<<16|w[L++]<<24;w=T.g[0],L=T.g[1],b=T.g[2];var D=T.g[3],P=w+(D^L&(b^D))+j[0]+3614090360&4294967295;w=L+(P<<7&4294967295|P>>>25),P=D+(b^w&(L^b))+j[1]+3905402710&4294967295,D=w+(P<<12&4294967295|P>>>20),P=b+(L^D&(w^L))+j[2]+606105819&4294967295,b=D+(P<<17&4294967295|P>>>15),P=L+(w^b&(D^w))+j[3]+3250441966&4294967295,L=b+(P<<22&4294967295|P>>>10),P=w+(D^L&(b^D))+j[4]+4118548399&4294967295,w=L+(P<<7&4294967295|P>>>25),P=D+(b^w&(L^b))+j[5]+1200080426&4294967295,D=w+(P<<12&4294967295|P>>>20),P=b+(L^D&(w^L))+j[6]+2821735955&4294967295,b=D+(P<<17&4294967295|P>>>15),P=L+(w^b&(D^w))+j[7]+4249261313&4294967295,L=b+(P<<22&4294967295|P>>>10),P=w+(D^L&(b^D))+j[8]+1770035416&4294967295,w=L+(P<<7&4294967295|P>>>25),P=D+(b^w&(L^b))+j[9]+2336552879&4294967295,D=w+(P<<12&4294967295|P>>>20),P=b+(L^D&(w^L))+j[10]+4294925233&4294967295,b=D+(P<<17&4294967295|P>>>15),P=L+(w^b&(D^w))+j[11]+2304563134&4294967295,L=b+(P<<22&4294967295|P>>>10),P=w+(D^L&(b^D))+j[12]+1804603682&4294967295,w=L+(P<<7&4294967295|P>>>25),P=D+(b^w&(L^b))+j[13]+4254626195&4294967295,D=w+(P<<12&4294967295|P>>>20),P=b+(L^D&(w^L))+j[14]+2792965006&4294967295,b=D+(P<<17&4294967295|P>>>15),P=L+(w^b&(D^w))+j[15]+1236535329&4294967295,L=b+(P<<22&4294967295|P>>>10),P=w+(b^D&(L^b))+j[1]+4129170786&4294967295,w=L+(P<<5&4294967295|P>>>27),P=D+(L^b&(w^L))+j[6]+3225465664&4294967295,D=w+(P<<9&4294967295|P>>>23),P=b+(w^L&(D^w))+j[11]+643717713&4294967295,b=D+(P<<14&4294967295|P>>>18),P=L+(D^w&(b^D))+j[0]+3921069994&4294967295,L=b+(P<<20&4294967295|P>>>12),P=w+(b^D&(L^b))+j[5]+3593408605&4294967295,w=L+(P<<5&4294967295|P>>>27),P=D+(L^b&(w^L))+j[10]+38016083&4294967295,D=w+(P<<9&4294967295|P>>>23),P=b+(w^L&(D^w))+j[15]+3634488961&4294967295,b=D+(P<<14&4294967295|P>>>18),P=L+(D^w&(b^D))+j[4]+3889429448&4294967295,L=b+(P<<20&4294967295|P>>>12),P=w+(b^D&(L^b))+j[9]+568446438&4294967295,w=L+(P<<5&4294967295|P>>>27),P=D+(L^b&(w^L))+j[14]+3275163606&4294967295,D=w+(P<<9&4294967295|P>>>23),P=b+(w^L&(D^w))+j[3]+4107603335&4294967295,b=D+(P<<14&4294967295|P>>>18),P=L+(D^w&(b^D))+j[8]+1163531501&4294967295,L=b+(P<<20&4294967295|P>>>12),P=w+(b^D&(L^b))+j[13]+2850285829&4294967295,w=L+(P<<5&4294967295|P>>>27),P=D+(L^b&(w^L))+j[2]+4243563512&4294967295,D=w+(P<<9&4294967295|P>>>23),P=b+(w^L&(D^w))+j[7]+1735328473&4294967295,b=D+(P<<14&4294967295|P>>>18),P=L+(D^w&(b^D))+j[12]+2368359562&4294967295,L=b+(P<<20&4294967295|P>>>12),P=w+(L^b^D)+j[5]+4294588738&4294967295,w=L+(P<<4&4294967295|P>>>28),P=D+(w^L^b)+j[8]+2272392833&4294967295,D=w+(P<<11&4294967295|P>>>21),P=b+(D^w^L)+j[11]+1839030562&4294967295,b=D+(P<<16&4294967295|P>>>16),P=L+(b^D^w)+j[14]+4259657740&4294967295,L=b+(P<<23&4294967295|P>>>9),P=w+(L^b^D)+j[1]+2763975236&4294967295,w=L+(P<<4&4294967295|P>>>28),P=D+(w^L^b)+j[4]+1272893353&4294967295,D=w+(P<<11&4294967295|P>>>21),P=b+(D^w^L)+j[7]+4139469664&4294967295,b=D+(P<<16&4294967295|P>>>16),P=L+(b^D^w)+j[10]+3200236656&4294967295,L=b+(P<<23&4294967295|P>>>9),P=w+(L^b^D)+j[13]+681279174&4294967295,w=L+(P<<4&4294967295|P>>>28),P=D+(w^L^b)+j[0]+3936430074&4294967295,D=w+(P<<11&4294967295|P>>>21),P=b+(D^w^L)+j[3]+3572445317&4294967295,b=D+(P<<16&4294967295|P>>>16),P=L+(b^D^w)+j[6]+76029189&4294967295,L=b+(P<<23&4294967295|P>>>9),P=w+(L^b^D)+j[9]+3654602809&4294967295,w=L+(P<<4&4294967295|P>>>28),P=D+(w^L^b)+j[12]+3873151461&4294967295,D=w+(P<<11&4294967295|P>>>21),P=b+(D^w^L)+j[15]+530742520&4294967295,b=D+(P<<16&4294967295|P>>>16),P=L+(b^D^w)+j[2]+3299628645&4294967295,L=b+(P<<23&4294967295|P>>>9),P=w+(b^(L|~D))+j[0]+4096336452&4294967295,w=L+(P<<6&4294967295|P>>>26),P=D+(L^(w|~b))+j[7]+1126891415&4294967295,D=w+(P<<10&4294967295|P>>>22),P=b+(w^(D|~L))+j[14]+2878612391&4294967295,b=D+(P<<15&4294967295|P>>>17),P=L+(D^(b|~w))+j[5]+4237533241&4294967295,L=b+(P<<21&4294967295|P>>>11),P=w+(b^(L|~D))+j[12]+1700485571&4294967295,w=L+(P<<6&4294967295|P>>>26),P=D+(L^(w|~b))+j[3]+2399980690&4294967295,D=w+(P<<10&4294967295|P>>>22),P=b+(w^(D|~L))+j[10]+4293915773&4294967295,b=D+(P<<15&4294967295|P>>>17),P=L+(D^(b|~w))+j[1]+2240044497&4294967295,L=b+(P<<21&4294967295|P>>>11),P=w+(b^(L|~D))+j[8]+1873313359&4294967295,w=L+(P<<6&4294967295|P>>>26),P=D+(L^(w|~b))+j[15]+4264355552&4294967295,D=w+(P<<10&4294967295|P>>>22),P=b+(w^(D|~L))+j[6]+2734768916&4294967295,b=D+(P<<15&4294967295|P>>>17),P=L+(D^(b|~w))+j[13]+1309151649&4294967295,L=b+(P<<21&4294967295|P>>>11),P=w+(b^(L|~D))+j[4]+4149444226&4294967295,w=L+(P<<6&4294967295|P>>>26),P=D+(L^(w|~b))+j[11]+3174756917&4294967295,D=w+(P<<10&4294967295|P>>>22),P=b+(w^(D|~L))+j[2]+718787259&4294967295,b=D+(P<<15&4294967295|P>>>17),P=L+(D^(b|~w))+j[9]+3951481745&4294967295,T.g[0]=T.g[0]+w&4294967295,T.g[1]=T.g[1]+(b+(P<<21&4294967295|P>>>11))&4294967295,T.g[2]=T.g[2]+b&4294967295,T.g[3]=T.g[3]+D&4294967295}r.prototype.u=function(T,w){w===void 0&&(w=T.length);for(var L=w-this.blockSize,j=this.B,b=this.h,D=0;D<w;){if(b==0)for(;D<=L;)i(this,T,D),D+=this.blockSize;if(typeof T=="string"){for(;D<w;)if(j[b++]=T.charCodeAt(D++),b==this.blockSize){i(this,j),b=0;break}}else for(;D<w;)if(j[b++]=T[D++],b==this.blockSize){i(this,j),b=0;break}}this.h=b,this.o+=w},r.prototype.v=function(){var T=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);T[0]=128;for(var w=1;w<T.length-8;++w)T[w]=0;var L=8*this.o;for(w=T.length-8;w<T.length;++w)T[w]=L&255,L/=256;for(this.u(T),T=Array(16),w=L=0;4>w;++w)for(var j=0;32>j;j+=8)T[L++]=this.g[w]>>>j&255;return T};function o(T,w){var L=a;return Object.prototype.hasOwnProperty.call(L,T)?L[T]:L[T]=w(T)}function s(T,w){this.h=w;for(var L=[],j=!0,b=T.length-1;0<=b;b--){var D=T[b]|0;j&&D==w||(L[b]=D,j=!1)}this.g=L}var a={};function u(T){return-128<=T&&128>T?o(T,function(w){return new s([w|0],0>w?-1:0)}):new s([T|0],0>T?-1:0)}function d(T){if(isNaN(T)||!isFinite(T))return m;if(0>T)return S(d(-T));for(var w=[],L=1,j=0;T>=L;j++)w[j]=T/L|0,L*=4294967296;return new s(w,0)}function h(T,w){if(T.length==0)throw Error("number format error: empty string");if(w=w||10,2>w||36<w)throw Error("radix out of range: "+w);if(T.charAt(0)=="-")return S(h(T.substring(1),w));if(0<=T.indexOf("-"))throw Error('number format error: interior "-" character');for(var L=d(Math.pow(w,8)),j=m,b=0;b<T.length;b+=8){var D=Math.min(8,T.length-b),P=parseInt(T.substring(b,b+D),w);8>D?(D=d(Math.pow(w,D)),j=j.j(D).add(d(P))):(j=j.j(L),j=j.add(d(P)))}return j}var m=u(0),E=u(1),_=u(16777216);t=s.prototype,t.m=function(){if(A(this))return-S(this).m();for(var T=0,w=1,L=0;L<this.g.length;L++){var j=this.i(L);T+=(0<=j?j:4294967296+j)*w,w*=4294967296}return T},t.toString=function(T){if(T=T||10,2>T||36<T)throw Error("radix out of range: "+T);if(x(this))return"0";if(A(this))return"-"+S(this).toString(T);for(var w=d(Math.pow(T,6)),L=this,j="";;){var b=I(L,w).g;L=y(L,b.j(w));var D=((0<L.g.length?L.g[0]:L.h)>>>0).toString(T);if(L=b,x(L))return D+j;for(;6>D.length;)D="0"+D;j=D+j}},t.i=function(T){return 0>T?0:T<this.g.length?this.g[T]:this.h};function x(T){if(T.h!=0)return!1;for(var w=0;w<T.g.length;w++)if(T.g[w]!=0)return!1;return!0}function A(T){return T.h==-1}t.l=function(T){return T=y(this,T),A(T)?-1:x(T)?0:1};function S(T){for(var w=T.g.length,L=[],j=0;j<w;j++)L[j]=~T.g[j];return new s(L,~T.h).add(E)}t.abs=function(){return A(this)?S(this):this},t.add=function(T){for(var w=Math.max(this.g.length,T.g.length),L=[],j=0,b=0;b<=w;b++){var D=j+(this.i(b)&65535)+(T.i(b)&65535),P=(D>>>16)+(this.i(b)>>>16)+(T.i(b)>>>16);j=P>>>16,D&=65535,P&=65535,L[b]=P<<16|D}return new s(L,L[L.length-1]&-2147483648?-1:0)};function y(T,w){return T.add(S(w))}t.j=function(T){if(x(this)||x(T))return m;if(A(this))return A(T)?S(this).j(S(T)):S(S(this).j(T));if(A(T))return S(this.j(S(T)));if(0>this.l(_)&&0>T.l(_))return d(this.m()*T.m());for(var w=this.g.length+T.g.length,L=[],j=0;j<2*w;j++)L[j]=0;for(j=0;j<this.g.length;j++)for(var b=0;b<T.g.length;b++){var D=this.i(j)>>>16,P=this.i(j)&65535,G=T.i(b)>>>16,ae=T.i(b)&65535;L[2*j+2*b]+=P*ae,g(L,2*j+2*b),L[2*j+2*b+1]+=D*ae,g(L,2*j+2*b+1),L[2*j+2*b+1]+=P*G,g(L,2*j+2*b+1),L[2*j+2*b+2]+=D*G,g(L,2*j+2*b+2)}for(j=0;j<w;j++)L[j]=L[2*j+1]<<16|L[2*j];for(j=w;j<2*w;j++)L[j]=0;return new s(L,0)};function g(T,w){for(;(T[w]&65535)!=T[w];)T[w+1]+=T[w]>>>16,T[w]&=65535,w++}function k(T,w){this.g=T,this.h=w}function I(T,w){if(x(w))throw Error("division by zero");if(x(T))return new k(m,m);if(A(T))return w=I(S(T),w),new k(S(w.g),S(w.h));if(A(w))return w=I(T,S(w)),new k(S(w.g),w.h);if(30<T.g.length){if(A(T)||A(w))throw Error("slowDivide_ only works with positive integers.");for(var L=E,j=w;0>=j.l(T);)L=R(L),j=R(j);var b=N(L,1),D=N(j,1);for(j=N(j,2),L=N(L,2);!x(j);){var P=D.add(j);0>=P.l(T)&&(b=b.add(L),D=P),j=N(j,1),L=N(L,1)}return w=y(T,b.j(w)),new k(b,w)}for(b=m;0<=T.l(w);){for(L=Math.max(1,Math.floor(T.m()/w.m())),j=Math.ceil(Math.log(L)/Math.LN2),j=48>=j?1:Math.pow(2,j-48),D=d(L),P=D.j(w);A(P)||0<P.l(T);)L-=j,D=d(L),P=D.j(w);x(D)&&(D=E),b=b.add(D),T=y(T,P)}return new k(b,T)}t.A=function(T){return I(this,T).h},t.and=function(T){for(var w=Math.max(this.g.length,T.g.length),L=[],j=0;j<w;j++)L[j]=this.i(j)&T.i(j);return new s(L,this.h&T.h)},t.or=function(T){for(var w=Math.max(this.g.length,T.g.length),L=[],j=0;j<w;j++)L[j]=this.i(j)|T.i(j);return new s(L,this.h|T.h)},t.xor=function(T){for(var w=Math.max(this.g.length,T.g.length),L=[],j=0;j<w;j++)L[j]=this.i(j)^T.i(j);return new s(L,this.h^T.h)};function R(T){for(var w=T.g.length+1,L=[],j=0;j<w;j++)L[j]=T.i(j)<<1|T.i(j-1)>>>31;return new s(L,T.h)}function N(T,w){var L=w>>5;w%=32;for(var j=T.g.length-L,b=[],D=0;D<j;D++)b[D]=0<w?T.i(D+L)>>>w|T.i(D+L+1)<<32-w:T.i(D+L);return new s(b,T.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,ax=r,s.prototype.add=s.prototype.add,s.prototype.multiply=s.prototype.j,s.prototype.modulo=s.prototype.A,s.prototype.compare=s.prototype.l,s.prototype.toNumber=s.prototype.m,s.prototype.toString=s.prototype.toString,s.prototype.getBits=s.prototype.i,s.fromNumber=d,s.fromString=h,Yi=s}).apply(typeof q_<"u"?q_:typeof self<"u"?self:typeof window<"u"?window:{});var rc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var lx,Za,ux,Rc,bm,cx,dx,hx;(function(){var t,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(l,p,v){return l==Array.prototype||l==Object.prototype||(l[p]=v.value),l};function n(l){l=[typeof globalThis=="object"&&globalThis,l,typeof window=="object"&&window,typeof self=="object"&&self,typeof rc=="object"&&rc];for(var p=0;p<l.length;++p){var v=l[p];if(v&&v.Math==Math)return v}throw Error("Cannot find global object")}var r=n(this);function i(l,p){if(p)e:{var v=r;l=l.split(".");for(var C=0;C<l.length-1;C++){var M=l[C];if(!(M in v))break e;v=v[M]}l=l[l.length-1],C=v[l],p=p(C),p!=C&&p!=null&&e(v,l,{configurable:!0,writable:!0,value:p})}}function o(l,p){l instanceof String&&(l+="");var v=0,C=!1,M={next:function(){if(!C&&v<l.length){var U=v++;return{value:p(U,l[U]),done:!1}}return C=!0,{done:!0,value:void 0}}};return M[Symbol.iterator]=function(){return M},M}i("Array.prototype.values",function(l){return l||function(){return o(this,function(p,v){return v})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var s=s||{},a=this||self;function u(l){var p=typeof l;return p=p!="object"?p:l?Array.isArray(l)?"array":p:"null",p=="array"||p=="object"&&typeof l.length=="number"}function d(l){var p=typeof l;return p=="object"&&l!=null||p=="function"}function h(l,p,v){return l.call.apply(l.bind,arguments)}function m(l,p,v){if(!l)throw Error();if(2<arguments.length){var C=Array.prototype.slice.call(arguments,2);return function(){var M=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(M,C),l.apply(p,M)}}return function(){return l.apply(p,arguments)}}function E(l,p,v){return E=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?h:m,E.apply(null,arguments)}function _(l,p){var v=Array.prototype.slice.call(arguments,1);return function(){var C=v.slice();return C.push.apply(C,arguments),l.apply(this,C)}}function x(l,p){function v(){}v.prototype=p.prototype,l.aa=p.prototype,l.prototype=new v,l.prototype.constructor=l,l.Qb=function(C,M,U){for(var H=Array(arguments.length-2),Le=2;Le<arguments.length;Le++)H[Le-2]=arguments[Le];return p.prototype[M].apply(C,H)}}function A(l){const p=l.length;if(0<p){const v=Array(p);for(let C=0;C<p;C++)v[C]=l[C];return v}return[]}function S(l,p){for(let v=1;v<arguments.length;v++){const C=arguments[v];if(u(C)){const M=l.length||0,U=C.length||0;l.length=M+U;for(let H=0;H<U;H++)l[M+H]=C[H]}else l.push(C)}}class y{constructor(p,v){this.i=p,this.j=v,this.h=0,this.g=null}get(){let p;return 0<this.h?(this.h--,p=this.g,this.g=p.next,p.next=null):p=this.i(),p}}function g(l){return/^[\s\xa0]*$/.test(l)}function k(){var l=a.navigator;return l&&(l=l.userAgent)?l:""}function I(l){return I[" "](l),l}I[" "]=function(){};var R=k().indexOf("Gecko")!=-1&&!(k().toLowerCase().indexOf("webkit")!=-1&&k().indexOf("Edge")==-1)&&!(k().indexOf("Trident")!=-1||k().indexOf("MSIE")!=-1)&&k().indexOf("Edge")==-1;function N(l,p,v){for(const C in l)p.call(v,l[C],C,l)}function T(l,p){for(const v in l)p.call(void 0,l[v],v,l)}function w(l){const p={};for(const v in l)p[v]=l[v];return p}const L="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function j(l,p){let v,C;for(let M=1;M<arguments.length;M++){C=arguments[M];for(v in C)l[v]=C[v];for(let U=0;U<L.length;U++)v=L[U],Object.prototype.hasOwnProperty.call(C,v)&&(l[v]=C[v])}}function b(l){var p=1;l=l.split(":");const v=[];for(;0<p&&l.length;)v.push(l.shift()),p--;return l.length&&v.push(l.join(":")),v}function D(l){a.setTimeout(()=>{throw l},0)}function P(){var l=q;let p=null;return l.g&&(p=l.g,l.g=l.g.next,l.g||(l.h=null),p.next=null),p}class G{constructor(){this.h=this.g=null}add(p,v){const C=ae.get();C.set(p,v),this.h?this.h.next=C:this.g=C,this.h=C}}var ae=new y(()=>new pe,l=>l.reset());class pe{constructor(){this.next=this.g=this.h=null}set(p,v){this.h=p,this.g=v,this.next=null}reset(){this.next=this.g=this.h=null}}let me,z=!1,q=new G,Z=()=>{const l=a.Promise.resolve(void 0);me=()=>{l.then(ce)}};var ce=()=>{for(var l;l=P();){try{l.h.call(l.g)}catch(v){D(v)}var p=ae;p.j(l),100>p.h&&(p.h++,l.next=p.g,p.g=l)}z=!1};function ee(){this.s=this.s,this.C=this.C}ee.prototype.s=!1,ee.prototype.ma=function(){this.s||(this.s=!0,this.N())},ee.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function ye(l,p){this.type=l,this.g=this.target=p,this.defaultPrevented=!1}ye.prototype.h=function(){this.defaultPrevented=!0};var qe=function(){if(!a.addEventListener||!Object.defineProperty)return!1;var l=!1,p=Object.defineProperty({},"passive",{get:function(){l=!0}});try{const v=()=>{};a.addEventListener("test",v,p),a.removeEventListener("test",v,p)}catch{}return l}();function Ge(l,p){if(ye.call(this,l?l.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,l){var v=this.type=l.type,C=l.changedTouches&&l.changedTouches.length?l.changedTouches[0]:null;if(this.target=l.target||l.srcElement,this.g=p,p=l.relatedTarget){if(R){e:{try{I(p.nodeName);var M=!0;break e}catch{}M=!1}M||(p=null)}}else v=="mouseover"?p=l.fromElement:v=="mouseout"&&(p=l.toElement);this.relatedTarget=p,C?(this.clientX=C.clientX!==void 0?C.clientX:C.pageX,this.clientY=C.clientY!==void 0?C.clientY:C.pageY,this.screenX=C.screenX||0,this.screenY=C.screenY||0):(this.clientX=l.clientX!==void 0?l.clientX:l.pageX,this.clientY=l.clientY!==void 0?l.clientY:l.pageY,this.screenX=l.screenX||0,this.screenY=l.screenY||0),this.button=l.button,this.key=l.key||"",this.ctrlKey=l.ctrlKey,this.altKey=l.altKey,this.shiftKey=l.shiftKey,this.metaKey=l.metaKey,this.pointerId=l.pointerId||0,this.pointerType=typeof l.pointerType=="string"?l.pointerType:Xe[l.pointerType]||"",this.state=l.state,this.i=l,l.defaultPrevented&&Ge.aa.h.call(this)}}x(Ge,ye);var Xe={2:"touch",3:"pen",4:"mouse"};Ge.prototype.h=function(){Ge.aa.h.call(this);var l=this.i;l.preventDefault?l.preventDefault():l.returnValue=!1};var F="closure_listenable_"+(1e6*Math.random()|0),oe=0;function se(l,p,v,C,M){this.listener=l,this.proxy=null,this.src=p,this.type=v,this.capture=!!C,this.ha=M,this.key=++oe,this.da=this.fa=!1}function le(l){l.da=!0,l.listener=null,l.proxy=null,l.src=null,l.ha=null}function de(l){this.src=l,this.g={},this.h=0}de.prototype.add=function(l,p,v,C,M){var U=l.toString();l=this.g[U],l||(l=this.g[U]=[],this.h++);var H=Yo(l,p,C,M);return-1<H?(p=l[H],v||(p.fa=!1)):(p=new se(p,this.src,U,!!C,M),p.fa=v,l.push(p)),p};function Te(l,p){var v=p.type;if(v in l.g){var C=l.g[v],M=Array.prototype.indexOf.call(C,p,void 0),U;(U=0<=M)&&Array.prototype.splice.call(C,M,1),U&&(le(p),l.g[v].length==0&&(delete l.g[v],l.h--))}}function Yo(l,p,v,C){for(var M=0;M<l.length;++M){var U=l[M];if(!U.da&&U.listener==p&&U.capture==!!v&&U.ha==C)return M}return-1}var ya="closure_lm_"+(1e6*Math.random()|0),va={};function vt(l,p,v,C,M){if(Array.isArray(p)){for(var U=0;U<p.length;U++)vt(l,p[U],v,C,M);return null}return v=ry(v),l&&l[F]?l.K(p,v,d(C)?!!C.capture:!1,M):On(l,p,v,!1,C,M)}function On(l,p,v,C,M,U){if(!p)throw Error("Invalid event type");var H=d(M)?!!M.capture:!!M,Le=Zh(l);if(Le||(l[ya]=Le=new de(l)),v=Le.add(p,v,C,H,U),v.proxy)return v;if(C=Ko(),v.proxy=C,C.src=l,C.listener=v,l.addEventListener)qe||(M=H),M===void 0&&(M=!1),l.addEventListener(p.toString(),C,M);else if(l.attachEvent)l.attachEvent(ny(p.toString()),C);else if(l.addListener&&l.removeListener)l.addListener(C);else throw Error("addEventListener and attachEvent are unavailable.");return v}function Ko(){function l(v){return p.call(l.src,l.listener,v)}const p=nS;return l}function ty(l,p,v,C,M){if(Array.isArray(p))for(var U=0;U<p.length;U++)ty(l,p[U],v,C,M);else C=d(C)?!!C.capture:!!C,v=ry(v),l&&l[F]?(l=l.i,p=String(p).toString(),p in l.g&&(U=l.g[p],v=Yo(U,v,C,M),-1<v&&(le(U[v]),Array.prototype.splice.call(U,v,1),U.length==0&&(delete l.g[p],l.h--)))):l&&(l=Zh(l))&&(p=l.g[p.toString()],l=-1,p&&(l=Yo(p,v,C,M)),(v=-1<l?p[l]:null)&&Xh(v))}function Xh(l){if(typeof l!="number"&&l&&!l.da){var p=l.src;if(p&&p[F])Te(p.i,l);else{var v=l.type,C=l.proxy;p.removeEventListener?p.removeEventListener(v,C,l.capture):p.detachEvent?p.detachEvent(ny(v),C):p.addListener&&p.removeListener&&p.removeListener(C),(v=Zh(p))?(Te(v,l),v.h==0&&(v.src=null,p[ya]=null)):le(l)}}}function ny(l){return l in va?va[l]:va[l]="on"+l}function nS(l,p){if(l.da)l=!0;else{p=new Ge(p,this);var v=l.listener,C=l.ha||l.src;l.fa&&Xh(l),l=v.call(C,p)}return l}function Zh(l){return l=l[ya],l instanceof de?l:null}var Jh="__closure_events_fn_"+(1e9*Math.random()>>>0);function ry(l){return typeof l=="function"?l:(l[Jh]||(l[Jh]=function(p){return l.handleEvent(p)}),l[Jh])}function _t(){ee.call(this),this.i=new de(this),this.M=this,this.F=null}x(_t,ee),_t.prototype[F]=!0,_t.prototype.removeEventListener=function(l,p,v,C){ty(this,l,p,v,C)};function Rt(l,p){var v,C=l.F;if(C)for(v=[];C;C=C.F)v.push(C);if(l=l.M,C=p.type||p,typeof p=="string")p=new ye(p,l);else if(p instanceof ye)p.target=p.target||l;else{var M=p;p=new ye(C,l),j(p,M)}if(M=!0,v)for(var U=v.length-1;0<=U;U--){var H=p.g=v[U];M=Tu(H,C,!0,p)&&M}if(H=p.g=l,M=Tu(H,C,!0,p)&&M,M=Tu(H,C,!1,p)&&M,v)for(U=0;U<v.length;U++)H=p.g=v[U],M=Tu(H,C,!1,p)&&M}_t.prototype.N=function(){if(_t.aa.N.call(this),this.i){var l=this.i,p;for(p in l.g){for(var v=l.g[p],C=0;C<v.length;C++)le(v[C]);delete l.g[p],l.h--}}this.F=null},_t.prototype.K=function(l,p,v,C){return this.i.add(String(l),p,!1,v,C)},_t.prototype.L=function(l,p,v,C){return this.i.add(String(l),p,!0,v,C)};function Tu(l,p,v,C){if(p=l.i.g[String(p)],!p)return!0;p=p.concat();for(var M=!0,U=0;U<p.length;++U){var H=p[U];if(H&&!H.da&&H.capture==v){var Le=H.listener,ut=H.ha||H.src;H.fa&&Te(l.i,H),M=Le.call(ut,C)!==!1&&M}}return M&&!C.defaultPrevented}function iy(l,p,v){if(typeof l=="function")v&&(l=E(l,v));else if(l&&typeof l.handleEvent=="function")l=E(l.handleEvent,l);else throw Error("Invalid listener argument");return 2147483647<Number(p)?-1:a.setTimeout(l,p||0)}function oy(l){l.g=iy(()=>{l.g=null,l.i&&(l.i=!1,oy(l))},l.l);const p=l.h;l.h=null,l.m.apply(null,p)}class rS extends ee{constructor(p,v){super(),this.m=p,this.l=v,this.h=null,this.i=!1,this.g=null}j(p){this.h=arguments,this.g?this.i=!0:oy(this)}N(){super.N(),this.g&&(a.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function _a(l){ee.call(this),this.h=l,this.g={}}x(_a,ee);var sy=[];function ay(l){N(l.g,function(p,v){this.g.hasOwnProperty(v)&&Xh(p)},l),l.g={}}_a.prototype.N=function(){_a.aa.N.call(this),ay(this)},_a.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var ef=a.JSON.stringify,iS=a.JSON.parse,oS=class{stringify(l){return a.JSON.stringify(l,void 0)}parse(l){return a.JSON.parse(l,void 0)}};function tf(){}tf.prototype.h=null;function ly(l){return l.h||(l.h=l.i())}function uy(){}var ka={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function nf(){ye.call(this,"d")}x(nf,ye);function rf(){ye.call(this,"c")}x(rf,ye);var Ci={},cy=null;function xu(){return cy=cy||new _t}Ci.La="serverreachability";function dy(l){ye.call(this,Ci.La,l)}x(dy,ye);function Ea(l){const p=xu();Rt(p,new dy(p))}Ci.STAT_EVENT="statevent";function hy(l,p){ye.call(this,Ci.STAT_EVENT,l),this.stat=p}x(hy,ye);function bt(l){const p=xu();Rt(p,new hy(p,l))}Ci.Ma="timingevent";function fy(l,p){ye.call(this,Ci.Ma,l),this.size=p}x(fy,ye);function wa(l,p){if(typeof l!="function")throw Error("Fn must not be null and must be a function");return a.setTimeout(function(){l()},p)}function Ta(){this.g=!0}Ta.prototype.xa=function(){this.g=!1};function sS(l,p,v,C,M,U){l.info(function(){if(l.g)if(U)for(var H="",Le=U.split("&"),ut=0;ut<Le.length;ut++){var ke=Le[ut].split("=");if(1<ke.length){var kt=ke[0];ke=ke[1];var Et=kt.split("_");H=2<=Et.length&&Et[1]=="type"?H+(kt+"="+ke+"&"):H+(kt+"=redacted&")}}else H=null;else H=U;return"XMLHTTP REQ ("+C+") [attempt "+M+"]: "+p+`
`+v+`
`+H})}function aS(l,p,v,C,M,U,H){l.info(function(){return"XMLHTTP RESP ("+C+") [ attempt "+M+"]: "+p+`
`+v+`
`+U+" "+H})}function Qo(l,p,v,C){l.info(function(){return"XMLHTTP TEXT ("+p+"): "+uS(l,v)+(C?" "+C:"")})}function lS(l,p){l.info(function(){return"TIMEOUT: "+p})}Ta.prototype.info=function(){};function uS(l,p){if(!l.g)return p;if(!p)return null;try{var v=JSON.parse(p);if(v){for(l=0;l<v.length;l++)if(Array.isArray(v[l])){var C=v[l];if(!(2>C.length)){var M=C[1];if(Array.isArray(M)&&!(1>M.length)){var U=M[0];if(U!="noop"&&U!="stop"&&U!="close")for(var H=1;H<M.length;H++)M[H]=""}}}}return ef(v)}catch{return p}}var Iu={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},py={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},of;function Su(){}x(Su,tf),Su.prototype.g=function(){return new XMLHttpRequest},Su.prototype.i=function(){return{}},of=new Su;function Ar(l,p,v,C){this.j=l,this.i=p,this.l=v,this.R=C||1,this.U=new _a(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new my}function my(){this.i=null,this.g="",this.h=!1}var gy={},sf={};function af(l,p,v){l.L=1,l.v=Pu(nr(p)),l.m=v,l.P=!0,yy(l,null)}function yy(l,p){l.F=Date.now(),Cu(l),l.A=nr(l.v);var v=l.A,C=l.R;Array.isArray(C)||(C=[String(C)]),Ry(v.i,"t",C),l.C=0,v=l.j.J,l.h=new my,l.g=Ky(l.j,v?p:null,!l.m),0<l.O&&(l.M=new rS(E(l.Y,l,l.g),l.O)),p=l.U,v=l.g,C=l.ca;var M="readystatechange";Array.isArray(M)||(M&&(sy[0]=M.toString()),M=sy);for(var U=0;U<M.length;U++){var H=vt(v,M[U],C||p.handleEvent,!1,p.h||p);if(!H)break;p.g[H.key]=H}p=l.H?w(l.H):{},l.m?(l.u||(l.u="POST"),p["Content-Type"]="application/x-www-form-urlencoded",l.g.ea(l.A,l.u,l.m,p)):(l.u="GET",l.g.ea(l.A,l.u,null,p)),Ea(),sS(l.i,l.u,l.A,l.l,l.R,l.m)}Ar.prototype.ca=function(l){l=l.target;const p=this.M;p&&rr(l)==3?p.j():this.Y(l)},Ar.prototype.Y=function(l){try{if(l==this.g)e:{const Et=rr(this.g);var p=this.g.Ba();const Jo=this.g.Z();if(!(3>Et)&&(Et!=3||this.g&&(this.h.h||this.g.oa()||Vy(this.g)))){this.J||Et!=4||p==7||(p==8||0>=Jo?Ea(3):Ea(2)),lf(this);var v=this.g.Z();this.X=v;t:if(vy(this)){var C=Vy(this.g);l="";var M=C.length,U=rr(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){Ai(this),xa(this);var H="";break t}this.h.i=new a.TextDecoder}for(p=0;p<M;p++)this.h.h=!0,l+=this.h.i.decode(C[p],{stream:!(U&&p==M-1)});C.length=0,this.h.g+=l,this.C=0,H=this.h.g}else H=this.g.oa();if(this.o=v==200,aS(this.i,this.u,this.A,this.l,this.R,Et,v),this.o){if(this.T&&!this.K){t:{if(this.g){var Le,ut=this.g;if((Le=ut.g?ut.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!g(Le)){var ke=Le;break t}}ke=null}if(v=ke)Qo(this.i,this.l,v,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,uf(this,v);else{this.o=!1,this.s=3,bt(12),Ai(this),xa(this);break e}}if(this.P){v=!0;let vn;for(;!this.J&&this.C<H.length;)if(vn=cS(this,H),vn==sf){Et==4&&(this.s=4,bt(14),v=!1),Qo(this.i,this.l,null,"[Incomplete Response]");break}else if(vn==gy){this.s=4,bt(15),Qo(this.i,this.l,H,"[Invalid Chunk]"),v=!1;break}else Qo(this.i,this.l,vn,null),uf(this,vn);if(vy(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Et!=4||H.length!=0||this.h.h||(this.s=1,bt(16),v=!1),this.o=this.o&&v,!v)Qo(this.i,this.l,H,"[Invalid Chunked Response]"),Ai(this),xa(this);else if(0<H.length&&!this.W){this.W=!0;var kt=this.j;kt.g==this&&kt.ba&&!kt.M&&(kt.j.info("Great, no buffering proxy detected. Bytes received: "+H.length),mf(kt),kt.M=!0,bt(11))}}else Qo(this.i,this.l,H,null),uf(this,H);Et==4&&Ai(this),this.o&&!this.J&&(Et==4?Hy(this.j,this):(this.o=!1,Cu(this)))}else CS(this.g),v==400&&0<H.indexOf("Unknown SID")?(this.s=3,bt(12)):(this.s=0,bt(13)),Ai(this),xa(this)}}}catch{}finally{}};function vy(l){return l.g?l.u=="GET"&&l.L!=2&&l.j.Ca:!1}function cS(l,p){var v=l.C,C=p.indexOf(`
`,v);return C==-1?sf:(v=Number(p.substring(v,C)),isNaN(v)?gy:(C+=1,C+v>p.length?sf:(p=p.slice(C,C+v),l.C=C+v,p)))}Ar.prototype.cancel=function(){this.J=!0,Ai(this)};function Cu(l){l.S=Date.now()+l.I,_y(l,l.I)}function _y(l,p){if(l.B!=null)throw Error("WatchDog timer not null");l.B=wa(E(l.ba,l),p)}function lf(l){l.B&&(a.clearTimeout(l.B),l.B=null)}Ar.prototype.ba=function(){this.B=null;const l=Date.now();0<=l-this.S?(lS(this.i,this.A),this.L!=2&&(Ea(),bt(17)),Ai(this),this.s=2,xa(this)):_y(this,this.S-l)};function xa(l){l.j.G==0||l.J||Hy(l.j,l)}function Ai(l){lf(l);var p=l.M;p&&typeof p.ma=="function"&&p.ma(),l.M=null,ay(l.U),l.g&&(p=l.g,l.g=null,p.abort(),p.ma())}function uf(l,p){try{var v=l.j;if(v.G!=0&&(v.g==l||cf(v.h,l))){if(!l.K&&cf(v.h,l)&&v.G==3){try{var C=v.Da.g.parse(p)}catch{C=null}if(Array.isArray(C)&&C.length==3){var M=C;if(M[0]==0){e:if(!v.u){if(v.g)if(v.g.F+3e3<l.F)Nu(v),Du(v);else break e;pf(v),bt(18)}}else v.za=M[1],0<v.za-v.T&&37500>M[2]&&v.F&&v.v==0&&!v.C&&(v.C=wa(E(v.Za,v),6e3));if(1>=wy(v.h)&&v.ca){try{v.ca()}catch{}v.ca=void 0}}else Pi(v,11)}else if((l.K||v.g==l)&&Nu(v),!g(p))for(M=v.Da.g.parse(p),p=0;p<M.length;p++){let ke=M[p];if(v.T=ke[0],ke=ke[1],v.G==2)if(ke[0]=="c"){v.K=ke[1],v.ia=ke[2];const kt=ke[3];kt!=null&&(v.la=kt,v.j.info("VER="+v.la));const Et=ke[4];Et!=null&&(v.Aa=Et,v.j.info("SVER="+v.Aa));const Jo=ke[5];Jo!=null&&typeof Jo=="number"&&0<Jo&&(C=1.5*Jo,v.L=C,v.j.info("backChannelRequestTimeoutMs_="+C)),C=v;const vn=l.g;if(vn){const Vu=vn.g?vn.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Vu){var U=C.h;U.g||Vu.indexOf("spdy")==-1&&Vu.indexOf("quic")==-1&&Vu.indexOf("h2")==-1||(U.j=U.l,U.g=new Set,U.h&&(df(U,U.h),U.h=null))}if(C.D){const gf=vn.g?vn.g.getResponseHeader("X-HTTP-Session-Id"):null;gf&&(C.ya=gf,be(C.I,C.D,gf))}}v.G=3,v.l&&v.l.ua(),v.ba&&(v.R=Date.now()-l.F,v.j.info("Handshake RTT: "+v.R+"ms")),C=v;var H=l;if(C.qa=Yy(C,C.J?C.ia:null,C.W),H.K){Ty(C.h,H);var Le=H,ut=C.L;ut&&(Le.I=ut),Le.B&&(lf(Le),Cu(Le)),C.g=H}else zy(C);0<v.i.length&&Ou(v)}else ke[0]!="stop"&&ke[0]!="close"||Pi(v,7);else v.G==3&&(ke[0]=="stop"||ke[0]=="close"?ke[0]=="stop"?Pi(v,7):ff(v):ke[0]!="noop"&&v.l&&v.l.ta(ke),v.v=0)}}Ea(4)}catch{}}var dS=class{constructor(l,p){this.g=l,this.map=p}};function ky(l){this.l=l||10,a.PerformanceNavigationTiming?(l=a.performance.getEntriesByType("navigation"),l=0<l.length&&(l[0].nextHopProtocol=="hq"||l[0].nextHopProtocol=="h2")):l=!!(a.chrome&&a.chrome.loadTimes&&a.chrome.loadTimes()&&a.chrome.loadTimes().wasFetchedViaSpdy),this.j=l?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Ey(l){return l.h?!0:l.g?l.g.size>=l.j:!1}function wy(l){return l.h?1:l.g?l.g.size:0}function cf(l,p){return l.h?l.h==p:l.g?l.g.has(p):!1}function df(l,p){l.g?l.g.add(p):l.h=p}function Ty(l,p){l.h&&l.h==p?l.h=null:l.g&&l.g.has(p)&&l.g.delete(p)}ky.prototype.cancel=function(){if(this.i=xy(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const l of this.g.values())l.cancel();this.g.clear()}};function xy(l){if(l.h!=null)return l.i.concat(l.h.D);if(l.g!=null&&l.g.size!==0){let p=l.i;for(const v of l.g.values())p=p.concat(v.D);return p}return A(l.i)}function hS(l){if(l.V&&typeof l.V=="function")return l.V();if(typeof Map<"u"&&l instanceof Map||typeof Set<"u"&&l instanceof Set)return Array.from(l.values());if(typeof l=="string")return l.split("");if(u(l)){for(var p=[],v=l.length,C=0;C<v;C++)p.push(l[C]);return p}p=[],v=0;for(C in l)p[v++]=l[C];return p}function fS(l){if(l.na&&typeof l.na=="function")return l.na();if(!l.V||typeof l.V!="function"){if(typeof Map<"u"&&l instanceof Map)return Array.from(l.keys());if(!(typeof Set<"u"&&l instanceof Set)){if(u(l)||typeof l=="string"){var p=[];l=l.length;for(var v=0;v<l;v++)p.push(v);return p}p=[],v=0;for(const C in l)p[v++]=C;return p}}}function Iy(l,p){if(l.forEach&&typeof l.forEach=="function")l.forEach(p,void 0);else if(u(l)||typeof l=="string")Array.prototype.forEach.call(l,p,void 0);else for(var v=fS(l),C=hS(l),M=C.length,U=0;U<M;U++)p.call(void 0,C[U],v&&v[U],l)}var Sy=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function pS(l,p){if(l){l=l.split("&");for(var v=0;v<l.length;v++){var C=l[v].indexOf("="),M=null;if(0<=C){var U=l[v].substring(0,C);M=l[v].substring(C+1)}else U=l[v];p(U,M?decodeURIComponent(M.replace(/\+/g," ")):"")}}}function Li(l){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,l instanceof Li){this.h=l.h,Au(this,l.j),this.o=l.o,this.g=l.g,Lu(this,l.s),this.l=l.l;var p=l.i,v=new Ca;v.i=p.i,p.g&&(v.g=new Map(p.g),v.h=p.h),Cy(this,v),this.m=l.m}else l&&(p=String(l).match(Sy))?(this.h=!1,Au(this,p[1]||"",!0),this.o=Ia(p[2]||""),this.g=Ia(p[3]||"",!0),Lu(this,p[4]),this.l=Ia(p[5]||"",!0),Cy(this,p[6]||"",!0),this.m=Ia(p[7]||"")):(this.h=!1,this.i=new Ca(null,this.h))}Li.prototype.toString=function(){var l=[],p=this.j;p&&l.push(Sa(p,Ay,!0),":");var v=this.g;return(v||p=="file")&&(l.push("//"),(p=this.o)&&l.push(Sa(p,Ay,!0),"@"),l.push(encodeURIComponent(String(v)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),v=this.s,v!=null&&l.push(":",String(v))),(v=this.l)&&(this.g&&v.charAt(0)!="/"&&l.push("/"),l.push(Sa(v,v.charAt(0)=="/"?yS:gS,!0))),(v=this.i.toString())&&l.push("?",v),(v=this.m)&&l.push("#",Sa(v,_S)),l.join("")};function nr(l){return new Li(l)}function Au(l,p,v){l.j=v?Ia(p,!0):p,l.j&&(l.j=l.j.replace(/:$/,""))}function Lu(l,p){if(p){if(p=Number(p),isNaN(p)||0>p)throw Error("Bad port number "+p);l.s=p}else l.s=null}function Cy(l,p,v){p instanceof Ca?(l.i=p,kS(l.i,l.h)):(v||(p=Sa(p,vS)),l.i=new Ca(p,l.h))}function be(l,p,v){l.i.set(p,v)}function Pu(l){return be(l,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),l}function Ia(l,p){return l?p?decodeURI(l.replace(/%25/g,"%2525")):decodeURIComponent(l):""}function Sa(l,p,v){return typeof l=="string"?(l=encodeURI(l).replace(p,mS),v&&(l=l.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),l):null}function mS(l){return l=l.charCodeAt(0),"%"+(l>>4&15).toString(16)+(l&15).toString(16)}var Ay=/[#\/\?@]/g,gS=/[#\?:]/g,yS=/[#\?]/g,vS=/[#\?@]/g,_S=/#/g;function Ca(l,p){this.h=this.g=null,this.i=l||null,this.j=!!p}function Lr(l){l.g||(l.g=new Map,l.h=0,l.i&&pS(l.i,function(p,v){l.add(decodeURIComponent(p.replace(/\+/g," ")),v)}))}t=Ca.prototype,t.add=function(l,p){Lr(this),this.i=null,l=Xo(this,l);var v=this.g.get(l);return v||this.g.set(l,v=[]),v.push(p),this.h+=1,this};function Ly(l,p){Lr(l),p=Xo(l,p),l.g.has(p)&&(l.i=null,l.h-=l.g.get(p).length,l.g.delete(p))}function Py(l,p){return Lr(l),p=Xo(l,p),l.g.has(p)}t.forEach=function(l,p){Lr(this),this.g.forEach(function(v,C){v.forEach(function(M){l.call(p,M,C,this)},this)},this)},t.na=function(){Lr(this);const l=Array.from(this.g.values()),p=Array.from(this.g.keys()),v=[];for(let C=0;C<p.length;C++){const M=l[C];for(let U=0;U<M.length;U++)v.push(p[C])}return v},t.V=function(l){Lr(this);let p=[];if(typeof l=="string")Py(this,l)&&(p=p.concat(this.g.get(Xo(this,l))));else{l=Array.from(this.g.values());for(let v=0;v<l.length;v++)p=p.concat(l[v])}return p},t.set=function(l,p){return Lr(this),this.i=null,l=Xo(this,l),Py(this,l)&&(this.h-=this.g.get(l).length),this.g.set(l,[p]),this.h+=1,this},t.get=function(l,p){return l?(l=this.V(l),0<l.length?String(l[0]):p):p};function Ry(l,p,v){Ly(l,p),0<v.length&&(l.i=null,l.g.set(Xo(l,p),A(v)),l.h+=v.length)}t.toString=function(){if(this.i)return this.i;if(!this.g)return"";const l=[],p=Array.from(this.g.keys());for(var v=0;v<p.length;v++){var C=p[v];const U=encodeURIComponent(String(C)),H=this.V(C);for(C=0;C<H.length;C++){var M=U;H[C]!==""&&(M+="="+encodeURIComponent(String(H[C]))),l.push(M)}}return this.i=l.join("&")};function Xo(l,p){return p=String(p),l.j&&(p=p.toLowerCase()),p}function kS(l,p){p&&!l.j&&(Lr(l),l.i=null,l.g.forEach(function(v,C){var M=C.toLowerCase();C!=M&&(Ly(this,C),Ry(this,M,v))},l)),l.j=p}function ES(l,p){const v=new Ta;if(a.Image){const C=new Image;C.onload=_(Pr,v,"TestLoadImage: loaded",!0,p,C),C.onerror=_(Pr,v,"TestLoadImage: error",!1,p,C),C.onabort=_(Pr,v,"TestLoadImage: abort",!1,p,C),C.ontimeout=_(Pr,v,"TestLoadImage: timeout",!1,p,C),a.setTimeout(function(){C.ontimeout&&C.ontimeout()},1e4),C.src=l}else p(!1)}function wS(l,p){const v=new Ta,C=new AbortController,M=setTimeout(()=>{C.abort(),Pr(v,"TestPingServer: timeout",!1,p)},1e4);fetch(l,{signal:C.signal}).then(U=>{clearTimeout(M),U.ok?Pr(v,"TestPingServer: ok",!0,p):Pr(v,"TestPingServer: server error",!1,p)}).catch(()=>{clearTimeout(M),Pr(v,"TestPingServer: error",!1,p)})}function Pr(l,p,v,C,M){try{M&&(M.onload=null,M.onerror=null,M.onabort=null,M.ontimeout=null),C(v)}catch{}}function TS(){this.g=new oS}function xS(l,p,v){const C=v||"";try{Iy(l,function(M,U){let H=M;d(M)&&(H=ef(M)),p.push(C+U+"="+encodeURIComponent(H))})}catch(M){throw p.push(C+"type="+encodeURIComponent("_badmap")),M}}function Ru(l){this.l=l.Ub||null,this.j=l.eb||!1}x(Ru,tf),Ru.prototype.g=function(){return new bu(this.l,this.j)},Ru.prototype.i=function(l){return function(){return l}}({});function bu(l,p){_t.call(this),this.D=l,this.o=p,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}x(bu,_t),t=bu.prototype,t.open=function(l,p){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=l,this.A=p,this.readyState=1,La(this)},t.send=function(l){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const p={headers:this.u,method:this.B,credentials:this.m,cache:void 0};l&&(p.body=l),(this.D||a).fetch(new Request(this.A,p)).then(this.Sa.bind(this),this.ga.bind(this))},t.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Aa(this)),this.readyState=0},t.Sa=function(l){if(this.g&&(this.l=l,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=l.headers,this.readyState=2,La(this)),this.g&&(this.readyState=3,La(this),this.g)))if(this.responseType==="arraybuffer")l.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof a.ReadableStream<"u"&&"body"in l){if(this.j=l.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;by(this)}else l.text().then(this.Ra.bind(this),this.ga.bind(this))};function by(l){l.j.read().then(l.Pa.bind(l)).catch(l.ga.bind(l))}t.Pa=function(l){if(this.g){if(this.o&&l.value)this.response.push(l.value);else if(!this.o){var p=l.value?l.value:new Uint8Array(0);(p=this.v.decode(p,{stream:!l.done}))&&(this.response=this.responseText+=p)}l.done?Aa(this):La(this),this.readyState==3&&by(this)}},t.Ra=function(l){this.g&&(this.response=this.responseText=l,Aa(this))},t.Qa=function(l){this.g&&(this.response=l,Aa(this))},t.ga=function(){this.g&&Aa(this)};function Aa(l){l.readyState=4,l.l=null,l.j=null,l.v=null,La(l)}t.setRequestHeader=function(l,p){this.u.append(l,p)},t.getResponseHeader=function(l){return this.h&&this.h.get(l.toLowerCase())||""},t.getAllResponseHeaders=function(){if(!this.h)return"";const l=[],p=this.h.entries();for(var v=p.next();!v.done;)v=v.value,l.push(v[0]+": "+v[1]),v=p.next();return l.join(`\r
`)};function La(l){l.onreadystatechange&&l.onreadystatechange.call(l)}Object.defineProperty(bu.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(l){this.m=l?"include":"same-origin"}});function jy(l){let p="";return N(l,function(v,C){p+=C,p+=":",p+=v,p+=`\r
`}),p}function hf(l,p,v){e:{for(C in v){var C=!1;break e}C=!0}C||(v=jy(v),typeof l=="string"?v!=null&&encodeURIComponent(String(v)):be(l,p,v))}function Be(l){_t.call(this),this.headers=new Map,this.o=l||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}x(Be,_t);var IS=/^https?$/i,SS=["POST","PUT"];t=Be.prototype,t.Ha=function(l){this.J=l},t.ea=function(l,p,v,C){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+l);p=p?p.toUpperCase():"GET",this.D=l,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():of.g(),this.v=this.o?ly(this.o):ly(of),this.g.onreadystatechange=E(this.Ea,this);try{this.B=!0,this.g.open(p,String(l),!0),this.B=!1}catch(U){Dy(this,U);return}if(l=v||"",v=new Map(this.headers),C)if(Object.getPrototypeOf(C)===Object.prototype)for(var M in C)v.set(M,C[M]);else if(typeof C.keys=="function"&&typeof C.get=="function")for(const U of C.keys())v.set(U,C.get(U));else throw Error("Unknown input type for opt_headers: "+String(C));C=Array.from(v.keys()).find(U=>U.toLowerCase()=="content-type"),M=a.FormData&&l instanceof a.FormData,!(0<=Array.prototype.indexOf.call(SS,p,void 0))||C||M||v.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[U,H]of v)this.g.setRequestHeader(U,H);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{My(this),this.u=!0,this.g.send(l),this.u=!1}catch(U){Dy(this,U)}};function Dy(l,p){l.h=!1,l.g&&(l.j=!0,l.g.abort(),l.j=!1),l.l=p,l.m=5,Oy(l),ju(l)}function Oy(l){l.A||(l.A=!0,Rt(l,"complete"),Rt(l,"error"))}t.abort=function(l){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=l||7,Rt(this,"complete"),Rt(this,"abort"),ju(this))},t.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),ju(this,!0)),Be.aa.N.call(this)},t.Ea=function(){this.s||(this.B||this.u||this.j?Ny(this):this.bb())},t.bb=function(){Ny(this)};function Ny(l){if(l.h&&typeof s<"u"&&(!l.v[1]||rr(l)!=4||l.Z()!=2)){if(l.u&&rr(l)==4)iy(l.Ea,0,l);else if(Rt(l,"readystatechange"),rr(l)==4){l.h=!1;try{const H=l.Z();e:switch(H){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var p=!0;break e;default:p=!1}var v;if(!(v=p)){var C;if(C=H===0){var M=String(l.D).match(Sy)[1]||null;!M&&a.self&&a.self.location&&(M=a.self.location.protocol.slice(0,-1)),C=!IS.test(M?M.toLowerCase():"")}v=C}if(v)Rt(l,"complete"),Rt(l,"success");else{l.m=6;try{var U=2<rr(l)?l.g.statusText:""}catch{U=""}l.l=U+" ["+l.Z()+"]",Oy(l)}}finally{ju(l)}}}}function ju(l,p){if(l.g){My(l);const v=l.g,C=l.v[0]?()=>{}:null;l.g=null,l.v=null,p||Rt(l,"ready");try{v.onreadystatechange=C}catch{}}}function My(l){l.I&&(a.clearTimeout(l.I),l.I=null)}t.isActive=function(){return!!this.g};function rr(l){return l.g?l.g.readyState:0}t.Z=function(){try{return 2<rr(this)?this.g.status:-1}catch{return-1}},t.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},t.Oa=function(l){if(this.g){var p=this.g.responseText;return l&&p.indexOf(l)==0&&(p=p.substring(l.length)),iS(p)}};function Vy(l){try{if(!l.g)return null;if("response"in l.g)return l.g.response;switch(l.H){case"":case"text":return l.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in l.g)return l.g.mozResponseArrayBuffer}return null}catch{return null}}function CS(l){const p={};l=(l.g&&2<=rr(l)&&l.g.getAllResponseHeaders()||"").split(`\r
`);for(let C=0;C<l.length;C++){if(g(l[C]))continue;var v=b(l[C]);const M=v[0];if(v=v[1],typeof v!="string")continue;v=v.trim();const U=p[M]||[];p[M]=U,U.push(v)}T(p,function(C){return C.join(", ")})}t.Ba=function(){return this.m},t.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function Pa(l,p,v){return v&&v.internalChannelParams&&v.internalChannelParams[l]||p}function Fy(l){this.Aa=0,this.i=[],this.j=new Ta,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=Pa("failFast",!1,l),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=Pa("baseRetryDelayMs",5e3,l),this.cb=Pa("retryDelaySeedMs",1e4,l),this.Wa=Pa("forwardChannelMaxRetries",2,l),this.wa=Pa("forwardChannelRequestTimeoutMs",2e4,l),this.pa=l&&l.xmlHttpFactory||void 0,this.Xa=l&&l.Tb||void 0,this.Ca=l&&l.useFetchStreams||!1,this.L=void 0,this.J=l&&l.supportsCrossDomainXhr||!1,this.K="",this.h=new ky(l&&l.concurrentRequestLimit),this.Da=new TS,this.P=l&&l.fastHandshake||!1,this.O=l&&l.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=l&&l.Rb||!1,l&&l.xa&&this.j.xa(),l&&l.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&l&&l.detectBufferingProxy||!1,this.ja=void 0,l&&l.longPollingTimeout&&0<l.longPollingTimeout&&(this.ja=l.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}t=Fy.prototype,t.la=8,t.G=1,t.connect=function(l,p,v,C){bt(0),this.W=l,this.H=p||{},v&&C!==void 0&&(this.H.OSID=v,this.H.OAID=C),this.F=this.X,this.I=Yy(this,null,this.W),Ou(this)};function ff(l){if(Uy(l),l.G==3){var p=l.U++,v=nr(l.I);if(be(v,"SID",l.K),be(v,"RID",p),be(v,"TYPE","terminate"),Ra(l,v),p=new Ar(l,l.j,p),p.L=2,p.v=Pu(nr(v)),v=!1,a.navigator&&a.navigator.sendBeacon)try{v=a.navigator.sendBeacon(p.v.toString(),"")}catch{}!v&&a.Image&&(new Image().src=p.v,v=!0),v||(p.g=Ky(p.j,null),p.g.ea(p.v)),p.F=Date.now(),Cu(p)}Gy(l)}function Du(l){l.g&&(mf(l),l.g.cancel(),l.g=null)}function Uy(l){Du(l),l.u&&(a.clearTimeout(l.u),l.u=null),Nu(l),l.h.cancel(),l.s&&(typeof l.s=="number"&&a.clearTimeout(l.s),l.s=null)}function Ou(l){if(!Ey(l.h)&&!l.s){l.s=!0;var p=l.Ga;me||Z(),z||(me(),z=!0),q.add(p,l),l.B=0}}function AS(l,p){return wy(l.h)>=l.h.j-(l.s?1:0)?!1:l.s?(l.i=p.D.concat(l.i),!0):l.G==1||l.G==2||l.B>=(l.Va?0:l.Wa)?!1:(l.s=wa(E(l.Ga,l,p),qy(l,l.B)),l.B++,!0)}t.Ga=function(l){if(this.s)if(this.s=null,this.G==1){if(!l){this.U=Math.floor(1e5*Math.random()),l=this.U++;const M=new Ar(this,this.j,l);let U=this.o;if(this.S&&(U?(U=w(U),j(U,this.S)):U=this.S),this.m!==null||this.O||(M.H=U,U=null),this.P)e:{for(var p=0,v=0;v<this.i.length;v++){t:{var C=this.i[v];if("__data__"in C.map&&(C=C.map.__data__,typeof C=="string")){C=C.length;break t}C=void 0}if(C===void 0)break;if(p+=C,4096<p){p=v;break e}if(p===4096||v===this.i.length-1){p=v+1;break e}}p=1e3}else p=1e3;p=$y(this,M,p),v=nr(this.I),be(v,"RID",l),be(v,"CVER",22),this.D&&be(v,"X-HTTP-Session-Id",this.D),Ra(this,v),U&&(this.O?p="headers="+encodeURIComponent(String(jy(U)))+"&"+p:this.m&&hf(v,this.m,U)),df(this.h,M),this.Ua&&be(v,"TYPE","init"),this.P?(be(v,"$req",p),be(v,"SID","null"),M.T=!0,af(M,v,null)):af(M,v,p),this.G=2}}else this.G==3&&(l?Wy(this,l):this.i.length==0||Ey(this.h)||Wy(this))};function Wy(l,p){var v;p?v=p.l:v=l.U++;const C=nr(l.I);be(C,"SID",l.K),be(C,"RID",v),be(C,"AID",l.T),Ra(l,C),l.m&&l.o&&hf(C,l.m,l.o),v=new Ar(l,l.j,v,l.B+1),l.m===null&&(v.H=l.o),p&&(l.i=p.D.concat(l.i)),p=$y(l,v,1e3),v.I=Math.round(.5*l.wa)+Math.round(.5*l.wa*Math.random()),df(l.h,v),af(v,C,p)}function Ra(l,p){l.H&&N(l.H,function(v,C){be(p,C,v)}),l.l&&Iy({},function(v,C){be(p,C,v)})}function $y(l,p,v){v=Math.min(l.i.length,v);var C=l.l?E(l.l.Na,l.l,l):null;e:{var M=l.i;let U=-1;for(;;){const H=["count="+v];U==-1?0<v?(U=M[0].g,H.push("ofs="+U)):U=0:H.push("ofs="+U);let Le=!0;for(let ut=0;ut<v;ut++){let ke=M[ut].g;const kt=M[ut].map;if(ke-=U,0>ke)U=Math.max(0,M[ut].g-100),Le=!1;else try{xS(kt,H,"req"+ke+"_")}catch{C&&C(kt)}}if(Le){C=H.join("&");break e}}}return l=l.i.splice(0,v),p.D=l,C}function zy(l){if(!l.g&&!l.u){l.Y=1;var p=l.Fa;me||Z(),z||(me(),z=!0),q.add(p,l),l.v=0}}function pf(l){return l.g||l.u||3<=l.v?!1:(l.Y++,l.u=wa(E(l.Fa,l),qy(l,l.v)),l.v++,!0)}t.Fa=function(){if(this.u=null,By(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var l=2*this.R;this.j.info("BP detection timer enabled: "+l),this.A=wa(E(this.ab,this),l)}},t.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,bt(10),Du(this),By(this))};function mf(l){l.A!=null&&(a.clearTimeout(l.A),l.A=null)}function By(l){l.g=new Ar(l,l.j,"rpc",l.Y),l.m===null&&(l.g.H=l.o),l.g.O=0;var p=nr(l.qa);be(p,"RID","rpc"),be(p,"SID",l.K),be(p,"AID",l.T),be(p,"CI",l.F?"0":"1"),!l.F&&l.ja&&be(p,"TO",l.ja),be(p,"TYPE","xmlhttp"),Ra(l,p),l.m&&l.o&&hf(p,l.m,l.o),l.L&&(l.g.I=l.L);var v=l.g;l=l.ia,v.L=1,v.v=Pu(nr(p)),v.m=null,v.P=!0,yy(v,l)}t.Za=function(){this.C!=null&&(this.C=null,Du(this),pf(this),bt(19))};function Nu(l){l.C!=null&&(a.clearTimeout(l.C),l.C=null)}function Hy(l,p){var v=null;if(l.g==p){Nu(l),mf(l),l.g=null;var C=2}else if(cf(l.h,p))v=p.D,Ty(l.h,p),C=1;else return;if(l.G!=0){if(p.o)if(C==1){v=p.m?p.m.length:0,p=Date.now()-p.F;var M=l.B;C=xu(),Rt(C,new fy(C,v)),Ou(l)}else zy(l);else if(M=p.s,M==3||M==0&&0<p.X||!(C==1&&AS(l,p)||C==2&&pf(l)))switch(v&&0<v.length&&(p=l.h,p.i=p.i.concat(v)),M){case 1:Pi(l,5);break;case 4:Pi(l,10);break;case 3:Pi(l,6);break;default:Pi(l,2)}}}function qy(l,p){let v=l.Ta+Math.floor(Math.random()*l.cb);return l.isActive()||(v*=2),v*p}function Pi(l,p){if(l.j.info("Error code "+p),p==2){var v=E(l.fb,l),C=l.Xa;const M=!C;C=new Li(C||"//www.google.com/images/cleardot.gif"),a.location&&a.location.protocol=="http"||Au(C,"https"),Pu(C),M?ES(C.toString(),v):wS(C.toString(),v)}else bt(2);l.G=0,l.l&&l.l.sa(p),Gy(l),Uy(l)}t.fb=function(l){l?(this.j.info("Successfully pinged google.com"),bt(2)):(this.j.info("Failed to ping google.com"),bt(1))};function Gy(l){if(l.G=0,l.ka=[],l.l){const p=xy(l.h);(p.length!=0||l.i.length!=0)&&(S(l.ka,p),S(l.ka,l.i),l.h.i.length=0,A(l.i),l.i.length=0),l.l.ra()}}function Yy(l,p,v){var C=v instanceof Li?nr(v):new Li(v);if(C.g!="")p&&(C.g=p+"."+C.g),Lu(C,C.s);else{var M=a.location;C=M.protocol,p=p?p+"."+M.hostname:M.hostname,M=+M.port;var U=new Li(null);C&&Au(U,C),p&&(U.g=p),M&&Lu(U,M),v&&(U.l=v),C=U}return v=l.D,p=l.ya,v&&p&&be(C,v,p),be(C,"VER",l.la),Ra(l,C),C}function Ky(l,p,v){if(p&&!l.J)throw Error("Can't create secondary domain capable XhrIo object.");return p=l.Ca&&!l.pa?new Be(new Ru({eb:v})):new Be(l.pa),p.Ha(l.J),p}t.isActive=function(){return!!this.l&&this.l.isActive(this)};function Qy(){}t=Qy.prototype,t.ua=function(){},t.ta=function(){},t.sa=function(){},t.ra=function(){},t.isActive=function(){return!0},t.Na=function(){};function Mu(){}Mu.prototype.g=function(l,p){return new Qt(l,p)};function Qt(l,p){_t.call(this),this.g=new Fy(p),this.l=l,this.h=p&&p.messageUrlParams||null,l=p&&p.messageHeaders||null,p&&p.clientProtocolHeaderRequired&&(l?l["X-Client-Protocol"]="webchannel":l={"X-Client-Protocol":"webchannel"}),this.g.o=l,l=p&&p.initMessageHeaders||null,p&&p.messageContentType&&(l?l["X-WebChannel-Content-Type"]=p.messageContentType:l={"X-WebChannel-Content-Type":p.messageContentType}),p&&p.va&&(l?l["X-WebChannel-Client-Profile"]=p.va:l={"X-WebChannel-Client-Profile":p.va}),this.g.S=l,(l=p&&p.Sb)&&!g(l)&&(this.g.m=l),this.v=p&&p.supportsCrossDomainXhr||!1,this.u=p&&p.sendRawJson||!1,(p=p&&p.httpSessionIdParam)&&!g(p)&&(this.g.D=p,l=this.h,l!==null&&p in l&&(l=this.h,p in l&&delete l[p])),this.j=new Zo(this)}x(Qt,_t),Qt.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Qt.prototype.close=function(){ff(this.g)},Qt.prototype.o=function(l){var p=this.g;if(typeof l=="string"){var v={};v.__data__=l,l=v}else this.u&&(v={},v.__data__=ef(l),l=v);p.i.push(new dS(p.Ya++,l)),p.G==3&&Ou(p)},Qt.prototype.N=function(){this.g.l=null,delete this.j,ff(this.g),delete this.g,Qt.aa.N.call(this)};function Xy(l){nf.call(this),l.__headers__&&(this.headers=l.__headers__,this.statusCode=l.__status__,delete l.__headers__,delete l.__status__);var p=l.__sm__;if(p){e:{for(const v in p){l=v;break e}l=void 0}(this.i=l)&&(l=this.i,p=p!==null&&l in p?p[l]:void 0),this.data=p}else this.data=l}x(Xy,nf);function Zy(){rf.call(this),this.status=1}x(Zy,rf);function Zo(l){this.g=l}x(Zo,Qy),Zo.prototype.ua=function(){Rt(this.g,"a")},Zo.prototype.ta=function(l){Rt(this.g,new Xy(l))},Zo.prototype.sa=function(l){Rt(this.g,new Zy)},Zo.prototype.ra=function(){Rt(this.g,"b")},Mu.prototype.createWebChannel=Mu.prototype.g,Qt.prototype.send=Qt.prototype.o,Qt.prototype.open=Qt.prototype.m,Qt.prototype.close=Qt.prototype.close,hx=function(){return new Mu},dx=function(){return xu()},cx=Ci,bm={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Iu.NO_ERROR=0,Iu.TIMEOUT=8,Iu.HTTP_ERROR=6,Rc=Iu,py.COMPLETE="complete",ux=py,uy.EventType=ka,ka.OPEN="a",ka.CLOSE="b",ka.ERROR="c",ka.MESSAGE="d",_t.prototype.listen=_t.prototype.K,Za=uy,Be.prototype.listenOnce=Be.prototype.L,Be.prototype.getLastError=Be.prototype.Ka,Be.prototype.getLastErrorCode=Be.prototype.Ba,Be.prototype.getStatus=Be.prototype.Z,Be.prototype.getResponseJson=Be.prototype.Oa,Be.prototype.getResponseText=Be.prototype.oa,Be.prototype.send=Be.prototype.ea,Be.prototype.setWithCredentials=Be.prototype.Ha,lx=Be}).apply(typeof rc<"u"?rc:typeof self<"u"?self:typeof window<"u"?window:{});const G_="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hN(){if(vT())try{await _T()}catch(t){return Kt.warn(nn.create("indexeddb-unavailable",{errorInfo:t==null?void 0:t.toString()}).message),!1}else return Kt.warn(nn.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function fN(t,e,n,r,i,o,s){var a;const u=aN(t);u.then(_=>{n[_.measurementId]=_.appId,t.options.measurementId&&_.measurementId!==t.options.measurementId&&Kt.warn(`The measurement ID in the local Firebase config (${t.options.measurementId}) does not match the measurement ID fetched from the server (${_.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(_=>Kt.error(_)),e.push(u);const d=hN().then(_=>{if(_)return r.getId()}),[h,m]=await Promise.all([u,d]);tN(o)||KO(o,h.measurementId),i("js",new Date);const E=(a=s==null?void 0:s.config)!==null&&a!==void 0?a:{};return E[zO]="firebase",E.update=!0,m!=null&&(E[$O]=m),i("config",h.measurementId,E),h.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class In{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=In.makeFromUrl(e,n)}catch{return new In(e,"")}if(r.path==="")return r;throw LN(e)}static makeFromUrl(e,n){let r=null;const i="([A-Za-z0-9.\\-_]+)";function o(I){I.path.charAt(I.path.length-1)==="/"&&(I.path_=I.path_.slice(0,-1))}const s="(/(.*))?$",a=new RegExp("^gs://"+i+s,"i"),u={bucket:1,path:3};function d(I){I.path_=decodeURIComponent(I.path)}const h="v[A-Za-z0-9_]+",m=n.replace(/[.]/g,"\\."),E="(/([^?#]*).*)?$",_=new RegExp(`^https?://${m}/${h}/b/${i}/o${E}`,"i"),x={bucket:1,path:3},A=n===J8?"(?:storage.googleapis.com|storage.cloud.google.com)":n,S="([^?#]*)",y=new RegExp(`^https?://${A}/${i}/${S}`,"i"),k=[{regex:a,indices:u,postModify:o},{regex:_,indices:x,postModify:d},{regex:y,indices:{bucket:1,path:2},postModify:d}];for(let I=0;I<k.length;I++){const R=k[I],N=R.regex.exec(e);if(N){const T=N[R.indices.bucket];let w=N[R.indices.path];w||(w=""),r=new In(T,w),R.postModify(r);break}}if(r==null)throw AN(e);return r}}class RN{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bN(t,e,n){let r=1,i=null,o=null,s=!1,a=0;function u(){return a===2}let d=!1;function h(...S){d||(d=!0,e.apply(null,S))}function m(S){i=setTimeout(()=>{i=null,t(_,u())},S)}function E(){o&&clearTimeout(o)}function _(S,...y){if(d){E();return}if(S){E(),h.call(null,S,...y);return}if(u()||s){E(),h.call(null,S,...y);return}r<64&&(r*=2);let k;a===1?(a=2,k=0):k=(r+Math.random())*1e3,m(k)}let x=!1;function A(S){x||(x=!0,E(),!d&&(i!==null?(S||(a=2),clearTimeout(i),m(0)):S||(a=1)))}return m(0),o=setTimeout(()=>{s=!0,A(!0)},n),A}function jN(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`;function K5(){const[t,e]=O.useState(""),[n,r]=O.useState(""),[i,o]=O.useState(""),[s,a]=O.useState(!1),[u,d]=O.useState(!1),[h,m]=O.useState(!1),[E,_]=O.useState(!1),x=ca(),A=ua();O.useEffect(()=>{var g;(g=A.state)!=null&&g.message&&(Y.info(A.state.message),x(A.pathname,{replace:!0,state:{}}))},[A,x]),O.useEffect(()=>{i&&o("")},[t,n]);const S=async()=>{var k,I;if(!t){o("Please enter your email address to reset your password"),(k=document.getElementById("email"))==null||k.focus();return}if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t)){o("Please enter a valid email address"),(I=document.getElementById("email"))==null||I.focus();return}try{_(!0),await jP(Sn,t),m(!0),Y.success("Password reset email sent! Check your inbox.")}catch(R){console.error("Password reset error:",R),R.code==="auth/user-not-found"?o("No account found with this email address"):o("Failed to send password reset email. Please try again.")}finally{_(!1)}},y=async g=>{var I,R,N;if(g.preventDefault(),!t||!n){o("Please enter both email and password");return}if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t)){o("Please enter a valid email address"),(I=document.getElementById("email"))==null||I.focus();return}try{o(""),a(!0);try{const w=(await OP(Sn,t,n)).user,L=pr(xn(Ce,"declined_registrations"),Kr("userId","==",w.uid));if(!(await zn(L)).empty){await Sn.signOut(),o("Your registration request has been declined. Please contact an administrator."),Y.error("Access denied: Registration declined");return}const b=pr(xn(Ce,"registration_requests"),Kr("userId","==",w.uid));if(!(await zn(b)).empty){await Sn.signOut(),o("Your registration request is pending approval. You will be notified when approved."),Y.info("Registration pending approval");return}const P=!1;Y.success("Login successful!"),x("/dashboard")}catch(T){if(console.error("Firebase auth error:",T),!(!1&&(T.code==="auth/network-request-failed"||(R=T.message)!=null&&R.includes("network")))){if(T.code==="auth/invalid-credential"||T.code==="auth/invalid-email"||T.code==="auth/user-not-found"||T.code==="auth/wrong-password"){console.log("Authentication failed:",T.code,T.message);const L=T.code==="auth/user-not-found"||T.code==="auth/invalid-credential"&&t.includes("@");o(L?f.jsxs("span",{children:["Account not found. Please check your email or",f.jsx("a",{href:"/register",style:{color:"#800000",marginLeft:"4px",textDecoration:"underline"},children:"register here"})]}):"Invalid email or password. Please check your credentials and try again."),(N=document.getElementById("email"))==null||N.focus()}else T.code==="auth/network-request-failed"?o("Network error. Please check your connection and try again."):T.code==="auth/too-many-requests"?o("Too many failed login attempts. Please try again later or reset your password."):T.code==="auth/operation-not-allowed"?(o("Email/password sign-in is not enabled. Please contact the administrator."),console.error("Firebase email/password authentication is not enabled in the Firebase Console")):(console.error("Login error details:",T),o("Failed to log in. Please try again."));Y.error("Login failed")}}}catch(T){console.error("Unexpected login error:",T),o("An unexpected error occurred. Please try again."),Y.error("Login failed")}finally{a(!1)}};return f.jsx(V5,{children:f.jsxs(F5,{children:[f.jsx(Y5,{children:"Hyacinth"}),f.jsx(U5,{children:"Attendance System"}),f.jsxs(W5,{onSubmit:y,children:[f.jsxs(ck,{children:[f.jsx(dk,{htmlFor:"email",children:"Email"}),f.jsxs(hk,{children:[f.jsx(hc,{children:f.jsx(Yh,{size:18})}),f.jsx(fk,{id:"email",type:"email",value:t,onChange:g=>e(g.target.value),placeholder:"Enter your email",required:!0})]})]}),f.jsxs(ck,{children:[f.jsx(dk,{htmlFor:"password",children:"Password"}),f.jsxs(hk,{children:[f.jsx(hc,{children:f.jsx($d,{size:18})}),f.jsx(fk,{id:"password",type:u?"text":"password",value:n,onChange:g=>r(g.target.value),placeholder:"Enter your password",required:!0}),f.jsx(G5,{type:"button",onClick:()=>d(!u),"aria-label":u?"Hide password":"Show password",children:u?f.jsx(Wd,{size:18}):f.jsx(Ud,{size:18})})]}),f.jsx(q5,{type:"button",onClick:S,disabled:E,tabIndex:"-1",children:E?"Sending...":h?"Email sent!":"Forgot password?"})]}),i&&f.jsx(z5,{children:i}),f.jsxs(H5,{children:[f.jsx($5,{type:"submit",disabled:s,onClick:y,children:s?"Logging in...":f.jsxs(f.Fragment,{children:[f.jsx(hc,{children:f.jsx(G1,{size:18})}),"Login"]})}),f.jsxs(B5,{to:"/register",children:[f.jsx(hc,{children:f.jsx(Y1,{size:18})}),"Register"]})]})]})]})})}const Q5=async t=>{try{const e={...t,createdAt:Nh(),status:"pending"};return(await P8(xn(Ce,"registration_requests"),e)).id}catch(e){throw console.error("Error submitting registration request:",e),e}},X5=async()=>{try{const t=pr(xn(Ce,"registration_requests"),L1("createdAt","desc"));return(await zn(t)).docs.map(n=>({id:n.id,...n.data()}))}catch(t){throw console.error("Error getting registration requests:",t),t}},Z5=async(t,e)=>{try{const n=ft(Ce,"registration_requests",t);await vl(n,{...e,updatedAt:Nh()})}catch(n){throw console.error("Error updating registration request:",n),n}},J5=async t=>{try{const e=ft(Ce,"users",t.userId);await Pd(e,{userId:t.userId,name:t.name,email:t.email,position:t.position,role:t.role||"user",status:"active",timeRegion:t.timeRegion||Intl.DateTimeFormat().resolvedOptions().timeZone||"Asia/Manila",createdAt:Nh(),userID:t.userID||`uid_${Date.now()}_${Math.random().toString(36).substring(2,7)}`}),await R1(ft(Ce,"registration_requests",t.id))}catch(e){throw console.error("Error approving registration request:",e),e}},e3=async t=>{try{if(await Pd(ft(Ce,"declined_registrations",t.id),{...t,declinedAt:Nh(),status:"declined",blocked:!0}),await R1(ft(Ce,"registration_requests",t.id)),t.userId&&!t.userId.startsWith("temp_"))try{const n=sx().currentUser;n&&n.uid===t.userId?(await $P(n),console.log("Deleted declined user from Firebase Authentication")):console.log("User marked as declined in Firestore. They will be blocked from accessing the system.")}catch(e){console.error("Error handling user authentication:",e)}}catch(e){throw console.error("Error declining registration request:",e),e}},t3=V.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
`;function c3(){const[t,e]=O.useState({lastName:"",firstName:"",middleInitial:"",email:"",password:"",confirmPassword:"",position:""}),[n,r]=O.useState({}),[i,o]=O.useState(!1),[s,a]=O.useState(!1),[u,d]=O.useState(!1),[h,m]=O.useState(!1),E=ca();O.useEffect(()=>{Object.keys(n).length>0&&r({})},[t]);const _={length:t.password.length>=4,validChars:/^[a-zA-Z0-9!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]+$/.test(t.password),hasLetter:/[a-zA-Z]/.test(t.password),hasNumber:/[0-9]/.test(t.password),match:t.password===t.confirmPassword&&t.confirmPassword!==""},x=g=>{const{name:k,value:I}=g.target;if(e(k==="middleInitial"?R=>({...R,[k]:I.toUpperCase()}):R=>({...R,[k]:I})),k==="email"&&I.includes("@")&&I.includes(".")){m(!0);const R=setTimeout(()=>{A(I)},800);return()=>clearTimeout(R)}},A=async g=>{try{if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(g)){m(!1);return}(await fetch("https://identitytoolkit.googleapis.com/v1/accounts:createAuthUri?key=undefined",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({continueUri:window.location.href,identifier:g})}).then(R=>R.json())).registered&&r(R=>({...R,email:"This email is already registered. Please use a different email or login instead."}))}catch(k){console.error("Error checking email:",k)}finally{m(!1)}},S=()=>{const g={};return t.lastName.trim()||(g.lastName="Last name is required"),t.firstName.trim()||(g.firstName="First name is required"),t.email.trim()?/\S+@\S+\.\S+/.test(t.email)||(g.email="Email is invalid"):g.email="Email is required",t.password?_.length?_.validChars?_.hasLetter?_.hasNumber||(g.password="Password must contain at least one number"):g.password="Password must contain at least one letter":g.password="Password contains invalid characters":g.password="Password must be at least 4 characters":g.password="Password is required",t.confirmPassword?t.password!==t.confirmPassword&&(g.confirmPassword="Passwords do not match"):g.confirmPassword="Please confirm your password",t.position||(g.position="Please select your position"),r(g),Object.keys(g).length===0},y=async g=>{var k,I,R,N;if(g.preventDefault(),!!S())try{o(!0);const T=!1;let w,L;try{L=await DP(Sn,t.email,t.password),w=L.user.uid}catch(P){if(console.error("Auth error:",P),P.code==="auth/email-already-in-use")console.log("Email already exists in Auth but proceeding with registration request"),w=`temp_${Date.now()}_${Math.random().toString(36).substring(2,7)}`;else if(!(T&&(P.code==="auth/network-request-failed"||(k=P.message)!=null&&k.includes("network"))))throw P}const j=`${t.lastName}, ${t.firstName}${t.middleInitial?" "+t.middleInitial+".":""}`;if(L!=null&&L.user)try{await MP(L.user,{displayName:j})}catch(P){console.warn("Could not update profile, continuing with registration:",P)}let b="Asia/Manila";try{b=Intl.DateTimeFormat().resolvedOptions().timeZone,console.log("Detected device time zone during registration:",b)}catch(P){console.error("Error detecting time zone during registration:",P)}const D={userId:w,lastName:t.lastName,firstName:t.firstName,middleInitial:t.middleInitial,name:j,email:t.email,position:t.position,role:"user",status:"pending",timeRegion:b,userID:`uid_${Date.now()}_${Math.random().toString(36).substring(2,7)}`};try{await Q5(D)}catch(P){if(console.error("Firestore error:",P),!T)throw P}Y.success("Registration request submitted! An administrator will review your request."),T&&!L||E("/login",{state:{message:"Your registration request has been submitted. You will be notified when your account is approved."}})}catch(T){if(console.error("Registration error:",T),T.code==="auth/email-already-in-use"||typeof T=="object"&&T.code==="auth/email-already-in-use"){const w=T.message||"Email is already registered. Please use a different email or login instead.";r(L=>({...L,email:w})),Y.error(f.jsxs("div",{children:["Email already exists. ",f.jsx("a",{href:"/",style:{color:"white",textDecoration:"underline"},children:"Login instead?"})]}),{autoClose:5e3}),(I=document.getElementById("email"))==null||I.scrollIntoView({behavior:"smooth",block:"center"}),(R=document.getElementById("email"))==null||R.focus()}else T.code==="auth/network-request-failed"?Y.error("Network error. Please check your connection and try again."):T.code==="auth/operation-not-allowed"?(r(w=>({...w,email:"Email/password registration is not enabled. Please contact the administrator."})),console.error("Firebase email/password authentication is not enabled in the Firebase Console")):(N=T.code)!=null&&N.includes("auth/")?Y.error(`Authentication error: ${T.message||"Please try again later"}`):(console.error("Registration error details:",T),Y.error("Registration failed. Please try again."))}finally{o(!1)}};return f.jsx(t3,{children:f.jsxs(n3,{children:[f.jsxs(l3,{to:"/",children:[f.jsx(kn,{children:f.jsx(PI,{size:16})}),"Back to Login"]}),f.jsx(r3,{children:"Create Account"}),f.jsxs(i3,{onSubmit:y,children:[f.jsxs(Wa,{children:[f.jsx(jr,{children:"Full Name"}),f.jsxs(o3,{children:[f.jsxs(hp,{flex:"2",minWidth:"150px",children:[f.jsx(jr,{htmlFor:"lastName",children:"Last Name"}),f.jsxs(Ri,{children:[f.jsx(kn,{children:f.jsx(Xi,{size:18})}),f.jsx(ns,{id:"lastName",name:"lastName",type:"text",value:t.lastName,onChange:x,placeholder:"Last name"})]}),n.lastName&&f.jsx(rs,{children:n.lastName})]}),f.jsxs(hp,{flex:"2",minWidth:"150px",children:[f.jsx(jr,{htmlFor:"firstName",children:"First Name"}),f.jsx(Ri,{children:f.jsx(ns,{id:"firstName",name:"firstName",type:"text",value:t.firstName,onChange:x,placeholder:"First name"})}),n.firstName&&f.jsx(rs,{children:n.firstName})]}),f.jsxs(hp,{flex:"1",minWidth:"80px",children:[f.jsx(jr,{htmlFor:"middleInitial",children:"M.I."}),f.jsx(Ri,{children:f.jsx(ns,{id:"middleInitial",name:"middleInitial",type:"text",value:t.middleInitial,onChange:x,placeholder:"M.I.",maxLength:"1"})})]})]})]}),f.jsxs(Wa,{children:[f.jsx(jr,{htmlFor:"email",children:"Email"}),f.jsxs(Ri,{children:[f.jsx(kn,{children:f.jsx(Yh,{size:18})}),f.jsx(ns,{id:"email",name:"email",type:"email",value:t.email,onChange:x,placeholder:"Enter your email"}),h&&f.jsx(fp,{as:"span","aria-label":"Checking email",children:f.jsx(pk,{size:18})})]}),n.email&&f.jsx(rs,{children:n.email})]}),f.jsxs(Wa,{children:[f.jsx(jr,{htmlFor:"position",children:"Position"}),f.jsxs(Ri,{children:[f.jsx(kn,{children:f.jsx(q1,{size:18})}),f.jsxs(s3,{id:"position",name:"position",value:t.position,onChange:x,children:[f.jsx("option",{value:"",disabled:!0,children:"Select your position"}),f.jsx("option",{value:"Intern/OJT",children:"Intern/OJT"}),f.jsx("option",{value:"Employed/Onboarded",children:"Employed/Onboarded"})]})]}),n.position&&f.jsx(rs,{children:n.position})]}),f.jsxs(Wa,{children:[f.jsx(jr,{htmlFor:"password",children:"Password"}),f.jsxs(Ri,{children:[f.jsx(kn,{children:f.jsx($d,{size:18})}),f.jsx(ns,{id:"password",name:"password",type:s?"text":"password",value:t.password,onChange:x,placeholder:"Create a password"}),f.jsx(fp,{type:"button",onClick:()=>a(!s),"aria-label":s?"Hide password":"Show password",children:s?f.jsx(Wd,{size:18}):f.jsx(Ud,{size:18})})]}),n.password&&f.jsx(rs,{children:n.password}),f.jsxs(u3,{children:[f.jsxs($a,{met:_.length,children:[f.jsx(kn,{children:f.jsx(Fi,{size:14,weight:_.length?"fill":"regular"})}),"At least 4 characters"]}),f.jsxs($a,{met:_.validChars,children:[f.jsx(kn,{children:f.jsx(Fi,{size:14,weight:_.validChars?"fill":"regular"})}),"Valid characters (letters, numbers, and special characters)"]}),f.jsxs($a,{met:_.hasLetter,children:[f.jsx(kn,{children:f.jsx(Fi,{size:14,weight:_.hasLetter?"fill":"regular"})}),"At least one letter"]}),f.jsxs($a,{met:_.hasNumber,children:[f.jsx(kn,{children:f.jsx(Fi,{size:14,weight:_.hasNumber?"fill":"regular"})}),"At least one number"]})]})]}),f.jsxs(Wa,{children:[f.jsx(jr,{htmlFor:"confirmPassword",children:"Confirm Password"}),f.jsxs(Ri,{children:[f.jsx(kn,{children:f.jsx($d,{size:18})}),f.jsx(ns,{id:"confirmPassword",name:"confirmPassword",type:u?"text":"password",value:t.confirmPassword,onChange:x,placeholder:"Confirm your password"}),f.jsx(fp,{type:"button",onClick:()=>d(!u),"aria-label":u?"Hide password":"Show password",children:u?f.jsx(Wd,{size:18}):f.jsx(Ud,{size:18})})]}),n.confirmPassword&&f.jsx(rs,{children:n.confirmPassword}),t.confirmPassword&&f.jsxs($a,{met:_.match,children:[f.jsx(kn,{children:f.jsx(Fi,{size:14,weight:_.match?"fill":"regular"})}),"Passwords match"]})]}),f.jsx(a3,{type:"submit",disabled:i||h,children:i?f.jsxs(f.Fragment,{children:[f.jsx(pk,{size:18}),"Creating Account..."]}):h?"Checking email...":"Register"})]})]})})}const FI=O.createContext(),X1=()=>O.useContext(FI),d3=({children:t})=>{const{currentUser:e}=V1(),[n,r]=O.useState(!1),[i,o]=O.useState(!0);O.useEffect(()=>{(async()=>{if(!(e!=null&&e.uid)){o(!1);return}try{const d=ft(Ce,"users_settings",e.uid),h=await Jl(d);if(h.exists()){const m=h.data();m.use24HourFormat!==void 0&&r(m.use24HourFormat)}else await Pd(d,{use24HourFormat:!1,userId:e.uid})}catch(d){console.error("Error fetching user settings:",d)}finally{o(!1)}})()},[e]);const a={use24HourFormat:n,toggleTimeFormat:async()=>{if(e!=null&&e.uid)try{const u=ft(Ce,"users_settings",e.uid);return await Pd(u,{use24HourFormat:!n,userId:e.uid},{merge:!0}),r(!n),!0}catch(u){return console.error("Error updating time format:",u),!1}},loading:i};return f.jsx(FI.Provider,{value:a,children:t})},h3=V.div`
  display: flex;
  min-height: 100vh;
`,f3=V.div`
  width: 250px;
...
`,P3=({user:t,activeTab:e,setActiveTab:n,attendanceStatus:r,loading:i,handleTimeInOut:o,lastRecord:s,isSuperAdmin:a,userData:u,setUserData:d,children:h})=>{var P;const m=ca(),{currentUser:E}=V1(),{use24HourFormat:_,toggleTimeFormat:x}=X1(),[A,S]=O.useState(!1),[y,g]=O.useState((u==null?void 0:u.timeRegion)||Intl.DateTimeFormat().resolvedOptions().timeZone||"Asia/Manila"),[k,I]=O.useState(!1),[R,N]=O.useState(""),[T,w]=O.useState(!1),L=G=>{try{const ae=new Date,pe={timeZone:G,timeZoneName:"short"},q=new Intl.DateTimeFormat("en-US",pe).format(ae).match(/GMT([+-]\d+)/);if(q&&q[1])return`UTC${q[1]}`;const Z=new Date,ee=(new Date(Z.toLocaleString("en-US",{timeZone:G}))-Z)/6e4,ye=Math.floor(Math.abs(ee)/60),qe=Math.abs(ee)%60;return`UTC${ee>=0?"+":"-"}${ye.toString().padStart(2,"0")}:${qe.toString().padStart(2,"0")}`}catch(ae){return console.error("Error calculating UTC offset:",ae),""}};O.useEffect(()=>{try{const G=Intl.DateTimeFormat().resolvedOptions().timeZone;N(G),console.log("Detected device time zone:",G)}catch(G){console.error("Error detecting time zone:",G),N("Unable to detect")}},[]),O.useEffect(()=>{u!=null&&u.timeRegion?g(u.timeRegion):R&&!(u!=null&&u.timeRegion)&&g(R)},[u,R]);const j=async()=>{if(!(!(t!=null&&t.uid)||k))try{I(!0);const G=ft(Ce,"users",t.uid);await vl(G,{timeRegion:y}),d(ae=>({...ae,timeRegion:y})),Y.success("Time region updated successfully"),S(!1)}catch(G){console.error("Error updating time region:",G),Y.error("Failed to update time region")}finally{I(!1)}},b=async()=>{if(!T)try{w(!0),await x()?Y.success(`Time format updated to ${_?"12-hour":"24-hour"} format`):Y.error("Failed to update time format")}catch(G){console.error("Error updating time format:",G),Y.error("Failed to update time format")}finally{w(!1)}},D=async()=>{try{await WP(Sn),m("/login")}catch(G){console.error("Error signing out:",G),Y.error("Failed to sign out")}};return f.jsxs(h3,{children:[f.jsxs(f3,{children:[f.jsx(p3,{children:"Hyacinth"}),f.jsxs(Dr,{className:e==="home"?"active":"",onClick:()=>n("home"),children:[f.jsx(OI,{size:20,style:{marginRight:"0.5rem"}}),"Home"]}),f.jsxs(Dr,{className:e==="schedule"?"active":"",onClick:()=>n("schedule"),children:[f.jsx(tu,{size:20,style:{marginRight:"0.5rem"}}),"Schedule"]}),f.jsxs(Dr,{className:e==="attendance"?"active":"",onClick:()=>n("attendance"),children:[f.jsx(RI,{size:20,style:{marginRight:"0.5rem"}}),"Attendance"]}),f.jsxs(Dr,{className:e==="profile"?"active":"",onClick:()=>n("profile"),children:[f.jsx(Xi,{size:20,style:{marginRight:"0.5rem"}}),"Profile"]}),a&&f.jsxs(f.Fragment,{children:[f.jsxs(Dr,{className:e==="registration_requests"?"active":"",onClick:()=>n("registration_requests"),children:[f.jsx(is,{children:f.jsx(Y1,{size:16})}),"Registration Requests"]}),f.jsxs(Dr,{className:e==="user_management"?"active":"",onClick:()=>n("user_management"),children:[f.jsx(is,{children:f.jsx(K1,{size:16})}),"User Management"]})]}),f.jsxs("div",{style:{marginTop:"auto"},children:[f.jsxs("div",{style:{marginBottom:"1.5rem"},children:[f.jsx("p",{style:{fontSize:"0.9rem",marginBottom:"0.75rem",opacity:"0.8"},children:"User Settings"}),f.jsxs(Dr,{onClick:()=>S(!0),children:[f.jsx(is,{children:f.jsx(DI,{size:16})}),"Change Time Region",f.jsxs("div",{style:{fontSize:"0.75rem",marginLeft:"auto",opacity:.7},children:[((P=u==null?void 0:u.timeRegion)==null?void 0:P.replace("_"," "))||"Asia/Manila",f.jsx("div",{style:{fontSize:"0.7rem",marginTop:"2px"},children:L((u==null?void 0:u.timeRegion)||"Asia/Manila")})]})]})]}),f.jsxs("div",{style:{marginBottom:"1.5rem"},children:[f.jsx("p",{style:{fontSize:"0.9rem",marginBottom:"0.75rem",opacity:"0.8"},children:"Attendance Actions"}),f.jsxs(m3,{onClick:()=>o("In"),disabled:i||r==="In",children:[f.jsx(is,{children:f.jsx(G1,{size:16})}),"Time In"]}),f.jsxs(g3,{onClick:()=>o("Out"),disabled:i||r==="Out"||!r,children:[f.jsx(is,{children:f.jsx($c,{size:16})}),"Time Out"]}),r&&f.jsxs("div",{style:{padding:"0.5rem 0",textAlign:"center",fontSize:"0.85rem"},children:["Status: ",f.jsx("strong",{children:r==="In"?"Clocked In":"Clocked Out"})]})]}),f.jsxs(Dr,{onClick:D,children:[f.jsx(is,{children:f.jsx($c,{size:16})}),"Logout"]})]})]}),f.jsxs(y3,{children:[f.jsxs(v3,{children:[f.jsxs(_3,{children:[e==="dashboard"&&"Dashboard",e==="attendance"&&"Attendance",e==="schedule"&&"Schedule",e==="profile"&&"Profile",e==="registration_requests"&&"Registration Requests",e==="user_management"&&"User Management"]}),f.jsxs(k3,{children:[f.jsx(E3,{children:t==null?void 0:t.displayName}),f.jsxs(w3,{onClick:D,children:[f.jsx($c,{size:16}),"Logout"]})]})]}),h]}),A&&f.jsx(T3,{children:f.jsxs(x3,{children:[f.jsxs(I3,{children:[f.jsx("h3",{children:"Change Time Region"}),f.jsx(A3,{onClick:()=>S(!1),children:"×"})]}),f.jsxs(S3,{children:[f.jsx("p",{style:{marginBottom:"1rem"},children:"Changing your time region will affect how times are displayed throughout the application and how your attendance is recorded."}),R&&f.jsxs("p",{style:{marginBottom:"1rem",backgroundColor:"#f0f7ff",padding:"0.5rem",borderRadius:"4px",fontSize:"0.9rem"},children:[f.jsx("strong",{children:"Detected device time zone:"})," ",R,f.jsxs("span",{style:{fontWeight:"normal"},children:["(",L(R),")"]}),R!==y&&f.jsx("button",{onClick:()=>g(R),style:{display:"block",marginTop:"0.5rem",padding:"0.25rem 0.5rem",fontSize:"0.8rem",backgroundColor:"#e6f0ff",border:"1px solid #bbd6fb",borderRadius:"4px",cursor:"pointer"},children:"Use device time zone"})]}),f.jsxs(gk,{children:[f.jsx(yk,{children:"Select Time Region"}),f.jsxs(L3,{value:y,onChange:G=>g(G.target.value),children:[f.jsx("optgroup",{label:"Asia",children:f.jsx("option",{value:"Asia/Manila",children:"Asia/Manila (PHT, UTC+8)"})}),f.jsxs("optgroup",{label:"Americas",children:[f.jsx("option",{value:"America/New_York",children:"America/New_York (Eastern, UTC-5/-4)"}),f.jsx("option",{value:"America/Chicago",children:"America/Chicago (Central, UTC-6/-5)"}),f.jsx("option",{value:"America/Denver",children:"America/Denver (Mountain, UTC-7/-6)"}),f.jsx("option",{value:"America/Los_Angeles",children:"America/Los_Angeles (Pacific, UTC-8/-7)"})]}),f.jsx("optgroup",{label:"Europe",children:f.jsx("option",{value:"Europe/London",children:"Europe/London (GMT/BST, UTC+0/+1)"})})]}),f.jsx("div",{style:{fontSize:"0.8rem",marginTop:"0.5rem",color:"#666"},children:"Note: UTC offsets may vary during Daylight Saving Time transitions."})]}),f.jsxs(gk,{style:{marginTop:"1.5rem"},children:[f.jsxs(yk,{style:{display:"flex",alignItems:"center",gap:"0.5rem"},children:[f.jsx(bI,{size:18}),"Time Format"]}),f.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"1rem",marginTop:"0.5rem"},children:[f.jsx(mk,{active:!_,onClick:b,disabled:T,children:"12-hour (AM/PM)"}),f.jsx(mk,{active:_,onClick:b,disabled:T,children:"24-hour"})]}),f.jsx("div",{style:{fontSize:"0.8rem",marginTop:"0.5rem",color:"#666"},children:"This setting affects how time is displayed throughout the application."})]})]}),f.jsxs(C3,{children:[f.jsx(vk,{onClick:()=>S(!1),children:"Cancel"}),f.jsx(vk,{primary:!0,onClick:j,disabled:k,children:k?"Updating...":"Save Changes"})]})]})})]})},ui=V.div`
  background-color: white;
  border-radius: 8px;
...
`;const j3=({attendanceStatus:t,lastRecord:e})=>f.jsx(f.Fragment,{children:f.jsxs(R3,{children:[f.jsxs(ui,{children:[f.jsx(ci,{children:"Today's Schedule"}),f.jsx(di,{children:f.jsx("p",{children:"No schedule for today"})})]}),f.jsxs(ui,{children:[f.jsx(ci,{children:"Attendance Status"}),f.jsx(di,{children:t?f.jsxs(f.Fragment,{children:[f.jsxs("p",{children:["Current Status:",f.jsx(b3,{status:t,children:t==="In"?"Clocked In":"Clocked Out"})]}),e&&f.jsxs("p",{children:["Last action: ",new Date(e.timestamp.toDate()).toLocaleString()]})]}):f.jsx("p",{children:"You haven't clocked in today"})})]}),f.jsxs(ui,{children:[f.jsx(ci,{children:"Recent Activity"}),f.jsx(di,{children:e?f.jsxs("p",{children:["Last ",e.type==="In"?"Time In":"Time Out",": ",new Date(e.timestamp.toDate()).toLocaleString()]}):f.jsx("p",{children:"No recent activity"})})]})]})}),D3=V.table`
  width: 100%;
...
`,Nk=V.div`
  ...
  padding: 2rem;
  color: #666;
`,e7=({user:t,userData:e})=>{const[n,r]=O.useState(null),[i,o]=O.useState(!0),[s,a]=O.useState(null),{use24HourFormat:u}=X1(),d=(e==null?void 0:e.timeRegion)||Intl.DateTimeFormat().resolvedOptions().timeZone||"Asia/Manila";O.useEffect(()=>{(async()=>{if(t!=null&&t.uid)try{if(o(!0),e&&e.schedule&&Array.isArray(e.schedule)&&e.schedule.length>0)console.log("Using schedule from userData prop:",e.schedule),r(e.schedule);else{const x=ft(Ce,"users",t.uid),A=await Jl(x);if(A.exists()){const S=A.data();if(S.schedule&&Array.isArray(S.schedule)&&S.schedule.length>0)console.log("Found user schedule in Firestore:",S.schedule),r(S.schedule);else if(S.scheduleId){const y=S.scheduleId,g=ft(Ce,"schedules",y),k=await Jl(g);k.exists()&&r(k.data())}else{const y=xn(Ce,"schedules"),g=pr(y,Kr("isDefault","==",!0)),k=await zn(g);k.empty||r(k.docs[0].data())}}}}catch(x){console.error("Error fetching schedule:",x),a("Failed to load schedule. Please try again later.")}finally{o(!1)}})()},[t,e]);const h=_=>["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][_],m=(_,x=null,A=d)=>{if(!_)return"N/A";try{if(!x||x===A){const[T,w]=_.split(":"),L=new Date;return L.setHours(parseInt(T,10)),L.setMinutes(parseInt(w,10)),L.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hour12:!u})}const[S,y]=_.split(":"),g=new Date;g.setHours(0,0,0,0);const k=new Date(g);k.setHours(parseInt(S,10),parseInt(y,10),0,0);const I=JV(k,x),R=ZV(I,A);return YV(R,u?"HH:mm":"h:mm a",{timeZone:A})}catch(S){return console.error("Error formatting time:",S),_}},E=(_,x,A)=>{try{const[S,y]=_.split(":").map(Number),g=new Date;g.setHours(0,0,0,0);const k=new Date(g);k.setHours(S,y,0,0);const I=V3(k,x);return z9(I,"HH:mm")}catch(S){console.error("Error calculating end time:",S);let y=(parseInt(_.split(":")[0],10)+x)%24,g=_.split(":")[1];return`${y.toString().padStart(2,"0")}:${g}`}};return f.jsxs(ui,{children:[f.jsx(ci,{children:"My Schedule"}),f.jsx(di,{children:i?f.jsx("p",{children:"Loading your schedule..."}):s?f.jsx(Nk,{children:f.jsx("p",{children:s})}):n?f.jsx("div",{children:Array.isArray(n)?f.jsxs(f.Fragment,{children:[f.jsx("p",{children:f.jsx("strong",{children:"Your Schedule"})}),n.map((_,x)=>{const A=new Date,y=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"].indexOf(_.dayOfWeek),g=A.getDay()===y,k=_.timeRegion||"Asia/Manila",I=m(_.timeIn,k,d),R=_.shiftDuration||8,N=E(_.timeIn,R),T=m(N,k,d);return f.jsxs(Ok,{isToday:g,children:[f.jsx("h3",{children:_.dayOfWeek}),f.jsxs("p",{children:[f.jsx("strong",{children:"Time In:"})," ",I," |",f.jsx("strong",{children:"Duration:"})," ",_.shiftDuration," hours"]}),f.jsxs("p",{children:[f.jsx("strong",{children:"Estimated Time Out:"})," ",T]}),f.jsxs("p",{children:[f.jsx("strong",{children:"Original Time Region:"})," ",k]}),f.jsxs("p",{children:[f.jsx("strong",{children:"Displayed In:"})," ",d]})]},x)}),f.jsxs(Dk,{children:[f.jsx("thead",{children:f.jsxs("tr",{children:[f.jsx("th",{children:"Day"}),f.jsx("th",{children:"Time In"}),f.jsx("th",{children:"Time Out (Est.)"}),f.jsx("th",{children:"Duration"}),f.jsx("th",{children:"Region"})]})}),f.jsx("tbody",{children:n.map((_,x)=>{const A=_.timeRegion||"Asia/Manila",S=m(_.timeIn,A,d),y=_.shiftDuration||8,g=E(_.timeIn,y),k=m(g,A,d);return f.jsxs("tr",{children:[f.jsx("td",{children:_.dayOfWeek}),f.jsx("td",{children:S}),f.jsx("td",{children:k}),f.jsxs("td",{children:[_.shiftDuration," hours"]}),f.jsxs("td",{children:[f.jsx("div",{children:A}),f.jsxs("div",{style:{fontSize:"0.8rem",opacity:.7},children:["Displayed in: ",d]})]})]},x)})})]})]}):f.jsxs(f.Fragment,{children:[f.jsxs("p",{children:["Your assigned schedule: ",f.jsx("strong",{children:n.name||"Standard Schedule"})]}),n.shifts&&n.shifts.map((_,x)=>{const S=new Date().getDay()===_.day;return f.jsxs(Ok,{isToday:S,children:[f.jsx("h3",{children:h(_.day)}),f.jsxs("p",{children:[f.jsx("strong",{children:"Start:"})," ",m(_.startTime)," |",f.jsx("strong",{children:"End:"})," ",m(_.endTime)]}),_.breakStart&&_.breakEnd&&f.jsxs("p",{children:[f.jsx("strong",{children:"Break:"})," ",m(_.breakStart)," - ",m(_.breakEnd)]})]},x)}),f.jsxs(Dk,{children:[f.jsx("thead",{children:f.jsxs("tr",{children:[f.jsx("th",{children:"Day"}),f.jsx("th",{children:"Start Time"}),f.jsx("th",{children:"End Time"}),f.jsx("th",{children:"Break"})]})}),f.jsx("tbody",{children:n.shifts&&n.shifts.map((_,x)=>f.jsxs("tr",{children:[f.jsx("td",{children:h(_.day)}),f.jsx("td",{children:m(_.startTime)}),f.jsx("td",{children:m(_.endTime)}),f.jsx("td",{children:_.breakStart&&_.breakEnd?`${m(_.breakStart)} - ${m(_.breakEnd)}`:"None"})]},x))})]})]})}):f.jsx(Nk,{children:f.jsx("p",{children:"No schedule has been assigned to you yet."})})})]})},t7=V.div`
  margin-bottom: 1.5rem;
`,ss=V.p`
  margin: 0.75rem 0;
  display: flex;
...
`,I7=V.div`
  ...
  padding: 3rem;
  color: #666;
`,S7=t=>{if(!t)return"N/A";try{let e;if(t!=null&&t.seconds)e=new Date(t.seconds*1e3);else if(t!=null&&t.toDate)e=t.toDate();else if(t instanceof Date)e=t;else if(typeof t=="string")e=new Date(t);else return"Invalid date";return e.toLocaleString("en-US",{year:"numeric",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",hour12:!0})}catch(e){return console.error("Error formatting timestamp:",e),"Invalid date"}},C7=()=>{const[t,e]=O.useState([]),[n,r]=O.useState(!0),[i,o]=O.useState(null),[s,a]=O.useState({name:"",email:"",position:"",role:""}),[u,d]=O.useState(!1);O.useEffect(()=>{h()},[]);const h=async()=>{try{r(!0);const y=await X5();e(y)}catch(y){console.error("Error fetching registration requests:",y),Y.error("Failed to load registration requests")}finally{r(!1)}},m=async y=>{try{d(!0),await J5(y),Y.success(`Registration for ${y.name||y.email} approved`),h()}catch(g){console.error("Error approving registration:",g),Y.error("Failed to approve registration")}finally{d(!1)}},E=async y=>{try{d(!0),await e3(y),Y.success(`Registration for ${y.name||y.email} declined`),Y.warning("Note: The user may still exist in Firebase Authentication. They will be blocked from accessing the system, but the account still exists."),h()}catch(g){console.error("Error declining registration:",g),Y.error("Failed to decline registration")}finally{d(!1)}},_=y=>{o(y),a({name:y.name||"",email:y.email||"",position:y.position||"",role:y.role||"user"})},x=()=>{o(null)},A=y=>{const{name:g,value:k}=y.target;a(I=>({...I,[g]:k}))},S=async y=>{y.preventDefault();try{d(!0),await Z5(i.id,{name:s.name,email:s.email,position:s.position,role:s.role}),Y.success("Registration request updated"),o(null),h()}catch(g){console.error("Error updating registration request:",g),Y.error("Failed to update registration request")}finally{d(!1)}};return n?f.jsxs(ui,{children:[f.jsx(ci,{children:"Registration Requests"}),f.jsx(di,{children:f.jsx(I7,{children:"Loading registration requests..."})})]}):f.jsxs(ui,{children:[f.jsx(ci,{children:"Registration Requests"}),f.jsxs(di,{children:[f.jsx(i7,{children:t.length===0?f.jsx(p7,{children:f.jsx("p",{children:"No pending registration requests"})}):t.map(y=>f.jsxs(o7,{children:[f.jsxs(s7,{children:[f.jsxs(a7,{children:[f.jsx(Xi,{size:18,weight:"bold"}),y.name||y.email]}),f.jsxs(l7,{children:[f.jsx(jI,{size:14}),S7(y.createdAt)]})]}),f.jsxs(u7,{children:[f.jsxs(kp,{children:[f.jsxs(Ep,{children:[f.jsx(Xi,{size:16}),"Email:"]}),f.jsx(wp,{children:y.email})]}),f.jsxs(kp,{children:[f.jsxs(Ep,{children:[f.jsx(B1,{size:16}),"Position:"]}),f.jsx(wp,{children:y.position||"Not specified"})]}),f.jsxs(kp,{children:[f.jsxs(Ep,{children:[f.jsx(Xi,{size:16}),"Role:"]}),f.jsx(wp,{children:y.role||"user"})]})]}),f.jsxs(c7,{children:[f.jsxs(f7,{onClick:()=>_(y),disabled:u,children:[f.jsx(NI,{size:16}),"Edit"]}),f.jsxs(d7,{onClick:()=>m(y),disabled:u,children:[f.jsx(Fi,{size:16}),"Accept"]}),f.jsxs(h7,{onClick:()=>E(y),disabled:u,children:[f.jsx(VI,{size:16}),"Decline"]})]})]},y.id))}),i&&f.jsx(m7,{children:f.jsxs(g7,{children:[f.jsxs(y7,{children:[f.jsx(v7,{children:"Edit Registration Request"}),f.jsx(_7,{onClick:x,children:"×"})]}),f.jsxs(k7,{onSubmit:S,children:[f.jsxs(fc,{children:[f.jsx(pc,{htmlFor:"name",children:"Name"}),f.jsx(Tp,{type:"text",id:"name",name:"name",value:s.name,onChange:A,placeholder:"Enter name"})]}),f.jsxs(fc,{children:[f.jsx(pc,{htmlFor:"email",children:"Email"}),f.jsx(Tp,{type:"email",id:"email",name:"email",value:s.email,onChange:A,placeholder:"Enter email",required:!0})]}),f.jsxs(fc,{children:[f.jsx(pc,{htmlFor:"position",children:"Position"}),f.jsx(Tp,{type:"text",id:"position",name:"position",value:s.position,onChange:A,placeholder:"Enter position"})]}),f.jsxs(fc,{children:[f.jsx(pc,{htmlFor:"role",children:"Role"}),f.jsxs(E7,{id:"role",name:"role",value:s.role,onChange:A,children:[f.jsx("option",{value:"user",children:"User"}),f.jsx("option",{value:"admin",children:"Admin"}),f.jsx("option",{value:"super_admin",children:"Super Admin"})]})]}),f.jsxs(w7,{children:[f.jsx(x7,{type:"button",onClick:x,children:"Cancel"}),f.jsx(T7,{type:"submit",disabled:u,children:"Save Changes"})]})]})]})})]})]})},A7=V.div`
  padding: 2rem;
`,L7=V.h2`
  color: #333;
  margin-bottom: 1.5rem;
...
`;function Z7(){const[t,e]=O.useState(null),[n,r]=O.useState("dashboard"),[i,o]=O.useState(null),[s,a]=O.useState(null),[u,d]=O.useState(!1),[h,m]=O.useState(null),[E,_]=O.useState(!1),x=ca();O.useEffect(()=>{const b=Sn.currentUser;if(b){const D={uid:b.uid,email:b.email,displayName:b.displayName||b.email.split("@")[0]};e(D),A(b.uid)}},[]);const A=async b=>{if(b)try{_(!0);try{const G=pr(xn(Ce,"declined_registrations"),Kr("userId","==",b));if(!(await zn(G)).empty){Y.error("Your registration request has been declined. Please contact an administrator."),await Sn.signOut(),x("/login");return}}catch(G){console.error("Error checking declined status:",G)}try{const G=pr(xn(Ce,"registration_requests"),Kr("userId","==",b));if(!(await zn(G)).empty){Y.info("Your registration request is pending approval. You will be notified when approved."),await Sn.signOut(),x("/login");return}}catch(G){console.error("Error checking pending status:",G)}const D=ft(Ce,"users",b),P=await Jl(D);if(P.exists()){const G=P.data();m(G)}else console.log("No user data found in Firestore"),Y.error("Your account is not properly set up. Please contact an administrator."),await Sn.signOut(),x("/login")}catch(D){console.error("Error fetching user data:",D),Y.error("Error loading user data. Please try again later.")}finally{_(!1)}};O.useEffect(()=>{t!=null&&t.uid&&S()},[t]);const S=async()=>{try{const b=xn(Ce,"attendance");try{const D=pr(b,Kr("userId","==",t.uid),L1("timestamp","desc"),ZD(1)),P=await zn(D);if(P.empty)o(null),a(null);else{const G=P.docs[0].data();a(G),o(G.type)}}catch(D){if(D.message&&D.message.includes("index is currently building")){console.log("Index is still building, using fallback method");const P=pr(b,Kr("userId","==",t.uid)),G=await zn(P);if(G.empty)o(null),a(null);else{let ae=null,pe=new Date(0);G.forEach(me=>{var Z;const z=me.data(),q=((Z=z.timestamp)==null?void 0:Z.toDate())||new Date(0);q>pe&&(pe=q,ae=z)}),ae?(a(ae),o(ae.type)):(o(null),a(null))}Y.info("System is updating. Some features may be temporarily limited.",{autoClose:5e3,hideProgressBar:!1})}else throw D}}catch(b){console.error("Error fetching attendance status:",b),b.message&&b.message.includes("index")?Y.warning("System is updating attendance records. Please try again in a few minutes."):Y.error("Unable to fetch your attendance status. Please refresh the page.")}},[y,g]=O.useState(!1),[k,I]=O.useState(null),[R,N]=O.useState(""),T=async(b,D)=>{if(b==="Out")return"Complete";try{const P=await Jl(ft(Ce,"users",D));if(!P.exists())return console.warn("User document not found when determining status"),"On Time";const ae=P.data().schedule||[],pe=new Date,me=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][pe.getDay()],z=ae&&Array.isArray(ae)?ae.find(ye=>ye.dayOfWeek===me):null;if(!z)return console.log("No schedule found for today:",me),"On Time";console.log("Found schedule for today:",z);const[q,Z]=z.timeIn.split(":").map(Number),ce=new Date;ce.setHours(q,Z,0,0);const ee=Math.round((pe-ce)/(1e3*60));return console.log("Time difference in minutes:",ee),ee<-15?"Early":ee<=15?"On Time":"Late"}catch(P){return console.error("Error determining status:",P),"On Time"}},w=async b=>{if(t){d(!0);try{const D=nt.now(),P=await T(b,t.uid),G={userId:t.uid,email:t.email,name:t.displayName,type:b,status:P,timestamp:D,notes:""};N(""),I(G),g(!0)}catch(D){console.error("Error preparing time in/out:",D),Y.error("Failed to prepare time in/out. Please try again.")}finally{d(!1)}}},L=async()=>{if(k){d(!0);try{const{status:b,...D}=k;D.notes=R;const P=await P8(xn(Ce,"attendance"),D);Y.success(`Time ${k.type} recorded successfully!`),o(k.type);const G={...k,notes:R};a(G),g(!1),I(null),N(""),console.log(`Time ${k.type} recorded with ID: ${P.id}`)}catch(b){console.error(`Error recording time ${k.type}:`,b),Y.error(`Failed to record time ${k.type}`)}finally{d(!1)}}},j=()=>{g(!1),I(null),N("")};return f.jsxs(f.Fragment,{children:[f.jsxs(P3,{user:t,activeTab:n,setActiveTab:r,attendanceStatus:i,loading:u,handleTimeInOut:w,lastRecord:s,isSuperAdmin:(h==null?void 0:h.role)==="super_admin",userData:h,setUserData:m,children:[n==="dashboard"&&f.jsx(j3,{attendanceStatus:i,lastRecord:s}),n==="attendance"&&f.jsx(N3,{user:t}),n==="schedule"&&f.jsx(e7,{user:t,userData:h}),n==="profile"&&f.jsx(r7,{user:t,userData:h,loadingUserData:E}),n==="registration_requests"&&(h==null?void 0:h.role)==="super_admin"&&f.jsx(C7,{}),n==="user_management"&&(h==null?void 0:h.role)==="super_admin"&&f.jsx($7,{})]}),y&&k&&f.jsx(z7,{children:f.jsxs(B7,{children:[f.jsxs(H7,{children:["Confirm Time ",k.type]}),f.jsxs(q7,{children:[f.jsxs("p",{children:[f.jsx("strong",{children:"Time:"})," ",k.timestamp.toDate().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0})]}),f.jsxs("p",{children:[f.jsx("strong",{children:"Date:"})," ",k.timestamp.toDate().toLocaleDateString()]}),f.jsxs("p",{children:[f.jsx("strong",{children:"Status:"}),f.jsx(Q7,{status:k.status,children:k.status})]}),f.jsxs("div",{style:{marginTop:"1rem"},children:[f.jsx("strong",{children:"Notes (Optional):"}),f.jsx(X7,{value:R,onChange:b=>N(b.target.value),placeholder:"Add any notes about this attendance record..."})]})]}),f.jsxs(G7,{children:[f.jsxs(Y7,{onClick:j,children:[f.jsx(Q1,{size:16,style:{marginRight:"4px"}}),"Cancel"]}),f.jsxs(K7,{onClick:L,children:[f.jsx(H1,{size:16,style:{marginRight:"4px"}}),"Confirm"]})]})]})})]})}const J7=({children:t})=>{const{currentUser:e,loading:n}=V1();return n?f.jsx(eF,{children:"Loading..."}):e?t:f.jsx(aT,{to:"/",replace:!0})},eF=V.div`
  display: flex;
  justify-content: center;
  align-items: center;
  height: 100vh;
  ...
  color: #6e8efb;
  background-color: #f5f5f5;
`;function tF(){return f.jsx(f.Fragment,{children:f.jsx(JN,{children:f.jsxs(d3,{children:[f.jsx(eA,{children:f.jsxs(G4,{children:[f.jsx(Ka,{path:"/",element:f.jsx(K5,{})}),f.jsx(Ka,{path:"/register",element:f.jsx(c3,{})}),f.jsx(Ka,{path:"/dashboard",element:f.jsx(J7,{children:f.jsx(Z7,{})})}),f.jsx(Ka,{path:"*",element:f.jsx(aT,{to:"/",replace:!0})})]})}),f.jsx(tg,{position:"top-right",autoClose:3e3})]})})})}Qw(document.getElementById("root")).render(f.jsx(O.StrictMode,{children:f.jsx(tF,{})}));
