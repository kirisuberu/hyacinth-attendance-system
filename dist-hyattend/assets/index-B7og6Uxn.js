...
*/var Yi,sx;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(T,w){function C(){}C.prototype=w.prototype,T.D=w.prototype,T.prototype=new C,T.prototype.constructor=T,T.C=function(R,j,D){for(var P=Array(arguments.length-2),X=2;X<arguments.length;X++)P[X-2]=arguments[X];return w.prototype[j].apply(R,P)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(T,w,C){C||(C=0);var R=Array(16);if(typeof w=="string")for(var j=0;16>j;++j)R[j]=w.charCodeAt(C++)|w.charCodeAt(C++)<<8|w.charCodeAt(C++)<<16|w.charCodeAt(C++)<<24;else for(j=0;16>j;++j)R[j]=w[C++]|w[C++]<<8|w[C++]<<16|w[C++]<<24;w=T.g[0],C=T.g[1],j=T.g[2];var D=T.g[3],P=w+(D^C&(j^D))+R[0]+3614090360&4294967295;w=C+(P<<7&4294967295|P>>>25),P=D+(j^w&(C^j))+R[1]+3905402710&4294967295,D=w+(P<<12&4294967295|P>>>20),P=j+(C^D&(w^C))+R[2]+606105819&4294967295,j=D+(P<<17&4294967295|P>>>15),P=C+(w^j&(D^w))+R[3]+3250441966&4294967295,C=j+(P<<22&4294967295|P>>>10),P=w+(D^C&(j^D))+R[4]+4118548399&4294967295,w=C+(P<<7&4294967295|P>>>25),P=D+(j^w&(C^j))+R[5]+1200080426&4294967295,D=w+(P<<12&4294967295|P>>>20),P=j+(C^D&(w^C))+R[6]+2821735955&4294967295,j=D+(P<<17&4294967295|P>>>15),P=C+(w^j&(D^w))+R[7]+4249261313&4294967295,C=j+(P<<22&4294967295|P>>>10),P=w+(D^C&(j^D))+R[8]+1770035416&4294967295,w=C+(P<<7&4294967295|P>>>25),P=D+(j^w&(C^j))+R[9]+2336552879&4294967295,D=w+(P<<12&4294967295|P>>>20),P=j+(C^D&(w^C))+R[10]+4294925233&4294967295,j=D+(P<<17&4294967295|P>>>15),P=C+(w^j&(D^w))+R[11]+2304563134&4294967295,C=j+(P<<22&4294967295|P>>>10),P=w+(D^C&(j^D))+R[12]+1804603682&4294967295,w=C+(P<<7&4294967295|P>>>25),P=D+(j^w&(C^j))+R[13]+4254626195&4294967295,D=w+(P<<12&4294967295|P>>>20),P=j+(C^D&(w^C))+R[14]+2792965006&4294967295,j=D+(P<<17&4294967295|P>>>15),P=C+(w^j&(D^w))+R[15]+1236535329&4294967295,C=j+(P<<22&4294967295|P>>>10),P=w+(j^D&(C^j))+R[1]+4129170786&4294967295,w=C+(P<<5&4294967295|P>>>27),P=D+(C^j&(w^C))+R[6]+3225465664&4294967295,D=w+(P<<9&4294967295|P>>>23),P=j+(w^C&(D^w))+R[11]+643717713&4294967295,j=D+(P<<14&4294967295|P>>>18),P=C+(D^w&(j^D))+R[0]+3921069994&4294967295,C=j+(P<<20&4294967295|P>>>12),P=w+(j^D&(C^j))+R[5]+3593408605&4294967295,w=C+(P<<5&4294967295|P>>>27),P=D+(C^j&(w^C))+R[10]+38016083&4294967295,D=w+(P<<9&4294967295|P>>>23),P=j+(w^C&(D^w))+R[15]+3634488961&4294967295,j=D+(P<<14&4294967295|P>>>18),P=C+(D^w&(j^D))+R[4]+3889429448&4294967295,C=j+(P<<20&4294967295|P>>>12),P=w+(j^D&(C^j))+R[9]+568446438&4294967295,w=C+(P<<5&4294967295|P>>>27),P=D+(C^j&(w^C))+R[14]+3275163606&4294967295,D=w+(P<<9&4294967295|P>>>23),P=j+(w^C&(D^w))+R[3]+4107603335&4294967295,j=D+(P<<14&4294967295|P>>>18),P=C+(D^w&(j^D))+R[8]+1163531501&4294967295,C=j+(P<<20&4294967295|P>>>12),P=w+(j^D&(C^j))+R[13]+2850285829&4294967295,w=C+(P<<5&4294967295|P>>>27),P=D+(C^j&(w^C))+R[2]+4243563512&4294967295,D=w+(P<<9&4294967295|P>>>23),P=j+(w^C&(D^w))+R[7]+1735328473&4294967295,j=D+(P<<14&4294967295|P>>>18),P=C+(D^w&(j^D))+R[12]+2368359562&4294967295,C=j+(P<<20&4294967295|P>>>12),P=w+(C^j^D)+R[5]+4294588738&4294967295,w=C+(P<<4&4294967295|P>>>28),P=D+(w^C^j)+R[8]+2272392833&4294967295,D=w+(P<<11&4294967295|P>>>21),P=j+(D^w^C)+R[11]+1839030562&4294967295,j=D+(P<<16&4294967295|P>>>16),P=C+(j^D^w)+R[14]+4259657740&4294967295,C=j+(P<<23&4294967295|P>>>9),P=w+(C^j^D)+R[1]+2763975236&4294967295,w=C+(P<<4&4294967295|P>>>28),P=D+(w^C^j)+R[4]+1272893353&4294967295,D=w+(P<<11&4294967295|P>>>21),P=j+(D^w^C)+R[7]+4139469664&4294967295,j=D+(P<<16&4294967295|P>>>16),P=C+(j^D^w)+R[10]+3200236656&4294967295,C=j+(P<<23&4294967295|P>>>9),P=w+(C^j^D)+R[13]+681279174&4294967295,w=C+(P<<4&4294967295|P>>>28),P=D+(w^C^j)+R[0]+3936430074&4294967295,D=w+(P<<11&4294967295|P>>>21),P=j+(D^w^C)+R[3]+3572445317&4294967295,j=D+(P<<16&4294967295|P>>>16),P=C+(j^D^w)+R[6]+76029189&4294967295,C=j+(P<<23&4294967295|P>>>9),P=w+(C^j^D)+R[9]+3654602809&4294967295,w=C+(P<<4&4294967295|P>>>28),P=D+(w^C^j)+R[12]+3873151461&4294967295,D=w+(P<<11&4294967295|P>>>21),P=j+(D^w^C)+R[15]+530742520&4294967295,j=D+(P<<16&4294967295|P>>>16),P=C+(j^D^w)+R[2]+3299628645&4294967295,C=j+(P<<23&4294967295|P>>>9),P=w+(j^(C|~D))+R[0]+4096336452&4294967295,w=C+(P<<6&4294967295|P>>>26),P=D+(C^(w|~j))+R[7]+1126891415&4294967295,D=w+(P<<10&4294967295|P>>>22),P=j+(w^(D|~C))+R[14]+2878612391&4294967295,j=D+(P<<15&4294967295|P>>>17),P=C+(D^(j|~w))+R[5]+4237533241&4294967295,C=j+(P<<21&4294967295|P>>>11),P=w+(j^(C|~D))+R[12]+1700485571&4294967295,w=C+(P<<6&4294967295|P>>>26),P=D+(C^(w|~j))+R[3]+2399980690&4294967295,D=w+(P<<10&4294967295|P>>>22),P=j+(w^(D|~C))+R[10]+4293915773&4294967295,j=D+(P<<15&4294967295|P>>>17),P=C+(D^(j|~w))+R[1]+2240044497&4294967295,C=j+(P<<21&4294967295|P>>>11),P=w+(j^(C|~D))+R[8]+1873313359&4294967295,w=C+(P<<6&4294967295|P>>>26),P=D+(C^(w|~j))+R[15]+4264355552&4294967295,D=w+(P<<10&4294967295|P>>>22),P=j+(w^(D|~C))+R[6]+2734768916&4294967295,j=D+(P<<15&4294967295|P>>>17),P=C+(D^(j|~w))+R[13]+1309151649&4294967295,C=j+(P<<21&4294967295|P>>>11),P=w+(j^(C|~D))+R[4]+4149444226&4294967295,w=C+(P<<6&4294967295|P>>>26),P=D+(C^(w|~j))+R[11]+3174756917&4294967295,D=w+(P<<10&4294967295|P>>>22),P=j+(w^(D|~C))+R[2]+718787259&4294967295,j=D+(P<<15&4294967295|P>>>17),P=C+(D^(j|~w))+R[9]+3951481745&4294967295,T.g[0]=T.g[0]+w&4294967295,T.g[1]=T.g[1]+(j+(P<<21&4294967295|P>>>11))&4294967295,T.g[2]=T.g[2]+j&4294967295,T.g[3]=T.g[3]+D&4294967295}r.prototype.u=function(T,w){w===void 0&&(w=T.length);for(var C=w-this.blockSize,R=this.B,j=this.h,D=0;D<w;){if(j==0)for(;D<=C;)i(this,T,D),D+=this.blockSize;if(typeof T=="string"){for(;D<w;)if(R[j++]=T.charCodeAt(D++),j==this.blockSize){i(this,R),j=0;break}}else for(;D<w;)if(R[j++]=T[D++],j==this.blockSize){i(this,R),j=0;break}}this.h=j,this.o+=w},r.prototype.v=function(){var T=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);T[0]=128;for(var w=1;w<T.length-8;++w)T[w]=0;var C=8*this.o;for(w=T.length-8;w<T.length;++w)T[w]=C&255,C/=256;for(this.u(T),T=Array(16),w=C=0;4>w;++w)for(var R=0;32>R;R+=8)T[C++]=this.g[w]>>>R&255;return T};function o(T,w){var C=a;return Object.prototype.hasOwnProperty.call(C,T)?C[T]:C[T]=w(T)}function s(T,w){this.h=w;for(var C=[],R=!0,j=T.length-1;0<=j;j--){var D=T[j]|0;R&&D==w||(C[j]=D,R=!1)}this.g=C}var a={};function u(T){return-128<=T&&128>T?o(T,function(w){return new s([w|0],0>w?-1:0)}):new s([T|0],0>T?-1:0)}function d(T){if(isNaN(T)||!isFinite(T))return m;if(0>T)return S(d(-T));for(var w=[],C=1,R=0;T>=C;R++)w[R]=T/C|0,C*=4294967296;return new s(w,0)}function h(T,w){if(T.length==0)throw Error("number format error: empty string");if(w=w||10,2>w||36<w)throw Error("radix out of range: "+w);if(T.charAt(0)=="-")return S(h(T.substring(1),w));if(0<=T.indexOf("-"))throw Error('number format error: interior "-" character');for(var C=d(Math.pow(w,8)),R=m,j=0;j<T.length;j+=8){var D=Math.min(8,T.length-j),P=parseInt(T.substring(j,j+D),w);8>D?(D=d(Math.pow(w,D)),R=R.j(D).add(d(P))):(R=R.j(C),R=R.add(d(P)))}return R}var m=u(0),k=u(1),E=u(16777216);t=s.prototype,t.m=function(){if(L(this))return-S(this).m();for(var T=0,w=1,C=0;C<this.g.length;C++){var R=this.i(C);T+=(0<=R?R:4294967296+R)*w,w*=4294967296}return T},t.toString=function(T){if(T=T||10,2>T||36<T)throw Error("radix out of range: "+T);if(I(this))return"0";if(L(this))return"-"+S(this).toString(T);for(var w=d(Math.pow(T,6)),C=this,R="";;){var j=x(C,w).g;C=v(C,j.j(w));var D=((0<C.g.length?C.g[0]:C.h)>>>0).toString(T);if(C=j,I(C))return D+R;for(;6>D.length;)D="0"+D;R=D+R}},t.i=function(T){return 0>T?0:T<this.g.length?this.g[T]:this.h};function I(T){if(T.h!=0)return!1;for(var w=0;w<T.g.length;w++)if(T.g[w]!=0)return!1;return!0}function L(T){return T.h==-1}t.l=function(T){return T=v(this,T),L(T)?-1:I(T)?0:1};function S(T){for(var w=T.g.length,C=[],R=0;R<w;R++)C[R]=~T.g[R];return new s(C,~T.h).add(k)}t.abs=function(){return L(this)?S(this):this},t.add=function(T){for(var w=Math.max(this.g.length,T.g.length),C=[],R=0,j=0;j<=w;j++){var D=R+(this.i(j)&65535)+(T.i(j)&65535),P=(D>>>16)+(this.i(j)>>>16)+(T.i(j)>>>16);R=P>>>16,D&=65535,P&=65535,C[j]=P<<16|D}return new s(C,C[C.length-1]&-2147483648?-1:0)};function v(T,w){return T.add(S(w))}t.j=function(T){if(I(this)||I(T))return m;if(L(this))return L(T)?S(this).j(S(T)):S(S(this).j(T));if(L(T))return S(this.j(S(T)));if(0>this.l(E)&&0>T.l(E))return d(this.m()*T.m());for(var w=this.g.length+T.g.length,C=[],R=0;R<2*w;R++)C[R]=0;for(R=0;R<this.g.length;R++)for(var j=0;j<T.g.length;j++){var D=this.i(R)>>>16,P=this.i(R)&65535,X=T.i(j)>>>16,ge=T.i(j)&65535;C[2*R+2*j]+=P*ge,g(C,2*R+2*j),C[2*R+2*j+1]+=D*ge,g(C,2*R+2*j+1),C[2*R+2*j+1]+=P*X,g(C,2*R+2*j+1),C[2*R+2*j+2]+=D*X,g(C,2*R+2*j+2)}for(R=0;R<w;R++)C[R]=C[2*R+1]<<16|C[2*R];for(R=w;R<2*w;R++)C[R]=0;return new s(C,0)};function g(T,w){for(;(T[w]&65535)!=T[w];)T[w+1]+=T[w]>>>16,T[w]&=65535,w++}function _(T,w){this.g=T,this.h=w}function x(T,w){if(I(w))throw Error("division by zero");if(I(T))return new _(m,m);if(L(T))return w=x(S(T),w),new _(S(w.g),S(w.h));if(L(w))return w=x(T,S(w)),new _(S(w.g),w.h);if(30<T.g.length){if(L(T)||L(w))throw Error("slowDivide_ only works with positive integers.");for(var C=k,R=w;0>=R.l(T);)C=b(C),R=b(R);var j=M(C,1),D=M(R,1);for(R=M(R,2),C=M(C,2);!I(R);){var P=D.add(R);0>=P.l(T)&&(j=j.add(C),D=P),R=M(R,1),C=M(C,1)}return w=v(T,j.j(w)),new _(j,w)}for(j=m;0<=T.l(w);){for(C=Math.max(1,Math.floor(T.m()/w.m())),R=Math.ceil(Math.log(C)/Math.LN2),R=48>=R?1:Math.pow(2,R-48),D=d(C),P=D.j(w);L(P)||0<P.l(T);)C-=R,D=d(C),P=D.j(w);I(D)&&(D=k),j=j.add(D),T=v(T,P)}return new _(j,T)}t.A=function(T){return x(this,T).h},t.and=function(T){for(var w=Math.max(this.g.length,T.g.length),C=[],R=0;R<w;R++)C[R]=this.i(R)&T.i(R);return new s(C,this.h&T.h)},t.or=function(T){for(var w=Math.max(this.g.length,T.g.length),C=[],R=0;R<w;R++)C[R]=this.i(R)|T.i(R);return new s(C,this.h|T.h)},t.xor=function(T){for(var w=Math.max(this.g.length,T.g.length),C=[],R=0;R<w;R++)C[R]=this.i(R)^T.i(R);return new s(C,this.h^T.h)};function b(T){for(var w=T.g.length+1,C=[],R=0;R<w;R++)C[R]=T.i(R)<<1|T.i(R-1)>>>31;return new s(C,T.h)}function M(T,w){var C=w>>5;w%=32;for(var R=T.g.length-C,j=[],D=0;D<R;D++)j[D]=0<w?T.i(D+C)>>>w|T.i(D+C+1)<<32-w:T.i(D+C);return new s(j,T.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,sx=r,s.prototype.add=s.prototype.add,s.prototype.multiply=s.prototype.j,s.prototype.modulo=s.prototype.A,s.prototype.compare=s.prototype.l,s.prototype.toNumber=s.prototype.m,s.prototype.toString=s.prototype.toString,s.prototype.getBits=s.prototype.i,s.fromNumber=d,s.fromString=h,Yi=s}).apply(typeof q_<"u"?q_:typeof self<"u"?self:typeof window<"u"?window:{});var rc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var ax,Za,lx,Rc,bm,ux,cx,dx;(function(){var t,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(l,f,y){return l==Array.prototype||l==Object.prototype||(l[f]=y.value),l};function n(l){l=[typeof globalThis=="object"&&globalThis,l,typeof window=="object"&&window,typeof self=="object"&&self,typeof rc=="object"&&rc];for(var f=0;f<l.length;++f){var y=l[f];if(y&&y.Math==Math)return y}throw Error("Cannot find global object")}var r=n(this);function i(l,f){if(f)e:{var y=r;l=l.split(".");for(var A=0;A<l.length-1;A++){var N=l[A];if(!(N in y))break e;y=y[N]}l=l[l.length-1],A=y[l],f=f(A),f!=A&&f!=null&&e(y,l,{configurable:!0,writable:!0,value:f})}}function o(l,f){l instanceof String&&(l+="");var y=0,A=!1,N={next:function(){if(!A&&y<l.length){var U=y++;return{value:f(U,l[U]),done:!1}}return A=!0,{done:!0,value:void 0}}};return N[Symbol.iterator]=function(){return N},N}i("Array.prototype.values",function(l){return l||function(){return o(this,function(f,y){return y})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var s=s||{},a=this||self;function u(l){var f=typeof l;return f=f!="object"?f:l?Array.isArray(l)?"array":f:"null",f=="array"||f=="object"&&typeof l.length=="number"}function d(l){var f=typeof l;return f=="object"&&l!=null||f=="function"}function h(l,f,y){return l.call.apply(l.bind,arguments)}function m(l,f,y){if(!l)throw Error();if(2<arguments.length){var A=Array.prototype.slice.call(arguments,2);return function(){var N=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(N,A),l.apply(f,N)}}return function(){return l.apply(f,arguments)}}function k(l,f,y){return k=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?h:m,k.apply(null,arguments)}function E(l,f){var y=Array.prototype.slice.call(arguments,1);return function(){var A=y.slice();return A.push.apply(A,arguments),l.apply(this,A)}}function I(l,f){function y(){}y.prototype=f.prototype,l.aa=f.prototype,l.prototype=new y,l.prototype.constructor=l,l.Qb=function(A,N,U){for(var H=Array(arguments.length-2),Ae=2;Ae<arguments.length;Ae++)H[Ae-2]=arguments[Ae];return f.prototype[N].apply(A,H)}}function L(l){const f=l.length;if(0<f){const y=Array(f);for(let A=0;A<f;A++)y[A]=l[A];return y}return[]}function S(l,f){for(let y=1;y<arguments.length;y++){const A=arguments[y];if(u(A)){const N=l.length||0,U=A.length||0;l.length=N+U;for(let H=0;H<U;H++)l[N+H]=A[H]}else l.push(A)}}class v{constructor(f,y){this.i=f,this.j=y,this.h=0,this.g=null}get(){let f;return 0<this.h?(this.h--,f=this.g,this.g=f.next,f.next=null):f=this.i(),f}}function g(l){return/^[\s\xa0]*$/.test(l)}function _(){var l=a.navigator;return l&&(l=l.userAgent)?l:""}function x(l){return x[" "](l),l}x[" "]=function(){};var b=_().indexOf("Gecko")!=-1&&!(_().toLowerCase().indexOf("webkit")!=-1&&_().indexOf("Edge")==-1)&&!(_().indexOf("Trident")!=-1||_().indexOf("MSIE")!=-1)&&_().indexOf("Edge")==-1;function M(l,f,y){for(const A in l)f.call(y,l[A],A,l)}function T(l,f){for(const y in l)f.call(void 0,l[y],y,l)}function w(l){const f={};for(const y in l)f[y]=l[y];return f}const C="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function R(l,f){let y,A;for(let N=1;N<arguments.length;N++){A=arguments[N];for(y in A)l[y]=A[y];for(let U=0;U<C.length;U++)y=C[U],Object.prototype.hasOwnProperty.call(A,y)&&(l[y]=A[y])}}function j(l){var f=1;l=l.split(":");const y=[];for(;0<f&&l.length;)y.push(l.shift()),f--;return l.length&&y.push(l.join(":")),y}function D(l){a.setTimeout(()=>{throw l},0)}function P(){var l=q;let f=null;return l.g&&(f=l.g,l.g=l.g.next,l.g||(l.h=null),f.next=null),f}class X{constructor(){this.h=this.g=null}add(f,y){const A=ge.get();A.set(f,y),this.h?this.h.next=A:this.g=A,this.h=A}}var ge=new v(()=>new he,l=>l.reset());class he{constructor(){this.next=this.g=this.h=null}set(f,y){this.h=f,this.g=y,this.next=null}reset(){this.next=this.g=this.h=null}}let pe,z=!1,q=new X,Z=()=>{const l=a.Promise.resolve(void 0);pe=()=>{l.then(ce)}};var ce=()=>{for(var l;l=P();){try{l.h.call(l.g)}catch(y){D(y)}var f=ge;f.j(l),100>f.h&&(f.h++,l.next=f.g,f.g=l)}z=!1};function te(){this.s=this.s,this.C=this.C}te.prototype.s=!1,te.prototype.ma=function(){this.s||(this.s=!0,this.N())},te.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function _e(l,f){this.type=l,this.g=this.target=f,this.defaultPrevented=!1}_e.prototype.h=function(){this.defaultPrevented=!0};var qe=function(){if(!a.addEventListener||!Object.defineProperty)return!1;var l=!1,f=Object.defineProperty({},"passive",{get:function(){l=!0}});try{const y=()=>{};a.addEventListener("test",y,f),a.removeEventListener("test",y,f)}catch{}return l}();function Ge(l,f){if(_e.call(this,l?l.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,l){var y=this.type=l.type,A=l.changedTouches&&l.changedTouches.length?l.changedTouches[0]:null;if(this.target=l.target||l.srcElement,this.g=f,f=l.relatedTarget){if(b){e:{try{x(f.nodeName);var N=!0;break e}catch{}N=!1}N||(f=null)}}else y=="mouseover"?f=l.fromElement:y=="mouseout"&&(f=l.toElement);this.relatedTarget=f,A?(this.clientX=A.clientX!==void 0?A.clientX:A.pageX,this.clientY=A.clientY!==void 0?A.clientY:A.pageY,this.screenX=A.screenX||0,this.screenY=A.screenY||0):(this.clientX=l.clientX!==void 0?l.clientX:l.pageX,this.clientY=l.clientY!==void 0?l.clientY:l.pageY,this.screenX=l.screenX||0,this.screenY=l.screenY||0),this.button=l.button,this.key=l.key||"",this.ctrlKey=l.ctrlKey,this.altKey=l.altKey,this.shiftKey=l.shiftKey,this.metaKey=l.metaKey,this.pointerId=l.pointerId||0,this.pointerType=typeof l.pointerType=="string"?l.pointerType:Xe[l.pointerType]||"",this.state=l.state,this.i=l,l.defaultPrevented&&Ge.aa.h.call(this)}}I(Ge,_e);var Xe={2:"touch",3:"pen",4:"mouse"};Ge.prototype.h=function(){Ge.aa.h.call(this);var l=this.i;l.preventDefault?l.preventDefault():l.returnValue=!1};var F="closure_listenable_"+(1e6*Math.random()|0),oe=0;function se(l,f,y,A,N){this.listener=l,this.proxy=null,this.src=f,this.type=y,this.capture=!!A,this.ha=N,this.key=++oe,this.da=this.fa=!1}function ae(l){l.da=!0,l.listener=null,l.proxy=null,l.src=null,l.ha=null}function ue(l){this.src=l,this.g={},this.h=0}ue.prototype.add=function(l,f,y,A,N){var U=l.toString();l=this.g[U],l||(l=this.g[U]=[],this.h++);var H=Yo(l,f,A,N);return-1<H?(f=l[H],y||(f.fa=!1)):(f=new se(f,this.src,U,!!A,N),f.fa=y,l.push(f)),f};function Te(l,f){var y=f.type;if(y in l.g){var A=l.g[y],N=Array.prototype.indexOf.call(A,f,void 0),U;(U=0<=N)&&Array.prototype.splice.call(A,N,1),U&&(ae(f),l.g[y].length==0&&(delete l.g[y],l.h--))}}function Yo(l,f,y,A){for(var N=0;N<l.length;++N){var U=l[N];if(!U.da&&U.listener==f&&U.capture==!!y&&U.ha==A)return N}return-1}var ya="closure_lm_"+(1e6*Math.random()|0),va={};function vt(l,f,y,A,N){if(Array.isArray(f)){for(var U=0;U<f.length;U++)vt(l,f[U],y,A,N);return null}return y=ry(y),l&&l[F]?l.K(f,y,d(A)?!!A.capture:!1,N):On(l,f,y,!1,A,N)}function On(l,f,y,A,N,U){if(!f)throw Error("Invalid event type");var H=d(N)?!!N.capture:!!N,Ae=Zh(l);if(Ae||(l[ya]=Ae=new ue(l)),y=Ae.add(f,y,A,H,U),y.proxy)return y;if(A=Ko(),y.proxy=A,A.src=l,A.listener=y,l.addEventListener)qe||(N=H),N===void 0&&(N=!1),l.addEventListener(f.toString(),A,N);else if(l.attachEvent)l.attachEvent(ny(f.toString()),A);else if(l.addListener&&l.removeListener)l.addListener(A);else throw Error("addEventListener and attachEvent are unavailable.");return y}function Ko(){function l(y){return f.call(l.src,l.listener,y)}const f=nS;return l}function ty(l,f,y,A,N){if(Array.isArray(f))for(var U=0;U<f.length;U++)ty(l,f[U],y,A,N);else A=d(A)?!!A.capture:!!A,y=ry(y),l&&l[F]?(l=l.i,f=String(f).toString(),f in l.g&&(U=l.g[f],y=Yo(U,y,A,N),-1<y&&(ae(U[y]),Array.prototype.splice.call(U,y,1),U.length==0&&(delete l.g[f],l.h--)))):l&&(l=Zh(l))&&(f=l.g[f.toString()],l=-1,f&&(l=Yo(f,y,A,N)),(y=-1<l?f[l]:null)&&Xh(y))}function Xh(l){if(typeof l!="number"&&l&&!l.da){var f=l.src;if(f&&f[F])Te(f.i,l);else{var y=l.type,A=l.proxy;f.removeEventListener?f.removeEventListener(y,A,l.capture):f.detachEvent?f.detachEvent(ny(y),A):f.addListener&&f.removeListener&&f.removeListener(A),(y=Zh(f))?(Te(y,l),y.h==0&&(y.src=null,f[ya]=null)):ae(l)}}}function ny(l){return l in va?va[l]:va[l]="on"+l}function nS(l,f){if(l.da)l=!0;else{f=new Ge(f,this);var y=l.listener,A=l.ha||l.src;l.fa&&Xh(l),l=y.call(A,f)}return l}function Zh(l){return l=l[ya],l instanceof ue?l:null}var Jh="__closure_events_fn_"+(1e9*Math.random()>>>0);function ry(l){return typeof l=="function"?l:(l[Jh]||(l[Jh]=function(f){return l.handleEvent(f)}),l[Jh])}function _t(){te.call(this),this.i=new ue(this),this.M=this,this.F=null}I(_t,te),_t.prototype[F]=!0,_t.prototype.removeEventListener=function(l,f,y,A){ty(this,l,f,y,A)};function Rt(l,f){var y,A=l.F;if(A)for(y=[];A;A=A.F)y.push(A);if(l=l.M,A=f.type||f,typeof f=="string")f=new _e(f,l);else if(f instanceof _e)f.target=f.target||l;else{var N=f;f=new _e(A,l),R(f,N)}if(N=!0,y)for(var U=y.length-1;0<=U;U--){var H=f.g=y[U];N=Tu(H,A,!0,f)&&N}if(H=f.g=l,N=Tu(H,A,!0,f)&&N,N=Tu(H,A,!1,f)&&N,y)for(U=0;U<y.length;U++)H=f.g=y[U],N=Tu(H,A,!1,f)&&N}_t.prototype.N=function(){if(_t.aa.N.call(this),this.i){var l=this.i,f;for(f in l.g){for(var y=l.g[f],A=0;A<y.length;A++)ae(y[A]);delete l.g[f],l.h--}}this.F=null},_t.prototype.K=function(l,f,y,A){return this.i.add(String(l),f,!1,y,A)},_t.prototype.L=function(l,f,y,A){return this.i.add(String(l),f,!0,y,A)};function Tu(l,f,y,A){if(f=l.i.g[String(f)],!f)return!0;f=f.concat();for(var N=!0,U=0;U<f.length;++U){var H=f[U];if(H&&!H.da&&H.capture==y){var Ae=H.listener,ut=H.ha||H.src;H.fa&&Te(l.i,H),N=Ae.call(ut,A)!==!1&&N}}return N&&!A.defaultPrevented}function iy(l,f,y){if(typeof l=="function")y&&(l=k(l,y));else if(l&&typeof l.handleEvent=="function")l=k(l.handleEvent,l);else throw Error("Invalid listener argument");return 2147483647<Number(f)?-1:a.setTimeout(l,f||0)}function oy(l){l.g=iy(()=>{l.g=null,l.i&&(l.i=!1,oy(l))},l.l);const f=l.h;l.h=null,l.m.apply(null,f)}class rS extends te{constructor(f,y){super(),this.m=f,this.l=y,this.h=null,this.i=!1,this.g=null}j(f){this.h=arguments,this.g?this.i=!0:oy(this)}N(){super.N(),this.g&&(a.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function _a(l){te.call(this),this.h=l,this.g={}}I(_a,te);var sy=[];function ay(l){M(l.g,function(f,y){this.g.hasOwnProperty(y)&&Xh(f)},l),l.g={}}_a.prototype.N=function(){_a.aa.N.call(this),ay(this)},_a.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var ef=a.JSON.stringify,iS=a.JSON.parse,oS=class{stringify(l){return a.JSON.stringify(l,void 0)}parse(l){return a.JSON.parse(l,void 0)}};function tf(){}tf.prototype.h=null;function ly(l){return l.h||(l.h=l.i())}function uy(){}var ka={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function nf(){_e.call(this,"d")}I(nf,_e);function rf(){_e.call(this,"c")}I(rf,_e);var Ci={},cy=null;function xu(){return cy=cy||new _t}Ci.La="serverreachability";function dy(l){_e.call(this,Ci.La,l)}I(dy,_e);function Ea(l){const f=xu();Rt(f,new dy(f))}Ci.STAT_EVENT="statevent";function hy(l,f){_e.call(this,Ci.STAT_EVENT,l),this.stat=f}I(hy,_e);function bt(l){const f=xu();Rt(f,new hy(f,l))}Ci.Ma="timingevent";function fy(l,f){_e.call(this,Ci.Ma,l),this.size=f}I(fy,_e);function wa(l,f){if(typeof l!="function")throw Error("Fn must not be null and must be a function");return a.setTimeout(function(){l()},f)}function Ta(){this.g=!0}Ta.prototype.xa=function(){this.g=!1};function sS(l,f,y,A,N,U){l.info(function(){if(l.g)if(U)for(var H="",Ae=U.split("&"),ut=0;ut<Ae.length;ut++){var ke=Ae[ut].split("=");if(1<ke.length){var kt=ke[0];ke=ke[1];var Et=kt.split("_");H=2<=Et.length&&Et[1]=="type"?H+(kt+"="+ke+"&"):H+(kt+"=redacted&")}}else H=null;else H=U;return"XMLHTTP REQ ("+A+") [attempt "+N+"]: "+f+`
`+y+`
`+H})}function aS(l,f,y,A,N,U,H){l.info(function(){return"XMLHTTP RESP ("+A+") [ attempt "+N+"]: "+f+`
`+y+`
`+U+" "+H})}function Qo(l,f,y,A){l.info(function(){return"XMLHTTP TEXT ("+f+"): "+uS(l,y)+(A?" "+A:"")})}function lS(l,f){l.info(function(){return"TIMEOUT: "+f})}Ta.prototype.info=function(){};function uS(l,f){if(!l.g)return f;if(!f)return null;try{var y=JSON.parse(f);if(y){for(l=0;l<y.length;l++)if(Array.isArray(y[l])){var A=y[l];if(!(2>A.length)){var N=A[1];if(Array.isArray(N)&&!(1>N.length)){var U=N[0];if(U!="noop"&&U!="stop"&&U!="close")for(var H=1;H<N.length;H++)N[H]=""}}}}return ef(y)}catch{return f}}var Iu={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},py={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},of;function Su(){}I(Su,tf),Su.prototype.g=function(){return new XMLHttpRequest},Su.prototype.i=function(){return{}},of=new Su;function Ar(l,f,y,A){this.j=l,this.i=f,this.l=y,this.R=A||1,this.U=new _a(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new my}function my(){this.i=null,this.g="",this.h=!1}var gy={},sf={};function af(l,f,y){l.L=1,l.v=Pu(nr(f)),l.m=y,l.P=!0,yy(l,null)}function yy(l,f){l.F=Date.now(),Cu(l),l.A=nr(l.v);var y=l.A,A=l.R;Array.isArray(A)||(A=[String(A)]),Ry(y.i,"t",A),l.C=0,y=l.j.J,l.h=new my,l.g=Ky(l.j,y?f:null,!l.m),0<l.O&&(l.M=new rS(k(l.Y,l,l.g),l.O)),f=l.U,y=l.g,A=l.ca;var N="readystatechange";Array.isArray(N)||(N&&(sy[0]=N.toString()),N=sy);for(var U=0;U<N.length;U++){var H=vt(y,N[U],A||f.handleEvent,!1,f.h||f);if(!H)break;f.g[H.key]=H}f=l.H?w(l.H):{},l.m?(l.u||(l.u="POST"),f["Content-Type"]="application/x-www-form-urlencoded",l.g.ea(l.A,l.u,l.m,f)):(l.u="GET",l.g.ea(l.A,l.u,null,f)),Ea(),sS(l.i,l.u,l.A,l.l,l.R,l.m)}Ar.prototype.ca=function(l){l=l.target;const f=this.M;f&&rr(l)==3?f.j():this.Y(l)},Ar.prototype.Y=function(l){try{if(l==this.g)e:{const Et=rr(this.g);var f=this.g.Ba();const Jo=this.g.Z();if(!(3>Et)&&(Et!=3||this.g&&(this.h.h||this.g.oa()||Vy(this.g)))){this.J||Et!=4||f==7||(f==8||0>=Jo?Ea(3):Ea(2)),lf(this);var y=this.g.Z();this.X=y;t:if(vy(this)){var A=Vy(this.g);l="";var N=A.length,U=rr(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){Ai(this),xa(this);var H="";break t}this.h.i=new a.TextDecoder}for(f=0;f<N;f++)this.h.h=!0,l+=this.h.i.decode(A[f],{stream:!(U&&f==N-1)});A.length=0,this.h.g+=l,this.C=0,H=this.h.g}else H=this.g.oa();if(this.o=y==200,aS(this.i,this.u,this.A,this.l,this.R,Et,y),this.o){if(this.T&&!this.K){t:{if(this.g){var Ae,ut=this.g;if((Ae=ut.g?ut.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!g(Ae)){var ke=Ae;break t}}ke=null}if(y=ke)Qo(this.i,this.l,y,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,uf(this,y);else{this.o=!1,this.s=3,bt(12),Ai(this),xa(this);break e}}if(this.P){y=!0;let vn;for(;!this.J&&this.C<H.length;)if(vn=cS(this,H),vn==sf){Et==4&&(this.s=4,bt(14),y=!1),Qo(this.i,this.l,null,"[Incomplete Response]");break}else if(vn==gy){this.s=4,bt(15),Qo(this.i,this.l,H,"[Invalid Chunk]"),y=!1;break}else Qo(this.i,this.l,vn,null),uf(this,vn);if(vy(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Et!=4||H.length!=0||this.h.h||(this.s=1,bt(16),y=!1),this.o=this.o&&y,!y)Qo(this.i,this.l,H,"[Invalid Chunked Response]"),Ai(this),xa(this);else if(0<H.length&&!this.W){this.W=!0;var kt=this.j;kt.g==this&&kt.ba&&!kt.M&&(kt.j.info("Great, no buffering proxy detected. Bytes received: "+H.length),mf(kt),kt.M=!0,bt(11))}}else Qo(this.i,this.l,H,null),uf(this,H);Et==4&&Ai(this),this.o&&!this.J&&(Et==4?Hy(this.j,this):(this.o=!1,Cu(this)))}else CS(this.g),y==400&&0<H.indexOf("Unknown SID")?(this.s=3,bt(12)):(this.s=0,bt(13)),Ai(this),xa(this)}}}catch{}finally{}};function vy(l){return l.g?l.u=="GET"&&l.L!=2&&l.j.Ca:!1}function cS(l,f){var y=l.C,A=f.indexOf(`
`,y);return A==-1?sf:(y=Number(f.substring(y,A)),isNaN(y)?gy:(A+=1,A+y>f.length?sf:(f=f.slice(A,A+y),l.C=A+y,f)))}Ar.prototype.cancel=function(){this.J=!0,Ai(this)};function Cu(l){l.S=Date.now()+l.I,_y(l,l.I)}function _y(l,f){if(l.B!=null)throw Error("WatchDog timer not null");l.B=wa(k(l.ba,l),f)}function lf(l){l.B&&(a.clearTimeout(l.B),l.B=null)}Ar.prototype.ba=function(){this.B=null;const l=Date.now();0<=l-this.S?(lS(this.i,this.A),this.L!=2&&(Ea(),bt(17)),Ai(this),this.s=2,xa(this)):_y(this,this.S-l)};function xa(l){l.j.G==0||l.J||Hy(l.j,l)}function Ai(l){lf(l);var f=l.M;f&&typeof f.ma=="function"&&f.ma(),l.M=null,ay(l.U),l.g&&(f=l.g,l.g=null,f.abort(),f.ma())}function uf(l,f){try{var y=l.j;if(y.G!=0&&(y.g==l||cf(y.h,l))){if(!l.K&&cf(y.h,l)&&y.G==3){try{var A=y.Da.g.parse(f)}catch{A=null}if(Array.isArray(A)&&A.length==3){var N=A;if(N[0]==0){e:if(!y.u){if(y.g)if(y.g.F+3e3<l.F)Mu(y),Du(y);else break e;pf(y),bt(18)}}else y.za=N[1],0<y.za-y.T&&37500>N[2]&&y.F&&y.v==0&&!y.C&&(y.C=wa(k(y.Za,y),6e3));if(1>=wy(y.h)&&y.ca){try{y.ca()}catch{}y.ca=void 0}}else Pi(y,11)}else if((l.K||y.g==l)&&Mu(y),!g(f))for(N=y.Da.g.parse(f),f=0;f<N.length;f++){let ke=N[f];if(y.T=ke[0],ke=ke[1],y.G==2)if(ke[0]=="c"){y.K=ke[1],y.ia=ke[2];const kt=ke[3];kt!=null&&(y.la=kt,y.j.info("VER="+y.la));const Et=ke[4];Et!=null&&(y.Aa=Et,y.j.info("SVER="+y.Aa));const Jo=ke[5];Jo!=null&&typeof Jo=="number"&&0<Jo&&(A=1.5*Jo,y.L=A,y.j.info("backChannelRequestTimeoutMs_="+A)),A=y;const vn=l.g;if(vn){const Vu=vn.g?vn.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Vu){var U=A.h;U.g||Vu.indexOf("spdy")==-1&&Vu.indexOf("quic")==-1&&Vu.indexOf("h2")==-1||(U.j=U.l,U.g=new Set,U.h&&(df(U,U.h),U.h=null))}if(A.D){const gf=vn.g?vn.g.getResponseHeader("X-HTTP-Session-Id"):null;gf&&(A.ya=gf,be(A.I,A.D,gf))}}y.G=3,y.l&&y.l.ua(),y.ba&&(y.R=Date.now()-l.F,y.j.info("Handshake RTT: "+y.R+"ms")),A=y;var H=l;if(A.qa=Yy(A,A.J?A.ia:null,A.W),H.K){Ty(A.h,H);var Ae=H,ut=A.L;ut&&(Ae.I=ut),Ae.B&&(lf(Ae),Cu(Ae)),A.g=H}else zy(A);0<y.i.length&&Ou(y)}else ke[0]!="stop"&&ke[0]!="close"||Pi(y,7);else y.G==3&&(ke[0]=="stop"||ke[0]=="close"?ke[0]=="stop"?Pi(y,7):ff(y):ke[0]!="noop"&&y.l&&y.l.ta(ke),y.v=0)}}Ea(4)}catch{}}var dS=class{constructor(l,f){this.g=l,this.map=f}};function ky(l){this.l=l||10,a.PerformanceNavigationTiming?(l=a.performance.getEntriesByType("navigation"),l=0<l.length&&(l[0].nextHopProtocol=="hq"||l[0].nextHopProtocol=="h2")):l=!!(a.chrome&&a.chrome.loadTimes&&a.chrome.loadTimes()&&a.chrome.loadTimes().wasFetchedViaSpdy),this.j=l?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Ey(l){return l.h?!0:l.g?l.g.size>=l.j:!1}function wy(l){return l.h?1:l.g?l.g.size:0}function cf(l,f){return l.h?l.h==f:l.g?l.g.has(f):!1}function df(l,f){l.g?l.g.add(f):l.h=f}function Ty(l,f){l.h&&l.h==f?l.h=null:l.g&&l.g.has(f)&&l.g.delete(f)}ky.prototype.cancel=function(){if(this.i=xy(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const l of this.g.values())l.cancel();this.g.clear()}};function xy(l){if(l.h!=null)return l.i.concat(l.h.D);if(l.g!=null&&l.g.size!==0){let f=l.i;for(const y of l.g.values())f=f.concat(y.D);return f}return L(l.i)}function hS(l){if(l.V&&typeof l.V=="function")return l.V();if(typeof Map<"u"&&l instanceof Map||typeof Set<"u"&&l instanceof Set)return Array.from(l.values());if(typeof l=="string")return l.split("");if(u(l)){for(var f=[],y=l.length,A=0;A<y;A++)f.push(l[A]);return f}f=[],y=0;for(A in l)f[y++]=l[A];return f}function fS(l){if(l.na&&typeof l.na=="function")return l.na();if(!l.V||typeof l.V!="function"){if(typeof Map<"u"&&l instanceof Map)return Array.from(l.keys());if(!(typeof Set<"u"&&l instanceof Set)){if(u(l)||typeof l=="string"){var f=[];l=l.length;for(var y=0;y<l;y++)f.push(y);return f}f=[],y=0;for(const A in l)f[y++]=A;return f}}}function Iy(l,f){if(l.forEach&&typeof l.forEach=="function")l.forEach(f,void 0);else if(u(l)||typeof l=="string")Array.prototype.forEach.call(l,f,void 0);else for(var y=fS(l),A=hS(l),N=A.length,U=0;U<N;U++)f.call(void 0,A[U],y&&y[U],l)}var Sy=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function pS(l,f){if(l){l=l.split("&");for(var y=0;y<l.length;y++){var A=l[y].indexOf("="),N=null;if(0<=A){var U=l[y].substring(0,A);N=l[y].substring(A+1)}else U=l[y];f(U,N?decodeURIComponent(N.replace(/\+/g," ")):"")}}}function Li(l){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,l instanceof Li){this.h=l.h,Au(this,l.j),this.o=l.o,this.g=l.g,Lu(this,l.s),this.l=l.l;var f=l.i,y=new Ca;y.i=f.i,f.g&&(y.g=new Map(f.g),y.h=f.h),Cy(this,y),this.m=l.m}else l&&(f=String(l).match(Sy))?(this.h=!1,Au(this,f[1]||"",!0),this.o=Ia(f[2]||""),this.g=Ia(f[3]||"",!0),Lu(this,f[4]),this.l=Ia(f[5]||"",!0),Cy(this,f[6]||"",!0),this.m=Ia(f[7]||"")):(this.h=!1,this.i=new Ca(null,this.h))}Li.prototype.toString=function(){var l=[],f=this.j;f&&l.push(Sa(f,Ay,!0),":");var y=this.g;return(y||f=="file")&&(l.push("//"),(f=this.o)&&l.push(Sa(f,Ay,!0),"@"),l.push(encodeURIComponent(String(y)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),y=this.s,y!=null&&l.push(":",String(y))),(y=this.l)&&(this.g&&y.charAt(0)!="/"&&l.push("/"),l.push(Sa(y,y.charAt(0)=="/"?yS:gS,!0))),(y=this.i.toString())&&l.push("?",y),(y=this.m)&&l.push("#",Sa(y,_S)),l.join("")};function nr(l){return new Li(l)}function Au(l,f,y){l.j=y?Ia(f,!0):f,l.j&&(l.j=l.j.replace(/:$/,""))}function Lu(l,f){if(f){if(f=Number(f),isNaN(f)||0>f)throw Error("Bad port number "+f);l.s=f}else l.s=null}function Cy(l,f,y){f instanceof Ca?(l.i=f,kS(l.i,l.h)):(y||(f=Sa(f,vS)),l.i=new Ca(f,l.h))}function be(l,f,y){l.i.set(f,y)}function Pu(l){return be(l,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),l}function Ia(l,f){return l?f?decodeURI(l.replace(/%25/g,"%2525")):decodeURIComponent(l):""}function Sa(l,f,y){return typeof l=="string"?(l=encodeURI(l).replace(f,mS),y&&(l=l.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),l):null}function mS(l){return l=l.charCodeAt(0),"%"+(l>>4&15).toString(16)+(l&15).toString(16)}var Ay=/[#\/\?@]/g,gS=/[#\?:]/g,yS=/[#\?]/g,vS=/[#\?@]/g,_S=/#/g;function Ca(l,f){this.h=this.g=null,this.i=l||null,this.j=!!f}function Lr(l){l.g||(l.g=new Map,l.h=0,l.i&&pS(l.i,function(f,y){l.add(decodeURIComponent(f.replace(/\+/g," ")),y)}))}t=Ca.prototype,t.add=function(l,f){Lr(this),this.i=null,l=Xo(this,l);var y=this.g.get(l);return y||this.g.set(l,y=[]),y.push(f),this.h+=1,this};function Ly(l,f){Lr(l),f=Xo(l,f),l.g.has(f)&&(l.i=null,l.h-=l.g.get(f).length,l.g.delete(f))}function Py(l,f){return Lr(l),f=Xo(l,f),l.g.has(f)}t.forEach=function(l,f){Lr(this),this.g.forEach(function(y,A){y.forEach(function(N){l.call(f,N,A,this)},this)},this)},t.na=function(){Lr(this);const l=Array.from(this.g.values()),f=Array.from(this.g.keys()),y=[];for(let A=0;A<f.length;A++){const N=l[A];for(let U=0;U<N.length;U++)y.push(f[A])}return y},t.V=function(l){Lr(this);let f=[];if(typeof l=="string")Py(this,l)&&(f=f.concat(this.g.get(Xo(this,l))));else{l=Array.from(this.g.values());for(let y=0;y<l.length;y++)f=f.concat(l[y])}return f},t.set=function(l,f){return Lr(this),this.i=null,l=Xo(this,l),Py(this,l)&&(this.h-=this.g.get(l).length),this.g.set(l,[f]),this.h+=1,this},t.get=function(l,f){return l?(l=this.V(l),0<l.length?String(l[0]):f):f};function Ry(l,f,y){Ly(l,f),0<y.length&&(l.i=null,l.g.set(Xo(l,f),L(y)),l.h+=y.length)}t.toString=function(){if(this.i)return this.i;if(!this.g)return"";const l=[],f=Array.from(this.g.keys());for(var y=0;y<f.length;y++){var A=f[y];const U=encodeURIComponent(String(A)),H=this.V(A);for(A=0;A<H.length;A++){var N=U;H[A]!==""&&(N+="="+encodeURIComponent(String(H[A]))),l.push(N)}}return this.i=l.join("&")};function Xo(l,f){return f=String(f),l.j&&(f=f.toLowerCase()),f}function kS(l,f){f&&!l.j&&(Lr(l),l.i=null,l.g.forEach(function(y,A){var N=A.toLowerCase();A!=N&&(Ly(this,A),Ry(this,N,y))},l)),l.j=f}function ES(l,f){const y=new Ta;if(a.Image){const A=new Image;A.onload=E(Pr,y,"TestLoadImage: loaded",!0,f,A),A.onerror=E(Pr,y,"TestLoadImage: error",!1,f,A),A.onabort=E(Pr,y,"TestLoadImage: abort",!1,f,A),A.ontimeout=E(Pr,y,"TestLoadImage: timeout",!1,f,A),a.setTimeout(function(){A.ontimeout&&A.ontimeout()},1e4),A.src=l}else f(!1)}function wS(l,f){const y=new Ta,A=new AbortController,N=setTimeout(()=>{A.abort(),Pr(y,"TestPingServer: timeout",!1,f)},1e4);fetch(l,{signal:A.signal}).then(U=>{clearTimeout(N),U.ok?Pr(y,"TestPingServer: ok",!0,f):Pr(y,"TestPingServer: server error",!1,f)}).catch(()=>{clearTimeout(N),Pr(y,"TestPingServer: error",!1,f)})}function Pr(l,f,y,A,N){try{N&&(N.onload=null,N.onerror=null,N.onabort=null,N.ontimeout=null),A(y)}catch{}}function TS(){this.g=new oS}function xS(l,f,y){const A=y||"";try{Iy(l,function(N,U){let H=N;d(N)&&(H=ef(N)),f.push(A+U+"="+encodeURIComponent(H))})}catch(N){throw f.push(A+"type="+encodeURIComponent("_badmap")),N}}function Ru(l){this.l=l.Ub||null,this.j=l.eb||!1}I(Ru,tf),Ru.prototype.g=function(){return new bu(this.l,this.j)},Ru.prototype.i=function(l){return function(){return l}}({});function bu(l,f){_t.call(this),this.D=l,this.o=f,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}I(bu,_t),t=bu.prototype,t.open=function(l,f){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=l,this.A=f,this.readyState=1,La(this)},t.send=function(l){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const f={headers:this.u,method:this.B,credentials:this.m,cache:void 0};l&&(f.body=l),(this.D||a).fetch(new Request(this.A,f)).then(this.Sa.bind(this),this.ga.bind(this))},t.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Aa(this)),this.readyState=0},t.Sa=function(l){if(this.g&&(this.l=l,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=l.headers,this.readyState=2,La(this)),this.g&&(this.readyState=3,La(this),this.g)))if(this.responseType==="arraybuffer")l.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof a.ReadableStream<"u"&&"body"in l){if(this.j=l.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;by(this)}else l.text().then(this.Ra.bind(this),this.ga.bind(this))};function by(l){l.j.read().then(l.Pa.bind(l)).catch(l.ga.bind(l))}t.Pa=function(l){if(this.g){if(this.o&&l.value)this.response.push(l.value);else if(!this.o){var f=l.value?l.value:new Uint8Array(0);(f=this.v.decode(f,{stream:!l.done}))&&(this.response=this.responseText+=f)}l.done?Aa(this):La(this),this.readyState==3&&by(this)}},t.Ra=function(l){this.g&&(this.response=this.responseText=l,Aa(this))},t.Qa=function(l){this.g&&(this.response=l,Aa(this))},t.ga=function(){this.g&&Aa(this)};function Aa(l){l.readyState=4,l.l=null,l.j=null,l.v=null,La(l)}t.setRequestHeader=function(l,f){this.u.append(l,f)},t.getResponseHeader=function(l){return this.h&&this.h.get(l.toLowerCase())||""},t.getAllResponseHeaders=function(){if(!this.h)return"";const l=[],f=this.h.entries();for(var y=f.next();!y.done;)y=y.value,l.push(y[0]+": "+y[1]),y=f.next();return l.join(`\r
`)};function La(l){l.onreadystatechange&&l.onreadystatechange.call(l)}Object.defineProperty(bu.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(l){this.m=l?"include":"same-origin"}});function jy(l){let f="";return M(l,function(y,A){f+=A,f+=":",f+=y,f+=`\r
`}),f}function hf(l,f,y){e:{for(A in y){var A=!1;break e}A=!0}A||(y=jy(y),typeof l=="string"?y!=null&&encodeURIComponent(String(y)):be(l,f,y))}function Be(l){_t.call(this),this.headers=new Map,this.o=l||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}I(Be,_t);var IS=/^https?$/i,SS=["POST","PUT"];t=Be.prototype,t.Ha=function(l){this.J=l},t.ea=function(l,f,y,A){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+l);f=f?f.toUpperCase():"GET",this.D=l,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():of.g(),this.v=this.o?ly(this.o):ly(of),this.g.onreadystatechange=k(this.Ea,this);try{this.B=!0,this.g.open(f,String(l),!0),this.B=!1}catch(U){Dy(this,U);return}if(l=y||"",y=new Map(this.headers),A)if(Object.getPrototypeOf(A)===Object.prototype)for(var N in A)y.set(N,A[N]);else if(typeof A.keys=="function"&&typeof A.get=="function")for(const U of A.keys())y.set(U,A.get(U));else throw Error("Unknown input type for opt_headers: "+String(A));A=Array.from(y.keys()).find(U=>U.toLowerCase()=="content-type"),N=a.FormData&&l instanceof a.FormData,!(0<=Array.prototype.indexOf.call(SS,f,void 0))||A||N||y.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[U,H]of y)this.g.setRequestHeader(U,H);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{Ny(this),this.u=!0,this.g.send(l),this.u=!1}catch(U){Dy(this,U)}};function Dy(l,f){l.h=!1,l.g&&(l.j=!0,l.g.abort(),l.j=!1),l.l=f,l.m=5,Oy(l),ju(l)}function Oy(l){l.A||(l.A=!0,Rt(l,"complete"),Rt(l,"error"))}t.abort=function(l){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=l||7,Rt(this,"complete"),Rt(this,"abort"),ju(this))},t.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),ju(this,!0)),Be.aa.N.call(this)},t.Ea=function(){this.s||(this.B||this.u||this.j?My(this):this.bb())},t.bb=function(){My(this)};function My(l){if(l.h&&typeof s<"u"&&(!l.v[1]||rr(l)!=4||l.Z()!=2)){if(l.u&&rr(l)==4)iy(l.Ea,0,l);else if(Rt(l,"readystatechange"),rr(l)==4){l.h=!1;try{const H=l.Z();e:switch(H){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var f=!0;break e;default:f=!1}var y;if(!(y=f)){var A;if(A=H===0){var N=String(l.D).match(Sy)[1]||null;!N&&a.self&&a.self.location&&(N=a.self.location.protocol.slice(0,-1)),A=!IS.test(N?N.toLowerCase():"")}y=A}if(y)Rt(l,"complete"),Rt(l,"success");else{l.m=6;try{var U=2<rr(l)?l.g.statusText:""}catch{U=""}l.l=U+" ["+l.Z()+"]",Oy(l)}}finally{ju(l)}}}}function ju(l,f){if(l.g){Ny(l);const y=l.g,A=l.v[0]?()=>{}:null;l.g=null,l.v=null,f||Rt(l,"ready");try{y.onreadystatechange=A}catch{}}}function Ny(l){l.I&&(a.clearTimeout(l.I),l.I=null)}t.isActive=function(){return!!this.g};function rr(l){return l.g?l.g.readyState:0}t.Z=function(){try{return 2<rr(this)?this.g.status:-1}catch{return-1}},t.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},t.Oa=function(l){if(this.g){var f=this.g.responseText;return l&&f.indexOf(l)==0&&(f=f.substring(l.length)),iS(f)}};function Vy(l){try{if(!l.g)return null;if("response"in l.g)return l.g.response;switch(l.H){case"":case"text":return l.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in l.g)return l.g.mozResponseArrayBuffer}return null}catch{return null}}function CS(l){const f={};l=(l.g&&2<=rr(l)&&l.g.getAllResponseHeaders()||"").split(`\r
`);for(let A=0;A<l.length;A++){if(g(l[A]))continue;var y=j(l[A]);const N=y[0];if(y=y[1],typeof y!="string")continue;y=y.trim();const U=f[N]||[];f[N]=U,U.push(y)}T(f,function(A){return A.join(", ")})}t.Ba=function(){return this.m},t.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function Pa(l,f,y){return y&&y.internalChannelParams&&y.internalChannelParams[l]||f}function Fy(l){this.Aa=0,this.i=[],this.j=new Ta,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=Pa("failFast",!1,l),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=Pa("baseRetryDelayMs",5e3,l),this.cb=Pa("retryDelaySeedMs",1e4,l),this.Wa=Pa("forwardChannelMaxRetries",2,l),this.wa=Pa("forwardChannelRequestTimeoutMs",2e4,l),this.pa=l&&l.xmlHttpFactory||void 0,this.Xa=l&&l.Tb||void 0,this.Ca=l&&l.useFetchStreams||!1,this.L=void 0,this.J=l&&l.supportsCrossDomainXhr||!1,this.K="",this.h=new ky(l&&l.concurrentRequestLimit),this.Da=new TS,this.P=l&&l.fastHandshake||!1,this.O=l&&l.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=l&&l.Rb||!1,l&&l.xa&&this.j.xa(),l&&l.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&l&&l.detectBufferingProxy||!1,this.ja=void 0,l&&l.longPollingTimeout&&0<l.longPollingTimeout&&(this.ja=l.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}t=Fy.prototype,t.la=8,t.G=1,t.connect=function(l,f,y,A){bt(0),this.W=l,this.H=f||{},y&&A!==void 0&&(this.H.OSID=y,this.H.OAID=A),this.F=this.X,this.I=Yy(this,null,this.W),Ou(this)};function ff(l){if(Uy(l),l.G==3){var f=l.U++,y=nr(l.I);if(be(y,"SID",l.K),be(y,"RID",f),be(y,"TYPE","terminate"),Ra(l,y),f=new Ar(l,l.j,f),f.L=2,f.v=Pu(nr(y)),y=!1,a.navigator&&a.navigator.sendBeacon)try{y=a.navigator.sendBeacon(f.v.toString(),"")}catch{}!y&&a.Image&&(new Image().src=f.v,y=!0),y||(f.g=Ky(f.j,null),f.g.ea(f.v)),f.F=Date.now(),Cu(f)}Gy(l)}function Du(l){l.g&&(mf(l),l.g.cancel(),l.g=null)}function Uy(l){Du(l),l.u&&(a.clearTimeout(l.u),l.u=null),Mu(l),l.h.cancel(),l.s&&(typeof l.s=="number"&&a.clearTimeout(l.s),l.s=null)}function Ou(l){if(!Ey(l.h)&&!l.s){l.s=!0;var f=l.Ga;pe||Z(),z||(pe(),z=!0),q.add(f,l),l.B=0}}function AS(l,f){return wy(l.h)>=l.h.j-(l.s?1:0)?!1:l.s?(l.i=f.D.concat(l.i),!0):l.G==1||l.G==2||l.B>=(l.Va?0:l.Wa)?!1:(l.s=wa(k(l.Ga,l,f),qy(l,l.B)),l.B++,!0)}t.Ga=function(l){if(this.s)if(this.s=null,this.G==1){if(!l){this.U=Math.floor(1e5*Math.random()),l=this.U++;const N=new Ar(this,this.j,l);let U=this.o;if(this.S&&(U?(U=w(U),R(U,this.S)):U=this.S),this.m!==null||this.O||(N.H=U,U=null),this.P)e:{for(var f=0,y=0;y<this.i.length;y++){t:{var A=this.i[y];if("__data__"in A.map&&(A=A.map.__data__,typeof A=="string")){A=A.length;break t}A=void 0}if(A===void 0)break;if(f+=A,4096<f){f=y;break e}if(f===4096||y===this.i.length-1){f=y+1;break e}}f=1e3}else f=1e3;f=$y(this,N,f),y=nr(this.I),be(y,"RID",l),be(y,"CVER",22),this.D&&be(y,"X-HTTP-Session-Id",this.D),Ra(this,y),U&&(this.O?f="headers="+encodeURIComponent(String(jy(U)))+"&"+f:this.m&&hf(y,this.m,U)),df(this.h,N),this.Ua&&be(y,"TYPE","init"),this.P?(be(y,"$req",f),be(y,"SID","null"),N.T=!0,af(N,y,null)):af(N,y,f),this.G=2}}else this.G==3&&(l?Wy(this,l):this.i.length==0||Ey(this.h)||Wy(this))};function Wy(l,f){var y;f?y=f.l:y=l.U++;const A=nr(l.I);be(A,"SID",l.K),be(A,"RID",y),be(A,"AID",l.T),Ra(l,A),l.m&&l.o&&hf(A,l.m,l.o),y=new Ar(l,l.j,y,l.B+1),l.m===null&&(y.H=l.o),f&&(l.i=f.D.concat(l.i)),f=$y(l,y,1e3),y.I=Math.round(.5*l.wa)+Math.round(.5*l.wa*Math.random()),df(l.h,y),af(y,A,f)}function Ra(l,f){l.H&&M(l.H,function(y,A){be(f,A,y)}),l.l&&Iy({},function(y,A){be(f,A,y)})}function $y(l,f,y){y=Math.min(l.i.length,y);var A=l.l?k(l.l.Na,l.l,l):null;e:{var N=l.i;let U=-1;for(;;){const H=["count="+y];U==-1?0<y?(U=N[0].g,H.push("ofs="+U)):U=0:H.push("ofs="+U);let Ae=!0;for(let ut=0;ut<y;ut++){let ke=N[ut].g;const kt=N[ut].map;if(ke-=U,0>ke)U=Math.max(0,N[ut].g-100),Ae=!1;else try{xS(kt,H,"req"+ke+"_")}catch{A&&A(kt)}}if(Ae){A=H.join("&");break e}}}return l=l.i.splice(0,y),f.D=l,A}function zy(l){if(!l.g&&!l.u){l.Y=1;var f=l.Fa;pe||Z(),z||(pe(),z=!0),q.add(f,l),l.v=0}}function pf(l){return l.g||l.u||3<=l.v?!1:(l.Y++,l.u=wa(k(l.Fa,l),qy(l,l.v)),l.v++,!0)}t.Fa=function(){if(this.u=null,By(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var l=2*this.R;this.j.info("BP detection timer enabled: "+l),this.A=wa(k(this.ab,this),l)}},t.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,bt(10),Du(this),By(this))};function mf(l){l.A!=null&&(a.clearTimeout(l.A),l.A=null)}function By(l){l.g=new Ar(l,l.j,"rpc",l.Y),l.m===null&&(l.g.H=l.o),l.g.O=0;var f=nr(l.qa);be(f,"RID","rpc"),be(f,"SID",l.K),be(f,"AID",l.T),be(f,"CI",l.F?"0":"1"),!l.F&&l.ja&&be(f,"TO",l.ja),be(f,"TYPE","xmlhttp"),Ra(l,f),l.m&&l.o&&hf(f,l.m,l.o),l.L&&(l.g.I=l.L);var y=l.g;l=l.ia,y.L=1,y.v=Pu(nr(f)),y.m=null,y.P=!0,yy(y,l)}t.Za=function(){this.C!=null&&(this.C=null,Du(this),pf(this),bt(19))};function Mu(l){l.C!=null&&(a.clearTimeout(l.C),l.C=null)}function Hy(l,f){var y=null;if(l.g==f){Mu(l),mf(l),l.g=null;var A=2}else if(cf(l.h,f))y=f.D,Ty(l.h,f),A=1;else return;if(l.G!=0){if(f.o)if(A==1){y=f.m?f.m.length:0,f=Date.now()-f.F;var N=l.B;A=xu(),Rt(A,new fy(A,y)),Ou(l)}else zy(l);else if(N=f.s,N==3||N==0&&0<f.X||!(A==1&&AS(l,f)||A==2&&pf(l)))switch(y&&0<y.length&&(f=l.h,f.i=f.i.concat(y)),N){case 1:Pi(l,5);break;case 4:Pi(l,10);break;case 3:Pi(l,6);break;default:Pi(l,2)}}}function qy(l,f){let y=l.Ta+Math.floor(Math.random()*l.cb);return l.isActive()||(y*=2),y*f}function Pi(l,f){if(l.j.info("Error code "+f),f==2){var y=k(l.fb,l),A=l.Xa;const N=!A;A=new Li(A||"//www.google.com/images/cleardot.gif"),a.location&&a.location.protocol=="http"||Au(A,"https"),Pu(A),N?ES(A.toString(),y):wS(A.toString(),y)}else bt(2);l.G=0,l.l&&l.l.sa(f),Gy(l),Uy(l)}t.fb=function(l){l?(this.j.info("Successfully pinged google.com"),bt(2)):(this.j.info("Failed to ping google.com"),bt(1))};function Gy(l){if(l.G=0,l.ka=[],l.l){const f=xy(l.h);(f.length!=0||l.i.length!=0)&&(S(l.ka,f),S(l.ka,l.i),l.h.i.length=0,L(l.i),l.i.length=0),l.l.ra()}}function Yy(l,f,y){var A=y instanceof Li?nr(y):new Li(y);if(A.g!="")f&&(A.g=f+"."+A.g),Lu(A,A.s);else{var N=a.location;A=N.protocol,f=f?f+"."+N.hostname:N.hostname,N=+N.port;var U=new Li(null);A&&Au(U,A),f&&(U.g=f),N&&Lu(U,N),y&&(U.l=y),A=U}return y=l.D,f=l.ya,y&&f&&be(A,y,f),be(A,"VER",l.la),Ra(l,A),A}function Ky(l,f,y){if(f&&!l.J)throw Error("Can't create secondary domain capable XhrIo object.");return f=l.Ca&&!l.pa?new Be(new Ru({eb:y})):new Be(l.pa),f.Ha(l.J),f}t.isActive=function(){return!!this.l&&this.l.isActive(this)};function Qy(){}t=Qy.prototype,t.ua=function(){},t.ta=function(){},t.sa=function(){},t.ra=function(){},t.isActive=function(){return!0},t.Na=function(){};function Nu(){}Nu.prototype.g=function(l,f){return new Qt(l,f)};function Qt(l,f){_t.call(this),this.g=new Fy(f),this.l=l,this.h=f&&f.messageUrlParams||null,l=f&&f.messageHeaders||null,f&&f.clientProtocolHeaderRequired&&(l?l["X-Client-Protocol"]="webchannel":l={"X-Client-Protocol":"webchannel"}),this.g.o=l,l=f&&f.initMessageHeaders||null,f&&f.messageContentType&&(l?l["X-WebChannel-Content-Type"]=f.messageContentType:l={"X-WebChannel-Content-Type":f.messageContentType}),f&&f.va&&(l?l["X-WebChannel-Client-Profile"]=f.va:l={"X-WebChannel-Client-Profile":f.va}),this.g.S=l,(l=f&&f.Sb)&&!g(l)&&(this.g.m=l),this.v=f&&f.supportsCrossDomainXhr||!1,this.u=f&&f.sendRawJson||!1,(f=f&&f.httpSessionIdParam)&&!g(f)&&(this.g.D=f,l=this.h,l!==null&&f in l&&(l=this.h,f in l&&delete l[f])),this.j=new Zo(this)}I(Qt,_t),Qt.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Qt.prototype.close=function(){ff(this.g)},Qt.prototype.o=function(l){var f=this.g;if(typeof l=="string"){var y={};y.__data__=l,l=y}else this.u&&(y={},y.__data__=ef(l),l=y);f.i.push(new dS(f.Ya++,l)),f.G==3&&Ou(f)},Qt.prototype.N=function(){this.g.l=null,delete this.j,ff(this.g),delete this.g,Qt.aa.N.call(this)};function Xy(l){nf.call(this),l.__headers__&&(this.headers=l.__headers__,this.statusCode=l.__status__,delete l.__headers__,delete l.__status__);var f=l.__sm__;if(f){e:{for(const y in f){l=y;break e}l=void 0}(this.i=l)&&(l=this.i,f=f!==null&&l in f?f[l]:void 0),this.data=f}else this.data=l}I(Xy,nf);function Zy(){rf.call(this),this.status=1}I(Zy,rf);function Zo(l){this.g=l}I(Zo,Qy),Zo.prototype.ua=function(){Rt(this.g,"a")},Zo.prototype.ta=function(l){Rt(this.g,new Xy(l))},Zo.prototype.sa=function(l){Rt(this.g,new Zy)},Zo.prototype.ra=function(){Rt(this.g,"b")},Nu.prototype.createWebChannel=Nu.prototype.g,Qt.prototype.send=Qt.prototype.o,Qt.prototype.open=Qt.prototype.m,Qt.prototype.close=Qt.prototype.close,dx=function(){return new Nu},cx=function(){return xu()},ux=Ci,bm={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Iu.NO_ERROR=0,Iu.TIMEOUT=8,Iu.HTTP_ERROR=6,Rc=Iu,py.COMPLETE="complete",lx=py,uy.EventType=ka,ka.OPEN="a",ka.CLOSE="b",ka.ERROR="c",ka.MESSAGE="d",_t.prototype.listen=_t.prototype.K,Za=uy,Be.prototype.listenOnce=Be.prototype.L,Be.prototype.getLastError=Be.prototype.Ka,Be.prototype.getLastErrorCode=Be.prototype.Ba,Be.prototype.getStatus=Be.prototype.Z,Be.prototype.getResponseJson=Be.prototype.Oa,Be.prototype.getResponseText=Be.prototype.oa,Be.prototype.send=Be.prototype.ea,Be.prototype.setWithCredentials=Be.prototype.Ha,ax=Be}).apply(typeof rc<"u"?rc:typeof self<"u"?self:typeof window<"u"?window:{});const G_="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`;function Q7(){const[t,e]=O.useState(null),[n,r]=O.useState("dashboard"),[i,o]=O.useState(null),[s,a]=O.useState(null),[u,d]=O.useState(!1),[h,m]=O.useState(null),[k,E]=O.useState(!1),I=ca();O.useEffect(()=>{const C=Sn.currentUser;if(C){const R={uid:C.uid,email:C.email,displayName:C.displayName||C.email.split("@")[0]};e(R),L(C.uid)}},[]);const L=async C=>{if(C)try{E(!0);try{const D=pr(xn(Le,"declined_registrations"),Kr("userId","==",C));if(!(await zn(D)).empty){G.error("Your registration request has been declined. Please contact an administrator."),await Sn.signOut(),I("/login");return}}catch(D){console.error("Error checking declined status:",D)}try{const D=pr(xn(Le,"registration_requests"),Kr("userId","==",C));if(!(await zn(D)).empty){G.info("Your registration request is pending approval. You will be notified when approved."),await Sn.signOut(),I("/login");return}}catch(D){console.error("Error checking pending status:",D)}const R=ft(Le,"users",C),j=await Jl(R);if(j.exists()){const D=j.data();m(D)}else console.log("No user data found in Firestore"),G.error("Your account is not properly set up. Please contact an administrator."),await Sn.signOut(),I("/login")}catch(R){console.error("Error fetching user data:",R),G.error("Error loading user data. Please try again later.")}finally{E(!1)}};O.useEffect(()=>{t!=null&&t.uid&&S()},[t]);const S=async()=>{try{const C=xn(Le,"attendance");try{const R=pr(C,Kr("userId","==",t.uid),L1("timestamp","desc"),ZD(1)),j=await zn(R);if(j.empty)o(null),a(null);else{const D=j.docs[0].data();a(D),o(D.type)}}catch(R){if(R.message&&R.message.includes("index is currently building")){console.log("Index is still building, using fallback method");const j=pr(C,Kr("userId","==",t.uid)),D=await zn(j);if(D.empty)o(null),a(null);else{let P=null,X=new Date(0);D.forEach(ge=>{var z;const he=ge.data(),pe=((z=he.timestamp)==null?void 0:z.toDate())||new Date(0);pe>X&&(X=pe,P=he)}),P?(a(P),o(P.type)):(o(null),a(null))}G.info("System is updating. Some features may be temporarily limited.",{autoClose:5e3,hideProgressBar:!1})}else throw R}}catch(C){console.error("Error fetching attendance status:",C),C.message&&C.message.includes("index")?G.warning("System is updating attendance records. Please try again in a few minutes."):G.error("Unable to fetch your attendance status. Please refresh the page.")}},[v,g]=O.useState(!1),[_,x]=O.useState(null),b=async(C,R)=>{if(C==="Out")return"Complete";try{const j=await Jl(ft(Le,"users",R));if(!j.exists())return console.warn("User document not found when determining status"),"On Time";const P=j.data().schedule||[],X=new Date,ge=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][X.getDay()],he=P&&Array.isArray(P)?P.find(ce=>ce.dayOfWeek===ge):null;if(!he)return console.log("No schedule found for today:",ge),"On Time";console.log("Found schedule for today:",he);const[pe,z]=he.timeIn.split(":").map(Number),q=new Date;q.setHours(pe,z,0,0);const Z=Math.round((X-q)/(1e3*60));return console.log("Time difference in minutes:",Z),Z<-15?"Early":Z<=15?"On Time":"Late"}catch(j){return console.error("Error determining status:",j),"On Time"}},M=async C=>{if(t){d(!0);try{const R=nt.now(),j=await b(C,t.uid),D={userId:t.uid,email:t.email,name:t.displayName,type:C,status:j,timestamp:R,notes:""};x(D),g(!0)}catch(R){console.error("Error preparing time in/out:",R),G.error("Failed to prepare time in/out. Please try again.")}finally{d(!1)}}},T=async()=>{if(_){d(!0);try{const{status:C,...R}=_,j=await L8(xn(Le,"attendance"),R);G.success(`Time ${_.type} recorded successfully!`),o(_.type),a(_),g(!1),x(null),console.log(`Time ${_.type} recorded with ID: ${j.id}`)}catch(C){console.error(`Error recording time ${_.type}:`,C),G.error(`Failed to record time ${_.type}`)}finally{d(!1)}}},w=()=>{g(!1),x(null)};return p.jsxs(p.Fragment,{children:[p.jsxs(P5,{user:t,activeTab:n,setActiveTab:r,attendanceStatus:i,loading:u,handleTimeInOut:M,lastRecord:s,isSuperAdmin:(h==null?void 0:h.role)==="super_admin",userData:h,setUserData:m,children:[n==="dashboard"&&p.jsx(b5,{attendanceStatus:i,lastRecord:s}),n==="attendance"&&p.jsx(O5,{user:t}),n==="schedule"&&p.jsx(JV,{user:t,userData:h}),n==="profile"&&p.jsx(n7,{user:t,userData:h,loadingUserData:k}),n==="registration_requests"&&(h==null?void 0:h.role)==="super_admin"&&p.jsx(S7,{}),n==="user_management"&&(h==null?void 0:h.role)==="super_admin"&&p.jsx(W7,{})]}),v&&_&&p.jsx($7,{children:p.jsxs(z7,{children:[p.jsxs(B7,{children:["Confirm Time ",_.type]}),p.jsxs(H7,{children:[p.jsxs("p",{children:[p.jsx("strong",{children:"Time:"})," ",_.timestamp.toDate().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0})]}),p.jsxs("p",{children:[p.jsx("strong",{children:"Date:"})," ",_.timestamp.toDate().toLocaleDateString()]}),p.jsxs("p",{children:[p.jsx("strong",{children:"Status:"}),p.jsx(K7,{status:_.status,children:_.status})]})]}),p.jsxs(q7,{children:[p.jsxs(G7,{onClick:w,children:[p.jsx(Q1,{size:16,style:{marginRight:"4px"}}),"Cancel"]}),p.jsxs(Y7,{onClick:T,children:[p.jsx(H1,{size:16,style:{marginRight:"4px"}}),"Confirm"]})]})]})})]})}const X7=({children:t})=>{const{currentUser:e,loading:n}=V1();return n?p.jsx(Z7,{children:"Loading..."}):e?t:p.jsx(sT,{to:"/",replace:!0})},Z7=V.div`
  display: flex;
  justify-content: center;
  align-items: center;
  height: 100vh;
