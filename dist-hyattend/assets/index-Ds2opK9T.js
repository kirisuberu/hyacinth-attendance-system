...
*/var Si,z2;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(T,k){function S(){}S.prototype=k.prototype,T.D=k.prototype,T.prototype=new S,T.prototype.constructor=T,T.C=function(A,N,b){for(var R=Array(arguments.length-2),me=2;me<arguments.length;me++)R[me-2]=arguments[me];return k.prototype[N].apply(A,R)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,n),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(T,k,S){S||(S=0);var A=Array(16);if(typeof k=="string")for(var N=0;16>N;++N)A[N]=k.charCodeAt(S++)|k.charCodeAt(S++)<<8|k.charCodeAt(S++)<<16|k.charCodeAt(S++)<<24;else for(N=0;16>N;++N)A[N]=k[S++]|k[S++]<<8|k[S++]<<16|k[S++]<<24;k=T.g[0],S=T.g[1],N=T.g[2];var b=T.g[3],R=k+(b^S&(N^b))+A[0]+3614090360&4294967295;k=S+(R<<7&4294967295|R>>>25),R=b+(N^k&(S^N))+A[1]+3905402710&4294967295,b=k+(R<<12&4294967295|R>>>20),R=N+(S^b&(k^S))+A[2]+606105819&4294967295,N=b+(R<<17&4294967295|R>>>15),R=S+(k^N&(b^k))+A[3]+3250441966&4294967295,S=N+(R<<22&4294967295|R>>>10),R=k+(b^S&(N^b))+A[4]+4118548399&4294967295,k=S+(R<<7&4294967295|R>>>25),R=b+(N^k&(S^N))+A[5]+1200080426&4294967295,b=k+(R<<12&4294967295|R>>>20),R=N+(S^b&(k^S))+A[6]+2821735955&4294967295,N=b+(R<<17&4294967295|R>>>15),R=S+(k^N&(b^k))+A[7]+4249261313&4294967295,S=N+(R<<22&4294967295|R>>>10),R=k+(b^S&(N^b))+A[8]+1770035416&4294967295,k=S+(R<<7&4294967295|R>>>25),R=b+(N^k&(S^N))+A[9]+2336552879&4294967295,b=k+(R<<12&4294967295|R>>>20),R=N+(S^b&(k^S))+A[10]+4294925233&4294967295,N=b+(R<<17&4294967295|R>>>15),R=S+(k^N&(b^k))+A[11]+2304563134&4294967295,S=N+(R<<22&4294967295|R>>>10),R=k+(b^S&(N^b))+A[12]+1804603682&4294967295,k=S+(R<<7&4294967295|R>>>25),R=b+(N^k&(S^N))+A[13]+4254626195&4294967295,b=k+(R<<12&4294967295|R>>>20),R=N+(S^b&(k^S))+A[14]+2792965006&4294967295,N=b+(R<<17&4294967295|R>>>15),R=S+(k^N&(b^k))+A[15]+1236535329&4294967295,S=N+(R<<22&4294967295|R>>>10),R=k+(N^b&(S^N))+A[1]+4129170786&4294967295,k=S+(R<<5&4294967295|R>>>27),R=b+(S^N&(k^S))+A[6]+3225465664&4294967295,b=k+(R<<9&4294967295|R>>>23),R=N+(k^S&(b^k))+A[11]+643717713&4294967295,N=b+(R<<14&4294967295|R>>>18),R=S+(b^k&(N^b))+A[0]+3921069994&4294967295,S=N+(R<<20&4294967295|R>>>12),R=k+(N^b&(S^N))+A[5]+3593408605&4294967295,k=S+(R<<5&4294967295|R>>>27),R=b+(S^N&(k^S))+A[10]+38016083&4294967295,b=k+(R<<9&4294967295|R>>>23),R=N+(k^S&(b^k))+A[15]+3634488961&4294967295,N=b+(R<<14&4294967295|R>>>18),R=S+(b^k&(N^b))+A[4]+3889429448&4294967295,S=N+(R<<20&4294967295|R>>>12),R=k+(N^b&(S^N))+A[9]+568446438&4294967295,k=S+(R<<5&4294967295|R>>>27),R=b+(S^N&(k^S))+A[14]+3275163606&4294967295,b=k+(R<<9&4294967295|R>>>23),R=N+(k^S&(b^k))+A[3]+4107603335&4294967295,N=b+(R<<14&4294967295|R>>>18),R=S+(b^k&(N^b))+A[8]+1163531501&4294967295,S=N+(R<<20&4294967295|R>>>12),R=k+(N^b&(S^N))+A[13]+2850285829&4294967295,k=S+(R<<5&4294967295|R>>>27),R=b+(S^N&(k^S))+A[2]+4243563512&4294967295,b=k+(R<<9&4294967295|R>>>23),R=N+(k^S&(b^k))+A[7]+1735328473&4294967295,N=b+(R<<14&4294967295|R>>>18),R=S+(b^k&(N^b))+A[12]+2368359562&4294967295,S=N+(R<<20&4294967295|R>>>12),R=k+(S^N^b)+A[5]+4294588738&4294967295,k=S+(R<<4&4294967295|R>>>28),R=b+(k^S^N)+A[8]+2272392833&4294967295,b=k+(R<<11&4294967295|R>>>21),R=N+(b^k^S)+A[11]+1839030562&4294967295,N=b+(R<<16&4294967295|R>>>16),R=S+(N^b^k)+A[14]+4259657740&4294967295,S=N+(R<<23&4294967295|R>>>9),R=k+(S^N^b)+A[1]+2763975236&4294967295,k=S+(R<<4&4294967295|R>>>28),R=b+(k^S^N)+A[4]+1272893353&4294967295,b=k+(R<<11&4294967295|R>>>21),R=N+(b^k^S)+A[7]+4139469664&4294967295,N=b+(R<<16&4294967295|R>>>16),R=S+(N^b^k)+A[10]+3200236656&4294967295,S=N+(R<<23&4294967295|R>>>9),R=k+(S^N^b)+A[13]+681279174&4294967295,k=S+(R<<4&4294967295|R>>>28),R=b+(k^S^N)+A[0]+3936430074&4294967295,b=k+(R<<11&4294967295|R>>>21),R=N+(b^k^S)+A[3]+3572445317&4294967295,N=b+(R<<16&4294967295|R>>>16),R=S+(N^b^k)+A[6]+76029189&4294967295,S=N+(R<<23&4294967295|R>>>9),R=k+(S^N^b)+A[9]+3654602809&4294967295,k=S+(R<<4&4294967295|R>>>28),R=b+(k^S^N)+A[12]+3873151461&4294967295,b=k+(R<<11&4294967295|R>>>21),R=N+(b^k^S)+A[15]+530742520&4294967295,N=b+(R<<16&4294967295|R>>>16),R=S+(N^b^k)+A[2]+3299628645&4294967295,S=N+(R<<23&4294967295|R>>>9),R=k+(N^(S|~b))+A[0]+4096336452&4294967295,k=S+(R<<6&4294967295|R>>>26),R=b+(S^(k|~N))+A[7]+1126891415&4294967295,b=k+(R<<10&4294967295|R>>>22),R=N+(k^(b|~S))+A[14]+2878612391&4294967295,N=b+(R<<15&4294967295|R>>>17),R=S+(b^(N|~k))+A[5]+4237533241&4294967295,S=N+(R<<21&4294967295|R>>>11),R=k+(N^(S|~b))+A[12]+1700485571&4294967295,k=S+(R<<6&4294967295|R>>>26),R=b+(S^(k|~N))+A[3]+2399980690&4294967295,b=k+(R<<10&4294967295|R>>>22),R=N+(k^(b|~S))+A[10]+4293915773&4294967295,N=b+(R<<15&4294967295|R>>>17),R=S+(b^(N|~k))+A[1]+2240044497&4294967295,S=N+(R<<21&4294967295|R>>>11),R=k+(N^(S|~b))+A[8]+1873313359&4294967295,k=S+(R<<6&4294967295|R>>>26),R=b+(S^(k|~N))+A[15]+4264355552&4294967295,b=k+(R<<10&4294967295|R>>>22),R=N+(k^(b|~S))+A[6]+2734768916&4294967295,N=b+(R<<15&4294967295|R>>>17),R=S+(b^(N|~k))+A[13]+1309151649&4294967295,S=N+(R<<21&4294967295|R>>>11),R=k+(N^(S|~b))+A[4]+4149444226&4294967295,k=S+(R<<6&4294967295|R>>>26),R=b+(S^(k|~N))+A[11]+3174756917&4294967295,b=k+(R<<10&4294967295|R>>>22),R=N+(k^(b|~S))+A[2]+718787259&4294967295,N=b+(R<<15&4294967295|R>>>17),R=S+(b^(N|~k))+A[9]+3951481745&4294967295,T.g[0]=T.g[0]+k&4294967295,T.g[1]=T.g[1]+(N+(R<<21&4294967295|R>>>11))&4294967295,T.g[2]=T.g[2]+N&4294967295,T.g[3]=T.g[3]+b&4294967295}r.prototype.u=function(T,k){k===void 0&&(k=T.length);for(var S=k-this.blockSize,A=this.B,N=this.h,b=0;b<k;){if(N==0)for(;b<=S;)i(this,T,b),b+=this.blockSize;if(typeof T=="string"){for(;b<k;)if(A[N++]=T.charCodeAt(b++),N==this.blockSize){i(this,A),N=0;break}}else for(;b<k;)if(A[N++]=T[b++],N==this.blockSize){i(this,A),N=0;break}}this.h=N,this.o+=k},r.prototype.v=function(){var T=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);T[0]=128;for(var k=1;k<T.length-8;++k)T[k]=0;var S=8*this.o;for(k=T.length-8;k<T.length;++k)T[k]=S&255,S/=256;for(this.u(T),T=Array(16),k=S=0;4>k;++k)for(var A=0;32>A;A+=8)T[S++]=this.g[k]>>>A&255;return T};function s(T,k){var S=l;return Object.prototype.hasOwnProperty.call(S,T)?S[T]:S[T]=k(T)}function o(T,k){this.h=k;for(var S=[],A=!0,N=T.length-1;0<=N;N--){var b=T[N]|0;A&&b==k||(S[N]=b,A=!1)}this.g=S}var l={};function u(T){return-128<=T&&128>T?s(T,function(k){return new o([k|0],0>k?-1:0)}):new o([T|0],0>T?-1:0)}function c(T){if(isNaN(T)||!isFinite(T))return m;if(0>T)return L(c(-T));for(var k=[],S=1,A=0;T>=S;A++)k[A]=T/S|0,S*=4294967296;return new o(k,0)}function f(T,k){if(T.length==0)throw Error("number format error: empty string");if(k=k||10,2>k||36<k)throw Error("radix out of range: "+k);if(T.charAt(0)=="-")return L(f(T.substring(1),k));if(0<=T.indexOf("-"))throw Error('number format error: interior "-" character');for(var S=c(Math.pow(k,8)),A=m,N=0;N<T.length;N+=8){var b=Math.min(8,T.length-N),R=parseInt(T.substring(N,N+b),k);8>b?(b=c(Math.pow(k,b)),A=A.j(b).add(c(R))):(A=A.j(S),A=A.add(c(R)))}return A}var m=u(0),g=u(1),E=u(16777216);t=o.prototype,t.m=function(){if(C(this))return-L(this).m();for(var T=0,k=1,S=0;S<this.g.length;S++){var A=this.i(S);T+=(0<=A?A:4294967296+A)*k,k*=4294967296}return T},t.toString=function(T){if(T=T||10,2>T||36<T)throw Error("radix out of range: "+T);if(x(this))return"0";if(C(this))return"-"+L(this).toString(T);for(var k=c(Math.pow(T,6)),S=this,A="";;){var N=P(S,k).g;S=y(S,N.j(k));var b=((0<S.g.length?S.g[0]:S.h)>>>0).toString(T);if(S=N,x(S))return b+A;for(;6>b.length;)b="0"+b;A=b+A}},t.i=function(T){return 0>T?0:T<this.g.length?this.g[T]:this.h};function x(T){if(T.h!=0)return!1;for(var k=0;k<T.g.length;k++)if(T.g[k]!=0)return!1;return!0}function C(T){return T.h==-1}t.l=function(T){return T=y(this,T),C(T)?-1:x(T)?0:1};function L(T){for(var k=T.g.length,S=[],A=0;A<k;A++)S[A]=~T.g[A];return new o(S,~T.h).add(g)}t.abs=function(){return C(this)?L(this):this},t.add=function(T){for(var k=Math.max(this.g.length,T.g.length),S=[],A=0,N=0;N<=k;N++){var b=A+(this.i(N)&65535)+(T.i(N)&65535),R=(b>>>16)+(this.i(N)>>>16)+(T.i(N)>>>16);A=R>>>16,b&=65535,R&=65535,S[N]=R<<16|b}return new o(S,S[S.length-1]&-2147483648?-1:0)};function y(T,k){return T.add(L(k))}t.j=function(T){if(x(this)||x(T))return m;if(C(this))return C(T)?L(this).j(L(T)):L(L(this).j(T));if(C(T))return L(this.j(L(T)));if(0>this.l(E)&&0>T.l(E))return c(this.m()*T.m());for(var k=this.g.length+T.g.length,S=[],A=0;A<2*k;A++)S[A]=0;for(A=0;A<this.g.length;A++)for(var N=0;N<T.g.length;N++){var b=this.i(A)>>>16,R=this.i(A)&65535,me=T.i(N)>>>16,Ye=T.i(N)&65535;S[2*A+2*N]+=R*Ye,_(S,2*A+2*N),S[2*A+2*N+1]+=b*Ye,_(S,2*A+2*N+1),S[2*A+2*N+1]+=R*me,_(S,2*A+2*N+1),S[2*A+2*N+2]+=b*me,_(S,2*A+2*N+2)}for(A=0;A<k;A++)S[A]=S[2*A+1]<<16|S[2*A];for(A=k;A<2*k;A++)S[A]=0;return new o(S,0)};function _(T,k){for(;(T[k]&65535)!=T[k];)T[k+1]+=T[k]>>>16,T[k]&=65535,k++}function I(T,k){this.g=T,this.h=k}function P(T,k){if(x(k))throw Error("division by zero");if(x(T))return new I(m,m);if(C(T))return k=P(L(T),k),new I(L(k.g),L(k.h));if(C(k))return k=P(T,L(k)),new I(L(k.g),k.h);if(30<T.g.length){if(C(T)||C(k))throw Error("slowDivide_ only works with positive integers.");for(var S=g,A=k;0>=A.l(T);)S=j(S),A=j(A);var N=M(S,1),b=M(A,1);for(A=M(A,2),S=M(S,2);!x(A);){var R=b.add(A);0>=R.l(T)&&(N=N.add(S),b=R),A=M(A,1),S=M(S,1)}return k=y(T,N.j(k)),new I(N,k)}for(N=m;0<=T.l(k);){for(S=Math.max(1,Math.floor(T.m()/k.m())),A=Math.ceil(Math.log(S)/Math.LN2),A=48>=A?1:Math.pow(2,A-48),b=c(S),R=b.j(k);C(R)||0<R.l(T);)S-=A,b=c(S),R=b.j(k);x(b)&&(b=g),N=N.add(b),T=y(T,R)}return new I(N,T)}t.A=function(T){return P(this,T).h},t.and=function(T){for(var k=Math.max(this.g.length,T.g.length),S=[],A=0;A<k;A++)S[A]=this.i(A)&T.i(A);return new o(S,this.h&T.h)},t.or=function(T){for(var k=Math.max(this.g.length,T.g.length),S=[],A=0;A<k;A++)S[A]=this.i(A)|T.i(A);return new o(S,this.h|T.h)},t.xor=function(T){for(var k=Math.max(this.g.length,T.g.length),S=[],A=0;A<k;A++)S[A]=this.i(A)^T.i(A);return new o(S,this.h^T.h)};function j(T){for(var k=T.g.length+1,S=[],A=0;A<k;A++)S[A]=T.i(A)<<1|T.i(A-1)>>>31;return new o(S,T.h)}function M(T,k){var S=k>>5;k%=32;for(var A=T.g.length-S,N=[],b=0;b<A;b++)N[b]=0<k?T.i(b+S)>>>k|T.i(b+S+1)<<32-k:T.i(b+S);return new o(N,T.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,z2=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=c,o.fromString=f,Si=o}).apply(typeof Z0<"u"?Z0:typeof self<"u"?self:typeof window<"u"?window:{});var gu=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vb(){if(n2())try{await r2()}catch(t){return Dt.warn(zt.create("indexeddb-unavailable",{errorInfo:t==null?void 0:t.toString()}).message),!1}else return Dt.warn(zt.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function Mb(t,e,n,r,i,s,o){var l;const u=Nb(t);u.then(E=>{n[E.measurementId]=E.appId,t.options.measurementId&&E.measurementId!==t.options.measurementId&&Dt.warn(`The measurement ID in the local Firebase config (${t.options.measurementId}) does not match the measurement ID fetched from the server (${E.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(E=>Dt.error(E)),e.push(u);const c=Vb().then(E=>{if(E)return r.getId()}),[f,m]=await Promise.all([u,c]);xb(s)||Eb(s,f.measurementId),i("js",new Date);const g=(l=o==null?void 0:o.config)!==null&&l!==void 0?l:{};return g[pb]="firebase",g.update=!0,m!=null&&(g[fb]=m),i("config",f.measurementId,g),f.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rO(t,e,n){let r=1,i=null,s=null,o=!1,l=0;function u(){return l===2}let c=!1;function f(...L){c||(c=!0,e.apply(null,L))}function m(L){i=setTimeout(()=>{i=null,t(E,u())},L)}function g(){s&&clearTimeout(s)}function E(L,...y){if(c){g();return}if(L){g(),f.call(null,L,...y);return}if(u()||o){g(),f.call(null,L,...y);return}r<64&&(r*=2);let I;l===1?(l=2,I=0):I=(r+Math.random())*1e3,m(I)}let x=!1;function C(L){x||(x=!0,g(),!c&&(i!==null?(L||(l=2),clearTimeout(i),m(0)):L||(l=1)))}return m(0),s=setTimeout(()=>{o=!0,C(!0)},n),C}function iO(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,Kj=U.div`
  ...
  padding: 2rem;
  color: #666;
`,Gj=({user:t})=>{const[e,n]=D.useState(null),[r,i]=D.useState(!0);D.useEffect(()=>{(async()=>{if(t!=null&&t.uid)try{i(!0);const c=ar(jt,"users",t.uid),f=await Bp(c);if(f.exists()&&f.data().scheduleId){const m=f.data().scheduleId,g=ar(jt,"schedules",m),E=await Bp(g);E.exists()&&n(E.data())}else{const m=mo(jt,"schedules"),g=hl(m,Bc("isDefault","==",!0)),E=await fl(g);E.empty||n(E.docs[0].data())}}catch(c){console.error("Error fetching schedule:",c)}finally{i(!1)}})()},[t]);const s=u=>["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][u],o=u=>{if(!u)return"N/A";try{const[c,f]=u.split(":"),m=new Date;return m.setHours(parseInt(c,10)),m.setMinutes(parseInt(f,10)),m.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}catch{return u}},l=()=>new Date().getDay();return v.jsxs(Br,{children:[v.jsx(zr,{children:"Your Schedule"}),v.jsx(Hr,{children:r?v.jsx("p",{children:"Loading schedule..."}):e?v.jsxs(v.Fragment,{children:[v.jsxs("p",{children:[v.jsx("strong",{children:"Schedule Name:"})," ",e.name||"Regular Schedule"]}),e.days&&Object.keys(e.days).length>0?Object.entries(e.days).map(([u,c])=>{const f=parseInt(u,10),m=f===l();return v.jsxs(qj,{isToday:m,children:[v.jsxs("h3",{children:[s(f)," ",m&&"(Today)"]}),c.shifts&&c.shifts.length>0?v.jsxs(Hj,{children:[v.jsx("thead",{children:v.jsxs("tr",{children:[v.jsx("th",{children:"Shift"}),v.jsx("th",{children:"Start Time"}),v.jsx("th",{children:"End Time"})]})}),v.jsx("tbody",{children:c.shifts.map((g,E)=>v.jsxs("tr",{children:[v.jsxs("td",{children:["Shift ",E+1]}),v.jsx("td",{children:o(g.startTime)}),v.jsx("td",{children:o(g.endTime)})]},E))})]}):v.jsx("p",{children:"No shifts scheduled"})]},u)}):v.jsx("p",{children:"No daily schedule defined"})]}):v.jsx(Kj,{children:v.jsx("p",{children:"No schedule assigned yet"})})})]})},Qj=U.div`
  margin-bottom: 1.5rem;
`,Is=U.p`
  margin: 0.75rem 0;
  display: flex;
