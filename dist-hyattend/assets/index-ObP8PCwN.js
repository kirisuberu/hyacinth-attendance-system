 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kj(t,e,n){let r=1,i=null,o=null,s=!1,a=0;function u(){return a===2}let d=!1;function h(...I){d||(d=!0,e.apply(null,I))}function p(I){i=setTimeout(()=>{i=null,t(E,u())},I)}function _(){o&&clearTimeout(o)}function E(I,...y){if(d){_();return}if(I){_(),h.call(null,I,...y);return}if(u()||s){_(),h.call(null,I,...y);return}r<64&&(r*=2);let k;a===1?(a=2,k=0):k=(r+Math.random())*1e3,p(k)}let S=!1;function P(I){S||(S=!0,_(),!d&&(i!==null?(I||(a=2),clearTimeout(i),p(0)):I||(a=1)))}return p(0),o=setTimeout(()=>{s=!0,P(!0)},n),P}function Ej(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
